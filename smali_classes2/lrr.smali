...
.method public constructor <init>(IIIIIZZZ[Landroid/hardware/camera2/params/MeteringRectangle;[Landroid/hardware/camera2/params/MeteringRectangle;[Landroid/hardware/camera2/params/MeteringRectangle;)V
    ...
    iput-object p1, p0, Llrr;->a:Ljava/lang/Boolean;

    invoke-static {p7}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object p1

    iput-object p1, p0, Llrr;->b:Ljava/lang/Boolean;

    invoke-static {p8}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object p1

    iput-object p1, p0, Llrr;->c:Ljava/lang/Boolean;

    iput-object p9, p0, Llrr;->d:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-object p10, p0, Llrr;->e:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-object p11, p0, Llrr;->f:[Landroid/hardware/camera2/params/MeteringRectangle;
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p1}, Llrr;->d()Ljava/lang/Integer;
    ...
    invoke-virtual {p1}, Llrr;->e()Ljava/lang/Integer;
    ...
    iget-object v0, p0, Llrr;->d:[Landroid/hardware/camera2/params/MeteringRectangle;

    iget-object v2, p1, Llrr;->d:[Landroid/hardware/camera2/params/MeteringRectangle;
    ...
    iget-object v0, p0, Llrr;->e:[Landroid/hardware/camera2/params/MeteringRectangle;

    iget-object v2, p1, Llrr;->e:[Landroid/hardware/camera2/params/MeteringRectangle;
    ...
    iget-object v0, p0, Llrr;->f:[Landroid/hardware/camera2/params/MeteringRectangle;

    iget-object v2, p1, Llrr;->f:[Landroid/hardware/camera2/params/MeteringRectangle;
    ...
    iget-object v2, p1, Llrr;->a:Ljava/lang/Boolean;
...
.method public final hashCode()I
    ...
    iget-object v1, p0, Llrr;->f:[Landroid/hardware/camera2/params/MeteringRectangle;

...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lpvu;->a:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/ContentProviderClient;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lpvu;->b:Landroid/content/ContentProviderClient;

    const-string p1, "device_params"

    invoke-static {p2, p1}, Lplf;->W(Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;

    move-result-object p1

    iput-object p1, p0, Lpvu;->c:Landroid/net/Uri;
    ...
    iput-object p1, p0, Lpvu;->d:Landroid/net/Uri;
    ...
    iput-object p1, p0, Lpvu;->e:Landroid/net/Uri;
    ...
    iput-object p1, p0, Lpvu;->f:Landroid/net/Uri;
...
.method private final g(Lpqg;Landroid/net/Uri;Ljava/lang/String;)Lpqh;
    .locals 1

    invoke-direct {p0, p2, p3}, Lpvu;->h(Landroid/net/Uri;Ljava/lang/String;)[B
    ...
    :cond_0
    :try_start_0
    invoke-interface {p1, p2}, Lpqg;->d([B)Lpqg;

    move-result-object p1

    invoke-interface {p1}, Lpqg;->j()Lpqh;
    ...
    sget-object p2, Lpvu;->a:Ljava/lang/String;
...
.method private final h(Landroid/net/Uri;Ljava/lang/String;)[B
    ...
    :try_start_0
    iget-object v1, p0, Lpvu;->b:Landroid/content/ContentProviderClient;
    ...
    :cond_1
    :try_start_2
    sget-object v1, Lpvu;->a:Ljava/lang/String;
...
.method public final a(Lpxb;)Lozi;
    ...
    iget-object v0, p0, Lpvu;->f:Landroid/net/Uri;

    invoke-direct {p0, v1, v0, p1}, Lpvu;->g(Lpqg;Landroid/net/Uri;Ljava/lang/String;)Lpqh;
...
.method public final b()Lpwy;
    ...
    iget-object v1, p0, Lpvu;->c:Landroid/net/Uri;

    const/4 v2, 0x0

    invoke-direct {p0, v0, v1, v2}, Lpvu;->g(Lpqg;Landroid/net/Uri;Ljava/lang/String;)Lpqh;
...
.method public final c()Lpwz;
    ...
    iget-object v1, p0, Lpvu;->e:Landroid/net/Uri;
...
.method public final d()Lpxa;
    ...
    iget-object v1, p0, Lpvu;->d:Landroid/net/Uri;
...
.method public final e()V
    ...
    iget-object v0, p0, Lpvu;->b:Landroid/content/ContentProviderClient;
...
.method public final f(Lpwy;)Z
    ...
    iget-object v0, p0, Lpvu;->c:Landroid/net/Uri;
    ...
    :try_start_0
    iget-object p1, p0, Lpvu;->b:Landroid/content/ContentProviderClient;
    ...
    sget-object v0, Lpvu;->a:Ljava/lang/String;

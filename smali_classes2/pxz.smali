...
.method public constructor <init>(Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;I)V
    ...
    iput-object p2, p0, Lpxz;->a:Ljava/lang/ref/WeakReference;

    return-void
.end method

.method public constructor <init>(Lpxv;I)V
    .locals 0
...
.method protected final x(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
    ...
    iget-object p2, p0, Lpxz;->a:Ljava/lang/ref/WeakReference;
    ...
    new-instance p3, Lpxt;

    const/4 v0, 0x2

    invoke-direct {p3, p2, v0}, Lpxt;-><init>(Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;I)V
    ...
    :sswitch_0
    sget-object p1, Lpxm;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    :cond_3
    invoke-static {}, Lpxm;->a()J

    move-result-wide v0

    iget-wide v4, p1, Lpxm;->g:J
    ...
    invoke-virtual {p1, p3}, Lpxn;->e(I)V

    iget-object p2, p2, Lpxv;->a:Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge$Callbacks;

    invoke-interface {p2, p1}, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge$Callbacks;->b(Lpxm;)V

    invoke-virtual {p1}, Lpxn;->d()V
    ...
    :sswitch_1
    sget-object p1, Lpxq;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    invoke-interface {p2, p1}, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge$Callbacks;->c(Lpxq;)V

    return v3

    :sswitch_2
    sget-object p1, Lpxn;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    invoke-interface {p2, p1}, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge$Callbacks;->a(Lpxn;)V
    ...
    :sswitch_3
    iget-object p1, p0, Lpxz;->a:Ljava/lang/ref/WeakReference;
    ...
    iget-object p3, p0, Lpxz;->a:Ljava/lang/ref/WeakReference;
    ...
    :cond_8
    iget-object p3, p3, Lpxv;->a:Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge$Callbacks;

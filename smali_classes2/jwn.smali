...
# direct methods
.method public constructor <init>(Ljava/util/Set;Ljwu;Lljd;)V
    .locals 1
    ...
    iput-object v0, p0, Ljwn;->a:Ljava/util/List;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Ljwn;->c:Ljava/util/Map;

    const/4 v0, 0x0

    iput-boolean v0, p0, Ljwn;->g:Z

    iput-object p1, p0, Ljwn;->b:Ljava/util/Set;

    iput-object p2, p0, Ljwn;->d:Ljwu;

    iput-object p3, p0, Ljwn;->e:Lljd;
...
# virtual methods
.method public final a(Llmt;Llnv;)V
    .locals 1

    iget-object v0, p0, Ljwn;->d:Ljwu;

    invoke-interface {v0, p1, p2}, Ljwu;->d(Llmt;Llnv;)V
...
.method public final declared-synchronized b()V
    ...
    iget-object v2, p0, Ljwn;->b:Ljava/util/Set;
    ...
    iget-object v6, p0, Ljwn;->c:Ljava/util/Map;
    ...
    iget-object v6, p0, Ljwn;->d:Ljwu;

    iget-object v7, v5, Ljwt;->a:Ljws;

    invoke-interface {v7, v6}, Ljws;->a(Ljwu;)Ljwq;

    move-result-object v6

    iget-object v7, p0, Ljwn;->c:Ljava/util/Map;
    ...
    :cond_3
    invoke-interface {v0, v2}, Ljwu;->g(Ljava/util/List;)V
    :try_end_1
...
.method public final c(II)Loix;
    ...
    iget-boolean v0, v0, Ljwk;->k:Z

    if-eqz v0, :cond_0

    sget-object v0, Ljwk;->a:Loue;
    ...
    iget-object v3, v3, Ljwk;->g:Llnv;

    invoke-interface {v0, v3}, Llmp;->d(Llnv;)Lmaa;
    ...
    :try_start_8
    invoke-static {v6}, Lmtp;->a(Landroid/graphics/Bitmap;)Lmtn;
    ...
    invoke-virtual {v10}, Ljwk;->b()Lmpg;
    ...
    invoke-virtual {v11}, Ljwk;->b()Lmpg;

    move-result-object v11

    invoke-static {v11}, Lmre;->a(Lmpg;)Lmre;
    ...
    :try_start_c
    invoke-virtual {v11}, Lmre;->close()V
    :try_end_c
...
.method public final declared-synchronized close()V
    ...
    iput-boolean v1, p0, Ljwn;->g:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :try_start_1
    iget-object v0, p0, Ljwn;->a:Ljava/util/List;
    ...
    invoke-interface {v0}, Ljwu;->close()V

    iget-object v0, p0, Ljwn;->f:Landroid/view/Surface;
...
.method public final declared-synchronized d(Landroid/view/Surface;ILandroid/util/Size;)V
    ...
    invoke-interface {v1, v2, p2}, Loub;->p(Ljava/lang/String;I)V

    :cond_1
    iget-object p2, p0, Ljwn;->e:Lljd;

    invoke-interface {p2}, Lljd;->f()V

    iput-object p1, p0, Ljwn;->f:Landroid/view/Surface;

    iget-object p2, p0, Ljwn;->d:Ljwu;

    invoke-interface {p2, p1, p3}, Ljwu;->f(Landroid/view/Surface;Landroid/util/Size;)V

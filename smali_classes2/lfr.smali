...
# direct methods
.method public synthetic constructor <init>(Llft;ILandroid/media/MediaCodec$BufferInfo;)V
    .locals 0
    ...
    iput-object p3, p0, Llfr;->c:Landroid/media/MediaCodec$BufferInfo;
...
.method public final run()V
    ...
    iget-object v2, p0, Llfr;->c:Landroid/media/MediaCodec$BufferInfo;
    ...
    iget-object v4, v0, Llfw;->q:Ljava/util/Deque;
    ...
    invoke-virtual {v8, v9}, Lore;->l(Ljava/lang/Comparable;)Z
    ...
    :cond_4
    :goto_1
    iget-object v4, v0, Llfw;->i:Landroid/media/MediaCodec;
    ...
    iget-wide v8, v0, Llfw;->t:J

    sub-long/2addr v6, v8

    iput-wide v6, v2, Landroid/media/MediaCodec$BufferInfo;->presentationTimeUs:J

    iget-object v6, v0, Llfw;->v:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    iget-object v6, v0, Llfw;->w:Ljava/util/concurrent/atomic/AtomicLong;

    iget-wide v7, v2, Landroid/media/MediaCodec$BufferInfo;->presentationTimeUs:J

    long-to-double v7, v7

    iget-wide v9, v0, Llfw;->l:D
    ...
    iget-object v4, v0, Llfw;->o:Ljava/util/Queue;

    new-instance v7, Llfv;

    invoke-direct {v7, v2, v6}, Llfv;-><init>(Landroid/media/MediaCodec$BufferInfo;Ljava/nio/ByteBuffer;)V
    ...
    iget-object v3, v0, Llfw;->m:Llgc;

    sget-object v4, Llfy;->a:Llfy;

    invoke-virtual {v3, v4}, Llgc;->a(Llfy;)V

    :cond_6
    :goto_2
    iget-object v3, v0, Llfw;->i:Landroid/media/MediaCodec;

    invoke-virtual {v3, v1, v5}, Landroid/media/MediaCodec;->releaseOutputBuffer(IZ)V

    iget-boolean v1, v0, Llfw;->y:Z

    if-eqz v1, :cond_a

    iget-wide v3, v2, Landroid/media/MediaCodec$BufferInfo;->presentationTimeUs:J

    iget-wide v5, v0, Llfw;->s:J
    ...
    iget-boolean v1, v0, Llfw;->x:Z

    if-eqz v1, :cond_8

    iget-boolean v1, v0, Llfw;->z:Z

    if-nez v1, :cond_9

    :cond_8
    iget-boolean v1, v0, Llfw;->A:Z

    if-nez v1, :cond_9

    iget-boolean v1, v0, Llfw;->B:Z

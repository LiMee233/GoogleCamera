...
.field final synthetic c:Lkps;


# direct methods
.method public constructor <init>(Landroid/content/Intent;Ljava/lang/ref/WeakReference;Lkps;)V
    .locals 0

    iput-object p1, p0, Lkpr;->a:Landroid/content/Intent;

    iput-object p2, p0, Lkpr;->b:Ljava/lang/ref/WeakReference;

    iput-object p3, p0, Lkpr;->c:Lkps;
...
.method public final b(Lcom/google/android/gms/googlehelp/GoogleHelp;)V
    ...
    iget-object v2, p0, Lkpr;->a:Landroid/content/Intent;

    const-string v3, "EXTRA_START_TICK"

    invoke-virtual {v2, v3, v0, v1}, Landroid/content/Intent;->putExtra(Ljava/lang/String;J)Landroid/content/Intent;

    iget-object v0, p0, Lkpr;->b:Ljava/lang/ref/WeakReference;
    ...
    iget-object p1, p0, Lkpr;->c:Lkps;

    sget-object v0, Lkpt;->a:Lcom/google/android/gms/common/api/Status;
    ...
    :cond_5
    iget-object v1, p0, Lkpr;->c:Lkps;

    iget-object v3, p0, Lkpr;->a:Landroid/content/Intent;
    ...
    sget-object v5, Lkpo;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    iput-object p1, v5, Lkpo;->a:Lcom/google/android/gms/googlehelp/GoogleHelp;

    invoke-static {}, Landroid/os/Parcel;->obtain()Landroid/os/Parcel;

    move-result-object p1

    invoke-static {v5, p1, v2}, Lkpe;->a(Lkpo;Landroid/os/Parcel;I)V
    ...
    invoke-direct {p1, v2}, Lkse;-><init>(Landroid/os/Looper;)V

    new-instance v2, Lkpq;

    invoke-direct {v2, v0, v3}, Lkpq;-><init>(Landroid/app/Activity;Landroid/content/Intent;)V

    invoke-virtual {p1, v2}, Lkse;->post(Ljava/lang/Runnable;)Z

    sget-object p1, Lcom/google/android/gms/common/api/Status;->a:Lcom/google/android/gms/common/api/Status;

    invoke-virtual {v1, p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->j(Lkit;)V

...
.method public synthetic constructor <init>(Ljava/io/OutputStream;)V
    ...
    iput-object p1, p0, Lmix;->a:Ljava/io/OutputStream;
...
# virtual methods
.method public final a(Lmiw;Last;Last;Lmiu;)V
    .locals 1

    iget-object v0, p0, Lmix;->a:Ljava/io/OutputStream;

    iget-object p1, p1, Lmiw;->a:[B

    invoke-static {p1, v0, p2, p3}, Lmdb;->p([BLjava/io/OutputStream;Last;Last;)V

    :try_start_0
    iget-object p1, p4, Lmiu;->b:Ljava/io/InputStream;
    ...
    iget-object p2, p4, Lmiu;->b:Ljava/io/InputStream;

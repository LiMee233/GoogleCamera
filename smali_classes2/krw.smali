...
.field public final synthetic b:Lkvk;

.field public final synthetic c:Ljava/util/concurrent/Executor;

.field public final synthetic d:Lkqi;


# direct methods
.method public synthetic constructor <init>(Landroid/content/Context;Lkvk;Ljava/util/concurrent/Executor;Lkqi;)V
    .locals 0
    ...
    iput-object p2, p0, Lkrw;->b:Lkvk;

    iput-object p3, p0, Lkrw;->c:Ljava/util/concurrent/Executor;

    iput-object p4, p0, Lkrw;->d:Lkqi;
...
.method public final run()V
    ...
    iget-object v1, p0, Lkrw;->b:Lkvk;

    iget-object v2, p0, Lkrw;->c:Ljava/util/concurrent/Executor;

    iget-object v3, p0, Lkrw;->d:Lkqi;

    sget-object v4, Lkqd;->a:Ljava/lang/Object;

    monitor-enter v4

    :try_start_0
    sget-boolean v5, Lkqd;->b:Z
    ...
    invoke-direct {v0, v2}, Lkie;-><init>(Lcom/google/android/gms/common/api/Status;)V

    invoke-virtual {v1, v0}, Lkvk;->c(Ljava/lang/Exception;)V
    ...
    sget-object v7, Lkru;->c:Lkru;

    invoke-static {v0, v6, v7}, Lkrn;->a(Landroid/content/Context;Ljava/lang/String;Lkrm;)Landroid/os/IInterface;

    move-result-object v6

    check-cast v6, Lkrr;
    :try_end_1
    .catch Lkrl; {:try_start_1 .. :try_end_1} :catch_5

    new-instance v7, Lkrx;

    invoke-direct {v7, v1, v6}, Lkrx;-><init>(Lkvk;Lkrr;)V
    ...
    invoke-static {v2}, Lkoe;->b(Ljava/lang/Object;)Lkof;
    ...
    :cond_2
    iget-object v9, v3, Lkqi;->k:Landroid/net/Uri;
    ...
    iget-object v9, v3, Lkqi;->d:Ljava/lang/String;

    if-eqz v9, :cond_6

    iget-object v9, v3, Lkqi;->j:Lkqk;
    ...
    invoke-static {v0}, Lojy;->b(Ljava/lang/Throwable;)Ljava/lang/String;
    ...
    invoke-virtual {v1, v2}, Lkvk;->c(Ljava/lang/Exception;)V
    ...
    invoke-virtual {v0}, Lkrl;->getMessage()Ljava/lang/String;

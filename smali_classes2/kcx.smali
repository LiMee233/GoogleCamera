...
.method static constructor <clinit>()V
    ...
    invoke-static {v0}, Lkdc;->e(I)Z

    move-result v0

    sput-boolean v0, Lkcx;->s:Z

    const/4 v1, 0x3

    invoke-static {v1}, Lkdc;->e(I)Z

    move-result v1

    sput-boolean v1, Lkcx;->t:Z

    const/4 v2, 0x4

    invoke-static {v2}, Lkdc;->e(I)Z

    move-result v2

    sput-boolean v2, Lkcx;->u:Z

    const/4 v3, 0x5

    invoke-static {v3}, Lkdc;->e(I)Z

    move-result v3

    sput-boolean v3, Lkcx;->v:Z

    const/4 v4, 0x6

    invoke-static {v4}, Lkdc;->e(I)Z

    move-result v4

    sput-boolean v4, Lkcx;->w:Z

    const/4 v5, 0x7

    invoke-static {v5}, Lkdc;->e(I)Z

    move-result v5

    sput-boolean v5, Lkcx;->x:Z
    ...
    :goto_0
    sput-object v7, Lkcx;->a:Landroid/hardware/camera2/CameraCharacteristics$Key;

    if-eqz v0, :cond_5

    invoke-static {}, Lkcx;->g()Z
    ...
    :goto_1
    sput-object v7, Lkcx;->b:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_2
    sput-object v7, Lkcx;->c:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_3
    sput-object v7, Lkcx;->d:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_4
    sput-object v7, Lkcx;->e:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_5
    sput-object v7, Lkcx;->f:Landroid/hardware/camera2/CaptureResult$Key;

    if-eqz v0, :cond_e

    invoke-static {}, Lkcx;->e()Z
    ...
    :goto_6
    sput-object v7, Lkcx;->g:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_7
    sput-object v7, Lkcx;->h:Landroid/hardware/camera2/CaptureResult$Key;

    if-eqz v0, :cond_10

    invoke-static {}, Lkcx;->a()Z
    ...
    :goto_8
    sput-object v7, Lkcx;->i:Landroid/hardware/camera2/CaptureResult$Key;

    invoke-static {}, Lkcx;->c()Z
    ...
    :goto_9
    sput-object v7, Lkcx;->j:Landroid/hardware/camera2/CaptureRequest$Key;

    if-eqz v0, :cond_16

    invoke-static {}, Lkcx;->b()Z
    ...
    :goto_a
    sput-object v7, Lkcx;->k:Landroid/hardware/camera2/CaptureRequest$Key;

    invoke-static {}, Lkcx;->h()Z
    ...
    :goto_b
    sput-object v7, Lkcx;->l:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    :goto_c
    sput-object v7, Lkcx;->m:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    :goto_d
    sput-object v7, Lkcx;->n:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    :goto_e
    sput-object v7, Lkcx;->o:Landroid/hardware/camera2/CameraCharacteristics$Key;

    if-eqz v0, :cond_38

    invoke-static {}, Lkcx;->d()Z
    ...
    :goto_f
    sput-object v7, Lkcx;->p:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    sput-object v7, Lkcx;->q:Ljava/lang/Integer;
    ...
    :goto_12
    sput-object v6, Lkcx;->r:Landroid/hardware/camera2/CaptureResult$Key;

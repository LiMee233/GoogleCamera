...
.field private static final d:Llzf;

.field private static final k:Llvn;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lpkm;->c:Ljava/lang/String;

    invoke-static {}, Llzf;->a()Llzf;

    move-result-object v0

    sput-object v0, Lpkm;->d:Llzf;
...
.method private static C(Llvn;Lpkl;Ljava/util/Map;Lcom/google/googlex/gcam/FaceInfoVector;)V
    .locals 24
    ...
    invoke-interface {v3, v2}, Llvn;->n(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    iget-object v4, v0, Lpkl;->a:[Landroid/hardware/camera2/params/Face;
    ...
    iget-object v5, v0, Lpkl;->a:[Landroid/hardware/camera2/params/Face;
    ...
    iget-object v5, v0, Lpkl;->d:[F

    iget-object v11, v0, Lpkl;->c:[B
    ...
    :goto_6
    sget-object v5, Lpkm;->c:Ljava/lang/String;
...
.method private static D(Llzo;)Z
    .locals 2

    sget-object v0, Lpkm;->d:Llzf;

    invoke-virtual {v0}, Llzf;->e()Z
    ...
    iget-boolean v1, v0, Llzf;->i:Z

    if-nez v1, :cond_0

    invoke-virtual {v0}, Llzf;->h()Z

    move-result v1

    if-nez v1, :cond_0

    iget-boolean v0, v0, Llzf;->m:Z
    ...
    invoke-interface {p0, v0}, Llzo;->d(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
...
.method private static E(Llvn;)[F
    .locals 3

    sget-object v0, Lkdb;->l:Landroid/hardware/camera2/CameraCharacteristics$Key;

    if-eqz v0, :cond_0

    sget-object v0, Lkdb;->l:Landroid/hardware/camera2/CameraCharacteristics$Key;

    invoke-interface {p0, v0}, Llvn;->l(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
...
.method public static c(Llvn;)I
    .locals 1

    const/4 v0, 0x0

    invoke-static {p0, v0, v0}, Lpkm;->d(Llvn;Llvo;Llzs;)I
...
.method public static d(Llvn;Llvo;Llzs;)I
    .locals 9
    ...
    invoke-interface {p0, v2}, Llvn;->l(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    invoke-static {p0, p1, p2}, Lpkm;->y(Llvn;Llvo;Llzs;)Llvn;

    move-result-object p0

    :cond_2
    invoke-interface {p0}, Llvn;->t()Ljava/util/List;
    ...
    invoke-interface {p2, p1}, Llzs;->d(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-interface {p0, v5}, Llvn;->l(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;

    move-result-object p0

    const-string v1, "pref_sensorid_key"
    ...
    :cond_9
    invoke-static {p2}, Lpkm;->D(Llzo;)Z
    ...
    sget-object p2, Lpkm;->d:Llzf;

    invoke-virtual {p2}, Llzf;->d()Z
...
.method public static e(Llvn;)J
    .locals 2

    invoke-static {p0}, Lpkm;->h(Llvn;)Llwn;
    ...
    invoke-interface {p0, v1, v0}, Llvn;->g(ILlie;)J
...
.method public static h(Llvn;)Llwn;
    .locals 6

    const/16 v0, 0x25

    invoke-interface {p0, v0}, Llvn;->x(I)Ljava/util/List;
    ...
    invoke-static {v1}, Lmin;->bs(Ljava/util/List;)Llie;

    move-result-object v1

    invoke-direct {p0, v0, v1}, Llwn;-><init>(ILlie;)V
    ...
    invoke-direct {p0, v2, v0}, Llwn;-><init>(ILlie;)V
    ...
    invoke-direct {v0, v4, p0}, Llwn;-><init>(ILlie;)V
...
.method public static i(Llzs;Ljava/lang/String;)Llzs;
    .locals 3
    ...
    sget-object v0, Lpkm;->c:Ljava/lang/String;
...
.method public static o(Landroid/graphics/Rect;Llzo;)Lcom/google/googlex/gcam/MeshWarp;
    .locals 12
    ...
    sget-object v0, Lkcz;->l:Landroid/hardware/camera2/CaptureResult$Key;

    if-eqz v0, :cond_2

    sget-object v0, Lkcz;->j:Landroid/hardware/camera2/CaptureResult$Key;

    if-eqz v0, :cond_2

    sget-object v0, Lkcz;->k:Landroid/hardware/camera2/CaptureResult$Key;

    if-eqz v0, :cond_2

    sget-object v0, Lkcz;->m:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    sget-object v1, Lkcz;->j:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    sget-object v1, Lkcz;->k:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    invoke-static {v0}, Lpkm;->A([F)Lcom/google/googlex/gcam/FloatVector;
    ...
    invoke-static {p1, v0, p0}, Lobm;->av(ZLjava/lang/String;Ljava/lang/Object;)V
    ...
    :cond_1
    sget-object p0, Lpkm;->c:Ljava/lang/String;
...
.method public static q(Llvn;Llzo;Lcom/google/googlex/gcam/FaceInfoVector;)V
    .locals 1

    new-instance v0, Lpkl;

    invoke-direct {v0, p1}, Lpkl;-><init>(Llzo;)V

    const/4 p1, 0x0

    invoke-static {p0, v0, p1, p2}, Lpkm;->C(Llvn;Lpkl;Ljava/util/Map;Lcom/google/googlex/gcam/FaceInfoVector;)V

    return-void
.end method

.method public static r(Llvn;[Landroid/hardware/camera2/params/Face;Lcom/google/googlex/gcam/FaceInfoVector;)V
    .locals 1

    new-instance v0, Lpkl;

    invoke-direct {v0, p1}, Lpkl;-><init>([Landroid/hardware/camera2/params/Face;)V
...
.method public static s(Llvn;Llzs;)[F
    .locals 5

    const/high16 v2, 0x3f800000    # 1.0f

    sget-object v0, Lkda;->s:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    sget v4, Lsgcam/Shamim;->GetSunlightFix:I
...
.method public static v(Llvn;)Lcom/google/googlex/gcam/StaticMetadata;
    .locals 18
    ...
    invoke-virtual {v0, v2}, Llzh;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static/range {p0 .. p0}, Lpkm;->c(Llvn;)I

    move-result v0

    invoke-virtual {v8, v0}, Lcom/google/googlex/gcam/StaticMetadata;->f(I)V

    invoke-interface/range {p0 .. p0}, Llvn;->H()Z
    ...
    invoke-interface/range {p0 .. p0}, Llvn;->k()Llwb;
    ...
    invoke-interface/range {p0 .. p0}, Llvn;->r()Ljava/util/List;
    ...
    invoke-interface {v1, v0}, Llvn;->n(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    invoke-interface {v1, v0}, Llvn;->l(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    sget-object v3, Lpkm;->c:Ljava/lang/String;
    ...
    invoke-interface {v1, v3}, Llvn;->n(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    invoke-static {v4, v5}, Lpkm;->b(J)F
    ...
    invoke-static/range {p0 .. p0}, Lpkm;->E(Llvn;)[F

    move-result-object v0

    invoke-static/range {p0 .. p0}, Lpkm;->x(Llvn;)F
    ...
    invoke-static {v2}, Lpkm;->z(Landroid/hardware/camera2/params/ColorSpaceTransform;)Lcom/google/googlex/gcam/FloatArray9;
    ...
    invoke-static {v3}, Lpkm;->z(Landroid/hardware/camera2/params/ColorSpaceTransform;)Lcom/google/googlex/gcam/FloatArray9;
    ...
    invoke-static/range {p0 .. p0}, Lpkm;->h(Llvn;)Llwn;

    move-result-object v0

    iget-object v2, v0, Llwn;->b:Llie;
    ...
    invoke-static/range {p0 .. p0}, Lpkm;->e(Llvn;)J

    move-result-wide v2

    iget-wide v4, v8, Lcom/google/googlex/gcam/StaticMetadata;->a:J

    invoke-static {v2, v3}, Lpkm;->b(J)F
...
.method private static x(Llvn;)F
    .locals 1

    sget-object v0, Lkdb;->m:Landroid/hardware/camera2/CameraCharacteristics$Key;
...
.method private static y(Llvn;Llvo;Llzs;)Llvn;
    .locals 6
    ...
    :cond_1
    invoke-interface {p2}, Llzs;->g()Ljava/util/Map;
    ...
    invoke-interface {p2}, Llzs;->e()Ljava/lang/String;
    ...
    invoke-interface {p1, v3}, Llvo;->a(Llvq;)Llvn;
    ...
    :cond_5
    sget-object p1, Lpkm;->c:Ljava/lang/String;
    ...
    invoke-interface {p2, v0}, Llzo;->d(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-interface {v0}, Llvn;->r()Ljava/util/List;
...
.method public final a(I)F
    ...
    invoke-interface {v0, v1}, Llvn;->n(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
...
.method public final f(Llzs;)J
    .locals 2

    invoke-virtual {p0, p1}, Lpkm;->g(Llzs;)Llvn;

    move-result-object p1

    invoke-static {p1}, Lpkm;->e(Llvn;)J
...
.method public final g(Llzs;)Llvn;
    .locals 2

    iget-object v0, p0, Lpkm;->a:Llvn;

    iget-object v1, p0, Lpkm;->b:Llvo;

    invoke-static {v0, v1, p1}, Lpkm;->y(Llvn;Llvo;Llzs;)Llvn;
...
.method public final j(Llzs;)Lcom/google/googlex/gcam/AwbInfo;
    ...
    sget-object v9, Lpkm;->c:Ljava/lang/String;
    ...
    :cond_3
    invoke-static {v9}, Lpkm;->z(Landroid/hardware/camera2/params/ColorSpaceTransform;)Lcom/google/googlex/gcam/FloatArray9;
...
.method public final k(Llzs;)Lcom/google/googlex/gcam/FrameMetadata;
    .locals 1

    const/4 v0, 0x0

    invoke-virtual {p0, p1, v0}, Lpkm;->l(Llzs;Lcom/google/googlex/gcam/GyroSampleVector;)Lcom/google/googlex/gcam/FrameMetadata;
...
.method public final l(Llzs;Lcom/google/googlex/gcam/GyroSampleVector;)Lcom/google/googlex/gcam/FrameMetadata;
    .locals 1

    const/4 v0, 0x0

    invoke-virtual {p0, p1, p2, v0}, Lpkm;->m(Llzs;Lcom/google/googlex/gcam/GyroSampleVector;Ljava/util/Map;)Lcom/google/googlex/gcam/FrameMetadata;
...
.method public final m(Llzs;Lcom/google/googlex/gcam/GyroSampleVector;Ljava/util/Map;)Lcom/google/googlex/gcam/FrameMetadata;
    .locals 35
    ...
    :try_start_0
    invoke-virtual/range {p0 .. p1}, Lpkm;->g(Llzs;)Llvn;

    move-result-object v6

    invoke-interface {v6}, Llvn;->i()Llvq;

    move-result-object v3

    iget-object v3, v3, Llvq;->a:Ljava/lang/String;

    invoke-static {v2, v3}, Lpkm;->i(Llzs;Ljava/lang/String;)Llzs;

    move-result-object v3

    new-instance v4, Lpkl;

    invoke-direct {v4, v3}, Lpkl;-><init>(Llzo;)V
    ...
    invoke-static {v6, v4, v9, v5}, Lpkm;->C(Llvn;Lpkl;Ljava/util/Map;Lcom/google/googlex/gcam/FaceInfoVector;)V

    sget-object v4, Lkda;->f:Landroid/hardware/camera2/CaptureResult$Key;

    if-eqz v4, :cond_1

    sget-object v4, Lkda;->f:Landroid/hardware/camera2/CaptureResult$Key;

    invoke-interface {v3, v4}, Llzs;->d(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-interface {v3, v9}, Llzs;->d(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-static {v4, v7, v12}, Lpkm;->B([Landroid/hardware/camera2/params/MeteringRectangle;ZLcom/google/googlex/gcam/WeightedPixelRectVector;)V
    ...
    invoke-static {v5, v7, v4}, Lpkm;->B([Landroid/hardware/camera2/params/MeteringRectangle;ZLcom/google/googlex/gcam/WeightedPixelRectVector;)V
    ...
    invoke-static {v9, v5, v10}, Lpkm;->B([Landroid/hardware/camera2/params/MeteringRectangle;ZLcom/google/googlex/gcam/WeightedPixelRectVector;)V
    ...
    invoke-static {v3, v2}, Lpkm;->o(Landroid/graphics/Rect;Llzo;)Lcom/google/googlex/gcam/MeshWarp;
    ...
    invoke-interface {v2, v4}, Llzo;->d(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-interface {v2, v9}, Llzo;->d(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-direct {v4, v15}, Lpkk;-><init>(Lcom/google/googlex/gcam/FrameMetadata;)V
    ...
    invoke-static {v3, v4}, Lobm;->ar(ZLjava/lang/Object;)V
    ...
    invoke-interface {v11, v3}, Llvn;->l(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    invoke-interface {v11, v4}, Llvn;->l(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    invoke-interface {v11, v5}, Llvn;->l(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    invoke-interface {v11, v6}, Llvn;->l(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    :cond_15
    sget-object v3, Lkcy;->b:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    sget-object v3, Lkcy;->c:Landroid/hardware/camera2/CameraCharacteristics$Key;

    if-eqz v3, :cond_17

    sget-object v3, Lkcy;->d:Landroid/hardware/camera2/CameraCharacteristics$Key;

    if-eqz v3, :cond_17

    sget-object v3, Lkcy;->e:Landroid/hardware/camera2/CameraCharacteristics$Key;

    if-eqz v3, :cond_17

    sget-object v3, Lkcy;->f:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    sget-object v12, Lkcy;->c:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    sget-object v13, Lkcy;->d:Landroid/hardware/camera2/CameraCharacteristics$Key;

    invoke-interface {v11, v13}, Llvn;->l(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;

    move-result-object v13

    check-cast v13, [F

    sget-object v6, Lkcy;->e:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    sget-object v14, Lkcy;->f:Landroid/hardware/camera2/CameraCharacteristics$Key;

    invoke-interface {v11, v14}, Llvn;->l(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    iget-object v3, v1, Lpkm;->b:Llvo;

    invoke-static {v11, v3, v2}, Lpkm;->d(Llvn;Llvo;Llzs;)I
    ...
    invoke-static {v11, v2}, Lpkm;->s(Llvn;Llzs;)[F
    ...
    :goto_c
    invoke-virtual/range {p0 .. p1}, Lpkm;->j(Llzs;)Lcom/google/googlex/gcam/AwbInfo;
    ...
    sget-object v3, Lkda;->g:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_d
    sget-object v5, Lkda;->h:Landroid/hardware/camera2/CaptureResult$Key;

    if-eqz v5, :cond_1d

    sget-object v5, Lkda;->h:Landroid/hardware/camera2/CaptureResult$Key;

    invoke-interface {v2, v5}, Llzs;->d(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-interface {v2, v6}, Llzs;->d(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-static {v11, v2}, Lsgcam/Shamim;->GetBlackLevel(Llvn;Llzs;)[F
    ...
    sget-object v4, Lpkm;->d:Llzf;

    invoke-virtual {v4}, Llzf;->g()Z

    move-result v5

    if-nez v5, :cond_2a

    invoke-virtual {v4}, Llzf;->h()Z
    ...
    :cond_2c
    sget-object v3, Lkcz;->b:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :cond_31
    sget-object v3, Lkdb;->k:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    sget-object v5, Lpsu;->i:Lpsu;

    invoke-static {v5, v3, v4}, Lpoy;->s(Lpoy;[BLpon;)Lpoy;

    move-result-object v3

    check-cast v3, Lpsu;

    iget-boolean v4, v3, Lpsu;->a:Z
    ...
    invoke-virtual {v1, v4}, Lpkm;->a(I)F
    ...
    :cond_36
    sget-object v3, Lkcx;->i:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :cond_37
    sget-object v3, Lkcy;->t:Landroid/hardware/camera2/CaptureResult$Key;
    :try_end_2
    ...
    invoke-direct {v2, v4, v5}, Lpjf;-><init>(J)V
    ...
    invoke-static {v2}, Lpjf;->a(Lpjf;)J
...
.method public final n(Llzs;)Lcom/google/googlex/gcam/FrameMetadataKey;
    .locals 4
    ...
    iget-object v2, p0, Lpkm;->b:Llvo;

    invoke-static {v1, v2, p1}, Lpkm;->d(Llvn;Llvo;Llzs;)I
...
.method public final p(Llzs;)Lcom/google/googlex/gcam/SpatialGainMap;
    .locals 18
    ...
    invoke-interface/range {p1 .. p1}, Llzs;->c()Llzn;
    ...
    invoke-interface {v0, v1}, Llzn;->a(Landroid/hardware/camera2/CaptureRequest$Key;)Ljava/lang/Object;
    ...
    sget-object v1, Lpkm;->c:Ljava/lang/String;
    ...
    invoke-interface {v1, v4}, Llvn;->n(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
...
.method public final u(Lcom/google/googlex/gcam/FrameRequest;Llzs;Lgzs;)V
    ...
    invoke-virtual {v2, v3}, Lpkm;->g(Llzs;)Llvn;
    ...
    invoke-static {v3}, Lpkm;->E(Llvn;)[F
    ...
    invoke-interface {v3, v4}, Llvn;->n(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    invoke-static {v8, v4, v5}, Lobm;->at(ZLjava/lang/String;I)V
    ...
    sget-object v0, Lkcy;->k:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    :cond_9
    invoke-interface {v3}, Llvn;->j()Llwa;
...
.method public final w(Lcom/google/googlex/gcam/AeShotParams;Llzs;FLlie;)V
    .locals 17
    ...
    invoke-virtual {v1, v0}, Lpkm;->g(Llzs;)Llvn;

    move-result-object v2

    invoke-interface {v2}, Llvn;->i()Llvq;

    move-result-object v3

    iget-object v3, v3, Llvq;->a:Ljava/lang/String;

    invoke-static {v0, v3}, Lpkm;->i(Llzs;Ljava/lang/String;)Llzs;
    ...
    invoke-static {v4, v0}, Lpkm;->o(Landroid/graphics/Rect;Llzo;)Lcom/google/googlex/gcam/MeshWarp;
    ...
    invoke-static {v5, v6, v3}, Lobm;->av(ZLjava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-interface {v2, v5}, Llvn;->n(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Landroid/graphics/Rect;

    invoke-static/range {p4 .. p4}, Llhq;->h(Llie;)Llhq;

    move-result-object v5

    invoke-virtual {v5, v3}, Llhq;->c(Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    invoke-static {v5, v6, v7}, Loxc;->P(III)I
    ...
    invoke-static {v6, v7, v8}, Loxc;->P(III)I
    ...
    invoke-static {v12, v13, v6}, Loxc;->V(FFF)F
    ...
    invoke-static {v14, v13, v6}, Loxc;->V(FFF)F
    ...
    invoke-static {v10, v13, v6}, Loxc;->V(FFF)F
    ...
    invoke-static {v9, v13, v6}, Loxc;->V(FFF)F

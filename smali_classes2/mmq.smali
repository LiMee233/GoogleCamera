...
# direct methods
.method public constructor <init>(Lmmr;Lmmt;)V
    .locals 0

    iput-object p1, p0, Lmmq;->a:Lmmr;

    iput-object p2, p0, Lmmq;->b:Lmmt;
...
.method public final run()V
    ...
    iput-boolean v2, v1, Lmmt;->b:Z

    :cond_0
    :goto_0
    iget-boolean v2, v1, Lmmt;->b:Z

    if-eqz v2, :cond_1

    :try_start_0
    iget-object v2, v1, Lmmt;->a:Ljava/util/concurrent/ArrayBlockingQueue;
    ...
    iget-object v3, v1, Lmmt;->a:Ljava/util/concurrent/ArrayBlockingQueue;
    ...
    iget-object v1, v1, Lmmt;->a:Ljava/util/concurrent/ArrayBlockingQueue;

    invoke-virtual {v1, v2}, Ljava/util/concurrent/ArrayBlockingQueue;->drainTo(Ljava/util/Collection;)I

    invoke-virtual {v0, v2}, Lmny;->k(Ljava/lang/Object;)V

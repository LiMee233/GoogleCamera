...
# direct methods
.method public constructor <init>(Lmrn;Ljava/util/concurrent/ExecutorService;)V
    .locals 2
    ...
    iput-wide v0, p0, Lmrq;->e:J

    iput-wide v0, p0, Lmrq;->f:J

    const/4 v0, 0x0

    iput-object v0, p0, Lmrq;->g:Ljava/util/concurrent/Future;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lmrq;->h:Z

    iput-object p1, p0, Lmrq;->a:Lmrn;

    iput-object p2, p0, Lmrq;->b:Ljava/util/concurrent/ExecutorService;

    invoke-interface {p1}, Lmrn;->a()Landroid/media/AudioFormat;

    move-result-object p2

    invoke-static {p2}, Lmrr;->a(Landroid/media/AudioFormat;)I
...
.method private final declared-synchronized f()V
    ...
    :try_start_0
    iget-boolean v0, p0, Lmrq;->h:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lmrq;->g:Ljava/util/concurrent/Future;
...
.method public final declared-synchronized b(Ljava/nio/ByteBuffer;I)Lmrm;
    ...
    invoke-direct {p0}, Lmrq;->e()J

    move-result-wide v2

    iput-wide v2, p0, Lmrq;->e:J
    ...
    invoke-static {p1, p2, v2, v3}, Lmrm;->a(Ljava/nio/ByteBuffer;IJ)Lmrm;

    move-result-object v0

    int-to-long v1, v1

    iget-wide v3, p0, Lmrq;->f:J

    add-long/2addr v3, v1

    iput-wide v3, p0, Lmrq;->f:J

    iget-wide v3, p0, Lmrq;->e:J

    iget-wide v5, p0, Lmrq;->d:J
    :try_end_4
...
.method public final declared-synchronized c()V
    ...
    iget-object v0, p0, Lmrq;->b:Ljava/util/concurrent/ExecutorService;

    iget-object v1, p0, Lmrq;->a:Lmrn;

    new-instance v2, Lmrp;

    invoke-direct {v2, v1}, Lmrp;-><init>(Lmrn;)V

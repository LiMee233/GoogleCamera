...
.method static constructor <clinit>()V
    ...
    sput-boolean v6, Lkcy;->y:Z

    const/4 v7, 0x2

    invoke-static {v7}, Lkcy;->a(I)Z
    ...
    :goto_0
    sput-object v7, Lkcy;->a:Landroid/hardware/camera2/CaptureResult$Key;

    invoke-static {v1}, Lkcy;->a(I)Z
    ...
    :goto_1
    sput-object v1, Lkcy;->b:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    :goto_2
    sput-object v1, Lkcy;->c:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    :goto_3
    sput-object v1, Lkcy;->d:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    :goto_4
    sput-object v1, Lkcy;->e:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    :goto_5
    sput-object v1, Lkcy;->f:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    :goto_6
    sput-object v3, Lkcy;->g:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_7
    sput-object v3, Lkcy;->h:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_8
    sput-object v3, Lkcy;->i:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_9
    sput-object v1, Lkcy;->j:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_a
    sput-object v3, Lkcy;->k:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    :goto_b
    sput-object v3, Lkcy;->l:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_c
    sput-object v3, Lkcy;->m:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_d
    sput-object v3, Lkcy;->n:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_e
    sput-object v3, Lkcy;->o:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_f
    sput-object v3, Lkcy;->p:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_10
    sput-object v1, Lkcy;->q:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_11
    sput-object v3, Lkcy;->r:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_12
    sput-object v3, Lkcy;->s:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_13
    sput-object v8, Lkcy;->t:Landroid/hardware/camera2/CaptureResult$Key;

...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-direct {v2, v1}, Lyl;-><init>(Landroid/content/Context;)V

    iput-object v2, v0, Landroid/support/wearable/view/ActionPage;->b:Lyl;

    new-instance v2, Lyg;

    invoke-direct {v2, v1}, Lyg;-><init>(Landroid/content/Context;)V

    iput-object v2, v0, Landroid/support/wearable/view/ActionPage;->a:Lyg;

    const/16 v3, 0x11

    invoke-virtual {v2, v3}, Lyg;->b(I)V

    iget-object v2, v0, Landroid/support/wearable/view/ActionPage;->a:Lyg;

    const/4 v4, 0x2

    invoke-virtual {v2, v4}, Lyg;->a(I)V

    sget-object v2, Lxb;->b:[I
    ...
    iget-object v15, v0, Landroid/support/wearable/view/ActionPage;->b:Lyl;

    invoke-virtual {v2, v6}, Landroid/content/res/TypedArray;->getColorStateList(I)Landroid/content/res/ColorStateList;

    move-result-object v6

    iput-object v6, v15, Lyl;->b:Landroid/content/res/ColorStateList;

    iget-object v6, v15, Lyl;->a:Landroid/graphics/drawable/ShapeDrawable;

    invoke-virtual {v6}, Landroid/graphics/drawable/ShapeDrawable;->getPaint()Landroid/graphics/Paint;

    move-result-object v6

    iget-object v15, v15, Lyl;->b:Landroid/content/res/ColorStateList;
    ...
    iget-object v4, v15, Lyl;->c:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v6, v15, Lyl;->c:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v15}, Lyl;->requestLayout()V

    invoke-virtual {v15}, Lyl;->invalidate()V
    ...
    iget-object v6, v0, Landroid/support/wearable/view/ActionPage;->b:Lyl;
    ...
    iget-object v4, v6, Lyl;->c:Landroid/graphics/drawable/Drawable;

    if-eqz v4, :cond_4

    invoke-virtual {v6}, Lyl;->invalidate()V

    invoke-virtual {v6}, Lyl;->requestLayout()V
    ...
    invoke-virtual {v6, v4}, Lyl;->a(I)V
    ...
    iget-object v4, v0, Landroid/support/wearable/view/ActionPage;->b:Lyl;

    invoke-virtual {v2, v3, v5}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v6

    invoke-virtual {v4, v6}, Lyl;->a(F)V
    ...
    iget-object v6, v0, Landroid/support/wearable/view/ActionPage;->a:Lyg;
    ...
    iget-object v15, v6, Lyg;->c:Ljava/lang/CharSequence;
    ...
    iput-object v8, v6, Lyg;->a:Landroid/text/Layout;

    iput-object v4, v6, Lyg;->c:Ljava/lang/CharSequence;

    invoke-virtual {v6}, Lyg;->requestLayout()V

    invoke-virtual {v6}, Lyg;->invalidate()V
    ...
    invoke-virtual {v6}, Lyg;->getContext()Landroid/content/Context;
    ...
    iput-object v15, v6, Lyg;->b:Landroid/content/res/ColorStateList;

    invoke-virtual {v6}, Lyg;->a()V
    ...
    invoke-virtual {v6, v4}, Lyg;->a(I)V
    ...
    iget-object v15, v0, Landroid/support/wearable/view/ActionPage;->a:Lyg;

    invoke-virtual {v2, v4, v3}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v4

    invoke-virtual {v15, v4}, Lyg;->b(I)V
    ...
    invoke-virtual {v15, v4}, Lyl;->setStateListAnimator(Landroid/animation/StateListAnimator;)V
    ...
    iget-object v1, v0, Landroid/support/wearable/view/ActionPage;->a:Lyg;
    ...
    iget-object v2, v1, Lyg;->a:Landroid/text/Layout;
    ...
    :cond_18
    iput-object v8, v1, Lyg;->a:Landroid/text/Layout;

    invoke-virtual {v1}, Lyg;->requestLayout()V

    invoke-virtual {v1}, Lyg;->invalidate()V

    :cond_19
    :goto_5
    iget-object v1, v0, Landroid/support/wearable/view/ActionPage;->a:Lyg;

    invoke-virtual {v1, v14, v12, v13}, Lyg;->a(Ljava/lang/String;II)V

    iget-object v1, v0, Landroid/support/wearable/view/ActionPage;->a:Lyg;

    invoke-virtual {v0, v1}, Landroid/support/wearable/view/ActionPage;->addView(Landroid/view/View;)V

    iget-object v1, v0, Landroid/support/wearable/view/ActionPage;->b:Lyl;
...
.method protected final onLayout(ZIIII)V
    ...
    iget-object p1, p0, Landroid/support/wearable/view/ActionPage;->b:Lyl;
    ...
    invoke-virtual {p1, p3, p5, v0, v1}, Lyl;->layout(IIII)V
    ...
    iget-object p2, p0, Landroid/support/wearable/view/ActionPage;->a:Lyg;

    iget-object p3, p0, Landroid/support/wearable/view/ActionPage;->b:Lyl;

    invoke-virtual {p3}, Lyl;->getBottom()I
    ...
    iget-object p5, p0, Landroid/support/wearable/view/ActionPage;->b:Lyl;

    invoke-virtual {p5}, Lyl;->getBottom()I
    ...
    invoke-virtual {p2, p1, p3, p4, p5}, Lyg;->layout(IIII)V
...
.method protected final onMeasure(II)V
    ...
    iget-object v0, p0, Landroid/support/wearable/view/ActionPage;->b:Lyl;
    ...
    iget-object v1, v0, Lyl;->c:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, v1, v1}, Lyl;->measure(II)V

    iget-object v0, p0, Landroid/support/wearable/view/ActionPage;->b:Lyl;

    invoke-virtual {v0}, Lyl;->getMeasuredWidth()I

    move-result v0

    iget-object v1, p0, Landroid/support/wearable/view/ActionPage;->b:Lyl;

    invoke-virtual {v1}, Lyl;->getMeasuredHeight()I
    ...
    invoke-virtual {v1, v0, v2}, Lyl;->measure(II)V
    ...
    iget-object p1, p0, Landroid/support/wearable/view/ActionPage;->a:Lyg;
    ...
    invoke-virtual {p1, p2, v0}, Lyg;->measure(II)V
...
.method public final setEnabled(Z)V
    ...
    invoke-virtual {v0, p1}, Lyl;->setEnabled(Z)V
...
.method public final setOnClickListener(Landroid/view/View$OnClickListener;)V
    ...
    invoke-virtual {v0, p1}, Lyl;->setOnClickListener(Landroid/view/View$OnClickListener;)V
...
.method public final setStateListAnimator(Landroid/animation/StateListAnimator;)V
    ...
    invoke-virtual {v0, p1}, Lyl;->setStateListAnimator(Landroid/animation/StateListAnimator;)V

...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p1, p2, p3}, Lpr;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    sget-object v0, Lnk;->d:[I
    ...
    invoke-virtual {p1, p2, v1}, Lwg;->f(II)I
    ...
    invoke-virtual {p1, p2, v1}, Lwg;->e(II)I
    ...
    invoke-virtual {p1, p2, p3}, Lwg;->f(II)I
...
.method public final a(Lnq;)V
    ...
    invoke-direct {v2, p1}, Lpt;-><init>(Lnq;)V

    invoke-virtual {v0, v2}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-virtual {p1}, Lnq;->b()Landroid/view/Menu;

    move-result-object p1

    check-cast p1, Los;

    iget-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Lqf;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Lqf;

    iget-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Lqf;

    invoke-virtual {v0}, Lqf;->h()V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Lqf;

    iget-object v3, p0, Landroid/support/v7/widget/ActionBarContextView;->b:Landroid/content/Context;

    invoke-virtual {p1, v2, v3}, Los;->a(Lpg;Landroid/content/Context;)V

    iget-object p1, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Lqf;

    iget-object v2, p1, Lqf;->f:Lpi;

    iget-object v3, p1, Lof;->f:Lpi;

    if-nez v3, :cond_3

    iget-object v3, p1, Lof;->d:Landroid/view/LayoutInflater;
    ...
    iput-object v1, p1, Lof;->f:Lpi;

    iget-object v1, p1, Lof;->f:Lpi;

    iget-object v3, p1, Lof;->c:Los;

    invoke-interface {v1, v3}, Lpi;->a(Los;)V
    ...
    invoke-virtual {v2, p1}, Landroid/support/v7/widget/ActionMenuView;->a(Lqf;)V
    ...
    invoke-static {p1, v1}, Lkb;->a(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
...
.method public final onDetachedFromWindow()V
    ...
    invoke-super {p0}, Lpr;->onDetachedFromWindow()V
...
.method public final onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    :cond_0
    invoke-super {p0, p1}, Lpr;->onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V

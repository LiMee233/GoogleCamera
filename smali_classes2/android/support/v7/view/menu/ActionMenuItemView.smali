...
.method private final g()V
    ...
    iget-object v2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->b:Lov;
    ...
    iget-object v2, v2, Lov;->l:Ljava/lang/CharSequence;
    ...
    iget-object v2, v2, Lov;->d:Ljava/lang/CharSequence;
    ...
    iget-object v2, v2, Lov;->m:Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->b:Lov;

    iget-object v1, v0, Lov;->d:Ljava/lang/CharSequence;
    ...
    :goto_4
    invoke-static {p0, v1}, Lokd;->a(Landroid/view/View;Ljava/lang/CharSequence;)V

    return-void

    :cond_6
    invoke-static {p0, v2}, Lokd;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public final a(Lov;)V
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->b:Lov;
    ...
    invoke-virtual {p0, v0, v2, v2, v2}, Lrw;->setCompoundDrawables(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V

    invoke-direct {p0}, Landroid/support/v7/view/menu/ActionMenuItemView;->g()V

    invoke-virtual {p1, p0}, Lov;->a(Lph;)Ljava/lang/CharSequence;
    ...
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->g:Ltb;

    if-nez p1, :cond_4

    new-instance p1, Lod;

    invoke-direct {p1, p0}, Lod;-><init>(Landroid/support/v7/view/menu/ActionMenuItemView;)V

    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->g:Ltb;
...
.method public final d()Z
    ...
    invoke-virtual {v0}, Lov;->getIcon()Landroid/graphics/drawable/Drawable;
...
.method public final onClick(Landroid/view/View;)V
    ...
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->c:Lor;

    if-eqz p1, :cond_0

    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->b:Lov;

    invoke-interface {p1, v0}, Lor;->a(Lov;)Z
...
.method public final onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-super {p0, p1}, Lrw;->onConfigurationChanged(Landroid/content/res/Configuration;)V
...
.method protected final onMeasure(II)V
    ...
    invoke-super {p0, v1, v2, v3, v4}, Lrw;->setPadding(IIII)V
    ...
    invoke-super {p0, p1, p2, v0, v1}, Lrw;->setPadding(IIII)V
...
.method public final onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-super {p0, p1}, Lrw;->onRestoreInstanceState(Landroid/os/Parcelable;)V
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0}, Lov;->hasSubMenu()Z
    ...
    :cond_0
    invoke-super {p0, p1}, Lrw;->onTouchEvent(Landroid/view/MotionEvent;)Z
...
.method public final setPadding(IIII)V
    ...
    invoke-super {p0, p1, p2, p3, p4}, Lrw;->setPadding(IIII)V

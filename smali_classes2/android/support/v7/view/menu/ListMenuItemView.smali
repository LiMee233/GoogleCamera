...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {p2, p3}, Lwg;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p2, p3, v0}, Lwg;->f(II)I
    ...
    invoke-virtual {p2, v0}, Lwg;->a(I)Landroid/graphics/drawable/Drawable;
...
.method public final a()Lov;
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/ListMenuItemView;->a:Lov;
...
.method public final a(Lov;)V
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/ListMenuItemView;->a:Lov;
    ...
    :cond_4
    :goto_2
    iget-object v3, p0, Landroid/support/v7/view/menu/ListMenuItemView;->a:Lov;

    invoke-virtual {v3}, Lov;->e()Z
    ...
    :cond_b
    :goto_5
    invoke-virtual {p1}, Lov;->d()Z

    move-result v0

    invoke-virtual {p1}, Lov;->c()C

    if-eqz v0, :cond_d

    iget-object v0, p0, Landroid/support/v7/view/menu/ListMenuItemView;->a:Lov;

    invoke-virtual {v0}, Lov;->d()Z
    ...
    iget-object v4, p0, Landroid/support/v7/view/menu/ListMenuItemView;->a:Lov;

    invoke-virtual {v4}, Lov;->c()C

    move-result v5

    if-eqz v5, :cond_13

    iget-object v6, v4, Lov;->j:Los;

    iget-object v6, v6, Los;->a:Landroid/content/Context;
    ...
    iget-object v8, v4, Lov;->j:Los;

    iget-object v8, v8, Los;->a:Landroid/content/Context;
    ...
    invoke-static {v7, v4, v8, v9}, Lov;->a(Ljava/lang/StringBuilder;IILjava/lang/String;)V
    ...
    invoke-static {v7, v4, v2, v8}, Lov;->a(Ljava/lang/StringBuilder;IILjava/lang/String;)V
    ...
    :cond_1f
    iget-object p1, p1, Lov;->l:Ljava/lang/CharSequence;
...
.method protected final onFinishInflate()V
    ...
    invoke-static {p0, v0}, Lkb;->a(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V

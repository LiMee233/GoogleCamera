...
.method public constructor <init>(Lcom/google/android/apps/camera/zoomui/ZoomUi;Ljava/util/Set;Llcy;Lfjr;Lcwj;Llcm;Ldde;Llcm;Lkab;Ljtw;)V
    ...
    invoke-direct {v3, p0}, Lkbl;-><init>(Lkbv;)V

    iput-object v3, v0, Lkbv;->a:Landroid/animation/AnimatorListenerAdapter;

    new-instance v4, Lkbm;

    invoke-direct {v4, p0}, Lkbm;-><init>(Lkbv;)V

    iput-object v4, v0, Lkbv;->b:Landroid/animation/AnimatorListenerAdapter;

    new-instance v5, Lkbn;

    invoke-direct {v5, p0}, Lkbn;-><init>(Lkbv;)V

    iput-object v5, v0, Lkbv;->c:Landroid/animation/AnimatorListenerAdapter;

    new-instance v6, Lkbj;

    invoke-direct {v6, p0}, Lkbj;-><init>(Lkbv;)V

    iput-object v6, v0, Lkbv;->d:Landroid/animation/ValueAnimator$AnimatorUpdateListener;

    new-instance v7, Lkbk;

    const/4 v8, 0x2

    invoke-direct {v7, p0, v8}, Lkbk;-><init>(Lkbv;I)V

    iput-object v7, v0, Lkbv;->e:Ljava/lang/Runnable;

    new-instance v7, Lkbk;

    const/4 v9, 0x1

    invoke-direct {v7, p0, v9}, Lkbk;-><init>(Lkbv;I)V

    iput-object v7, v0, Lkbv;->f:Ljava/lang/Runnable;
    ...
    iput v10, v0, Lkbv;->F:I

    iput-boolean v7, v0, Lkbv;->x:Z

    invoke-static {}, Llap;->a()V

    move-object v10, p2

    iput-object v10, v0, Lkbv;->y:Ljava/util/Set;

    move-object/from16 v10, p3

    iput-object v10, v0, Lkbv;->h:Llcy;

    move-object/from16 v10, p5

    iput-object v10, v0, Lkbv;->g:Lcwj;

    move-object/from16 v10, p4

    iput-object v10, v0, Lkbv;->z:Lfjr;

    move-object/from16 v10, p6

    iput-object v10, v0, Lkbv;->u:Llcm;

    iput-object v2, v0, Lkbv;->v:Ldde;

    move-object/from16 v10, p8

    iput-object v10, v0, Lkbv;->o:Llcm;

    iput-object v1, v0, Lkbv;->p:Lcom/google/android/apps/camera/zoomui/ZoomUi;

    move-object/from16 v10, p9

    iput-object v10, v0, Lkbv;->C:Lkab;

    move-object/from16 v10, p10

    iput-object v10, v0, Lkbv;->q:Ljtw;

    sget-object v10, Lddk;->W:Lddf;

    invoke-interface {v2, v10}, Ldde;->k(Lddf;)Z

    move-result v10

    iput-boolean v10, v0, Lkbv;->D:Z
    ...
    iput-object v1, v0, Lkbv;->l:Landroid/animation/ValueAnimator;
    ...
    iput-object v1, v0, Lkbv;->k:Landroid/animation/ValueAnimator;
    ...
    iput-object v1, v0, Lkbv;->n:Landroid/animation/ValueAnimator;
    ...
    invoke-direct {v3, v10}, Lkbo;-><init>(Landroid/view/View;)V
    ...
    iput-object v3, v0, Lkbv;->A:Landroid/animation/AnimatorSet;
...
.method public final A(I)V
    ...
    iget-object v0, p0, Lkbv;->y:Ljava/util/Set;
    ...
    invoke-interface {v1, p1}, Lkao;->p(I)V
...
.method public final B(I)V
    ...
    iget-boolean v2, v1, Lkbv;->x:Z

    const/16 v3, 0x8

    if-nez v2, :cond_0

    iget-object v2, v1, Lkbv;->B:Landroid/view/ViewGroup;
    ...
    iget-object v2, v1, Lkbv;->A:Landroid/animation/AnimatorSet;

    invoke-virtual {v2}, Landroid/animation/AnimatorSet;->start()V

    :cond_0
    iget-object v2, v1, Lkbv;->p:Lcom/google/android/apps/camera/zoomui/ZoomUi;
    ...
    sget-object v9, Lkac;->a:Lkac;

    sget-object v9, Ljrx;->a:Ljrx;
    ...
    invoke-direct {v7, v2}, Lkai;-><init>(Lcom/google/android/apps/camera/zoomui/ZoomUi;)V
    ...
    invoke-direct {v6, v2}, Lkaj;-><init>(Lcom/google/android/apps/camera/zoomui/ZoomUi;)V
    ...
    :cond_9
    sget-object v3, Lcom/google/android/apps/camera/zoomui/ZoomUi;->b:Loue;
    ...
    invoke-interface/range {v18 .. v23}, Loub;->u(Ljava/lang/String;JJ)V
    ...
    invoke-direct {v5, v2, v15}, Lkag;-><init>(Lcom/google/android/apps/camera/zoomui/ZoomUi;I)V

    invoke-virtual {v3, v5}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    new-instance v5, Lkak;

    invoke-direct {v5, v2}, Lkak;-><init>(Lcom/google/android/apps/camera/zoomui/ZoomUi;)V
    ...
    invoke-virtual {v4}, Lkac;->ordinal()I

    move-result v4

    iget-object v5, v1, Lkbv;->C:Lkab;

    iget v7, v1, Lkbv;->t:F

    invoke-virtual {v5, v3, v7}, Lkab;->c(FF)F
    ...
    invoke-virtual {v5}, Lkab;->b()F

    move-result v5

    iget-object v7, v1, Lkbv;->C:Lkab;

    sget-object v9, Lkac;->d:Lkac;

    invoke-virtual {v9}, Lkac;->ordinal()I

    move-result v9

    invoke-virtual {v7, v9}, Lkab;->a(I)F
    ...
    sget-object v3, Lkac;->d:Lkac;

    invoke-virtual {v3}, Lkac;->ordinal()I
    ...
    sget-object v7, Lkac;->d:Lkac;

    invoke-virtual {v7}, Lkac;->ordinal()I

    move-result v7

    invoke-virtual {v5, v7}, Lkab;->a(I)F
    ...
    :pswitch_4
    iget-object v4, v1, Lkbv;->C:Lkab;

    invoke-virtual {v4, v8}, Lkab;->a(I)F

    move-result v5

    iget v7, v1, Lkbv;->t:F

    invoke-virtual {v4, v5, v7}, Lkab;->c(FF)F
    ...
    iget-object v2, v1, Lkbv;->C:Lkab;

    iget-object v3, v1, Lkbv;->p:Lcom/google/android/apps/camera/zoomui/ZoomUi;

    iget-object v4, v1, Lkbv;->h:Llcy;
    ...
    invoke-virtual {v2, v4}, Lkab;->d(F)Lkac;

    move-result-object v4

    invoke-virtual {v2, v3, v4}, Lkab;->g(Lcom/google/android/apps/camera/zoomui/ZoomUi;Lkac;)V

    iget-object v2, v1, Lkbv;->h:Llcy;
    ...
    iget-object v3, v1, Lkbv;->C:Lkab;

    invoke-virtual {v3, v2}, Lkab;->i(F)Z
    ...
    invoke-virtual {v2, v5}, Lkab;->f(Ljrj;)Ljava/util/Map;

    move-result-object v5

    invoke-virtual {v2, v4}, Lkab;->i(F)Z
    ...
    :goto_b
    iget-object v6, v2, Lkab;->c:Llcy;

    check-cast v6, Llcc;

    iget-object v6, v6, Llcc;->d:Ljava/lang/Object;
    ...
    invoke-virtual {v2, v4, v6}, Lkab;->c(FF)F

    move-result v6

    check-cast v5, Loom;

    invoke-virtual {v5}, Loom;->t()Looz;
    ...
    invoke-virtual {v10}, Lkac;->ordinal()I
    ...
    invoke-virtual {v2, v10, v6}, Lkab;->j(Lkac;F)Z

    move-result v10

    if-nez v10, :cond_18

    invoke-virtual {v2, v6}, Lkab;->k(F)Z
    ...
    invoke-virtual {v2, v3, v9}, Lkab;->g(Lcom/google/android/apps/camera/zoomui/ZoomUi;Lkac;)V

    invoke-virtual {v3}, Lcom/google/android/apps/camera/zoomui/ZoomUi;->k()Landroid/widget/TextView;

    move-result-object v9

    invoke-virtual {v2, v7, v4, v8}, Lkab;->e(ZFZ)Ljava/lang/String;
    ...
    invoke-virtual {v2, v4}, Lkab;->l(F)Z
    ...
    invoke-virtual {v2, v10, v6}, Lkab;->m(Lkac;F)Z
...
.method final r()V
    ...
    iget-object v0, p0, Lkbv;->B:Landroid/view/ViewGroup;

    if-eqz v0, :cond_1

    iget-boolean v1, p0, Lkbv;->w:Z

    if-eqz v1, :cond_0

    iget-object v1, p0, Lkbv;->e:Ljava/lang/Runnable;
    ...
    :cond_0
    iget-object v1, p0, Lkbv;->f:Ljava/lang/Runnable;
...
.method public final s(Z)V
    ...
    iget-boolean v0, p0, Lkbv;->w:Z

    if-eqz v0, :cond_1

    iget-boolean v0, p0, Lkbv;->x:Z
    ...
    iget-object p1, p0, Lkbv;->A:Landroid/animation/AnimatorSet;
    ...
    :cond_2
    iget-object p1, p0, Lkbv;->B:Landroid/view/ViewGroup;
...
.method public final t()V
    ...
    invoke-virtual {p0, v0}, Lkbv;->B(I)V
...
.method public final u()V
    ...
    iget-object v0, p0, Lkbv;->p:Lcom/google/android/apps/camera/zoomui/ZoomUi;
    ...
    invoke-direct {v5, v0}, Lkal;-><init>(Lcom/google/android/apps/camera/zoomui/ZoomUi;)V
    ...
    new-instance v6, Lkam;

    invoke-direct {v6, v0}, Lkam;-><init>(Lcom/google/android/apps/camera/zoomui/ZoomUi;)V
    ...
    invoke-direct {v6, v0}, Lkan;-><init>(Lcom/google/android/apps/camera/zoomui/ZoomUi;)V
    ...
    invoke-virtual {p0}, Lkbv;->r()V

    invoke-virtual {p0}, Lkbv;->w()V
...
.method public final v()V
    ...
    iget-object v0, p0, Lkbv;->A:Landroid/animation/AnimatorSet;
...
.method public final w()V
    ...
    :goto_0
    iget-object v1, p0, Lkbv;->v:Ldde;

    sget-object v2, Lddk;->aM:Lddf;
    ...
    iget-object v1, p0, Lkbv;->B:Landroid/view/ViewGroup;

    iget-object v2, p0, Lkbv;->e:Ljava/lang/Runnable;
    ...
    iget-object v2, p0, Lkbv;->f:Ljava/lang/Runnable;
...
.method public final x()V
    ...
    iget-object v0, p0, Lkbv;->i:Lcom/google/android/apps/camera/zoomui/ZoomKnob;
    ...
    iget-object v1, p0, Lkbv;->i:Lcom/google/android/apps/camera/zoomui/ZoomKnob;

    new-instance v2, Lkbk;

    const/4 v3, 0x0

    invoke-direct {v2, p0, v3}, Lkbk;-><init>(Lkbv;I)V
...
.method public final z(IFF)V
    ...
    iget-object v0, p0, Lkbv;->z:Lfjr;

    iget-object v1, p0, Lkbv;->g:Lcwj;

    invoke-interface {v1}, Lcwj;->d()Llwb;

    move-result-object v1

    invoke-interface {v0, p1, p2, p3, v1}, Lfjr;->M(IFFLlwb;)V

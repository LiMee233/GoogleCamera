...
.field private final c:Lqsp;


# direct methods
.method public constructor <init>(Lqkb;Lvr;Lwl;Lwn;)V
    .locals 0
    ...
    invoke-static {p1, p2, p3}, Lqly;->G(III)Lqsp;

    move-result-object p1

    iput-object p1, p0, Lwa;->c:Lqsp;
    ...
    iget-object p1, p4, Lwn;->a:Lqqe;

    new-instance p2, Lqqd;

    const-string p3, "CXCP-VirtualCameraManager"

    invoke-direct {p2, p3}, Lqqd;-><init>(Ljava/lang/String;)V

    new-instance p3, Lvv;

    const/4 p4, 0x0

    invoke-direct {p3, p0, p4}, Lvv;-><init>(Lwa;Lqlc;)V

    const/4 p4, 0x2

    invoke-static {p1, p2, p3, p4}, Lqnh;->h(Lqqe;Lqli;Lqmt;I)Lqrb;
...
# virtual methods
.method public final a(Ljava/util/List;Lqlc;)Ljava/lang/Object;
    .locals 4
    ...
    invoke-direct {v0, p0, p2}, Lvw;-><init>(Lwa;Lqlc;)V
    ...
    invoke-interface {p2, v0}, Lqsp;->b(Lqlc;)Ljava/lang/Object;
    ...
    iget-object v2, p2, Lwa;->c:Lqsp;

    invoke-interface {v2}, Lqsp;->l()Z

    move-result v2

    if-nez v2, :cond_4

    iget-object p2, p2, Lwa;->c:Lqsp;

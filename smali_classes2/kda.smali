...
.method static constructor <clinit>()V
    ...
    sput-boolean v3, Lkda;->u:Z

    const/4 v4, 0x1

    invoke-static {v4}, Lkda;->a(I)Z
    ...
    :goto_2
    sput-object v5, Lkda;->a:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_4
    sput-object v5, Lkda;->b:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_6
    sput-object v5, Lkda;->c:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_8
    sput-object v4, Lkda;->d:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    :goto_9
    sput-object v5, Lkda;->e:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_b
    sput-object v0, Lkda;->f:Landroid/hardware/camera2/CaptureResult$Key;

    invoke-static {v2}, Lkda;->a(I)Z
    ...
    :goto_16
    sput-object v1, Lkda;->g:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_17
    sput-object v0, Lkda;->h:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_18
    sput-object v1, Lkda;->i:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_1b
    sput-object v1, Lkda;->k:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_1c
    sput-object v1, Lkda;->l:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_1d
    sput-object v1, Lkda;->m:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_1f
    sput-object v1, Lkda;->n:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_20
    sput-object v1, Lkda;->o:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_21
    sput-object v0, Lkda;->p:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_23
    sput-object v1, Lkda;->q:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_27
    sput-object v6, Lkda;->s:Landroid/hardware/camera2/CaptureResult$Key;

...
# direct methods
.method public constructor <init>(Lodq;[B)V
    .locals 1
    ...
    iput-object p2, p0, Lnio;->c:Ljava/lang/Object;

    new-instance p2, Lnir;

    const/4 v0, 0x0

    invoke-direct {p2, v0}, Lnir;-><init>([B)V

    iput-object p2, p0, Lnio;->b:Lnjg;

    iget-object p1, p1, Lodq;->a:Landroid/content/Context;

    iput-object p1, p0, Lnio;->a:Landroid/content/Context;
...
.method private final h(Landroid/net/Uri;)Z
    ...
    iget-object v0, p0, Lnio;->a:Landroid/content/Context;
...
.method protected final a(Landroid/net/Uri;)Landroid/net/Uri;
    ...
    invoke-direct {p0, p1}, Lnio;->h(Landroid/net/Uri;)Z

    move-result v0

    if-nez v0, :cond_0

    invoke-virtual {p0, p1}, Lnjh;->c(Landroid/net/Uri;)Ljava/io/File;
    ...
    invoke-static {p1}, Lnjc;->b(Ljava/util/List;)Ljava/lang/String;
    ...
    invoke-direct {p1, v0}, Lniv;-><init>(Ljava/lang/String;)V

    throw p1
.end method

.method protected final b()Lnjg;
    .locals 1

    iget-object v0, p0, Lnio;->b:Lnjg;
...
.method public final c(Landroid/net/Uri;)Ljava/io/File;
    ...
    invoke-direct {v0, p1}, Lniv;-><init>(Ljava/lang/String;)V
    ...
    :pswitch_1
    invoke-static {v0}, Lmyv;->d(Landroid/content/Context;)Ljava/io/File;
    ...
    invoke-static {p1}, Lnin;->a(Ljava/lang/String;)Landroid/accounts/Account;

    move-result-object p1
    :try_end_0
    .catch Ljava/lang/IllegalArgumentException; {:try_start_0 .. :try_end_0} :catch_0

    invoke-static {p1}, Lnin;->c(Landroid/accounts/Account;)Z
    ...
    invoke-direct {v0, p1}, Lniv;-><init>(Ljava/lang/Throwable;)V
    ...
    iget-object p1, p0, Lnio;->a:Landroid/content/Context;

    invoke-static {p1}, Lmey;->c(Landroid/content/Context;)Z
    ...
    :cond_3
    iget-object v1, p0, Lnio;->c:Ljava/lang/Object;

    monitor-enter v1

    :try_start_1
    iget-object p1, p0, Lnio;->d:Ljava/lang/String;
    ...
    invoke-static {p1}, Lmyv;->d(Landroid/content/Context;)Ljava/io/File;
    ...
    iput-object p1, p0, Lnio;->d:Ljava/lang/String;
    ...
    invoke-direct {p1, v0}, Lniu;-><init>(Ljava/lang/String;)V
...
.method public final d(Landroid/net/Uri;)Ljava/io/InputStream;
    ...
    invoke-interface {v0, p1}, Lnjg;->d(Landroid/net/Uri;)Ljava/io/InputStream;
...
.method public final f(Landroid/net/Uri;)Z
    ...
    invoke-interface {v0, p1}, Lnjg;->f(Landroid/net/Uri;)Z

.class public Lcom/dmgc/ota/OTAUtils;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/dmgc/ota/OTAUtils$CheckVersion;
    }
.end annotation
...
.method static synthetic access$000(Ljava/lang/String;Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p0, p1}, Lcom/dmgc/ota/OTAUtils;->getString(Ljava/lang/String;Landroid/content/Context;)Ljava/lang/String;
...
.method static synthetic access$100(Landroid/content/Context;)Landroid/app/AlertDialog;
    ...
    invoke-static {p0}, Lcom/dmgc/ota/OTAUtils;->createAlertDialog(Landroid/content/Context;)Landroid/app/AlertDialog;
...
.method static synthetic access$200(Ljava/lang/String;Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, p1, p2}, Lcom/dmgc/ota/OTAUtils;->getString(Ljava/lang/String;Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
...
.method public static hookPreference(Landroid/preference/PreferenceFragment;)V
    ...
    new-instance v1, Lcom/dmgc/ota/OTAUtils$2;

    invoke-direct {v1, p0}, Lcom/dmgc/ota/OTAUtils$2;-><init>(Landroid/preference/PreferenceFragment;)V
...
.method static synthetic lambda$hookPreference$0(Landroid/preference/PreferenceFragment;Landroid/preference/Preference;)Z
    ...
    new-instance p1, Lcom/dmgc/ota/OTAUtils$CheckVersion;

    invoke-virtual {p0}, Landroid/preference/PreferenceFragment;->getContext()Landroid/content/Context;

    move-result-object p0

    invoke-direct {p1, p0}, Lcom/dmgc/ota/OTAUtils$CheckVersion;-><init>(Landroid/content/Context;)V

    const/4 p0, 0x0

    new-array v0, p0, [Ljava/lang/Void;

    invoke-virtual {p1, v0}, Lcom/dmgc/ota/OTAUtils$CheckVersion;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;

...
.method private static A(Lmda;)Last;
    .locals 3

    const/4 v0, 0x1

    invoke-static {p0, v0, v0}, Lmdb;->w(Lmda;ZZ)Ljava/util/List;

    move-result-object p0

    invoke-static {p0}, Lmdb;->s(Ljava/util/List;)Last;
...
.method private static B(Lmda;Ljava/io/OutputStream;Last;Last;)V
    .locals 11
    ...
    invoke-static {p3}, Lmdb;->y(Last;)[B
    ...
    :cond_1
    invoke-static {v0}, Lmdb;->v([B)Ljava/lang/String;
    ...
    :goto_0
    invoke-static {p2}, Lmdb;->y(Last;)[B
    ...
    invoke-static {p0, p2, p2}, Lmdb;->w(Lmda;ZZ)Ljava/util/List;

    move-result-object p0

    invoke-static {p0, v1}, Lmdb;->r(Ljava/util/List;[B)I
    ...
    invoke-static {p0, v1}, Lohc;->U(Ljava/lang/Iterable;Loja;)V
    ...
    invoke-static {v10, p2, v9, p2}, Lmdb;->q([BI[BI)I

    move-result v10

    invoke-static {v8}, Lmdb;->z(I)[B

    move-result-object v8

    invoke-static {v8, p2, v9, v10}, Lmdb;->q([BI[BI)I

    move-result v8

    add-int/2addr v10, v8

    invoke-static {v7}, Lmdb;->z(I)[B
    ...
    invoke-static {v0, v7, v9, v10}, Lmdb;->q([BI[BI)I

    move-result v8

    add-int/2addr v7, v8

    invoke-static {v9}, Lmdb;->t([B)Lmcz;
    ...
    :cond_8
    :try_start_1
    invoke-static {p1, p0}, Lmdb;->x(Ljava/io/OutputStream;Ljava/util/List;)V
    :try_end_1
...
.method public static c(Ljava/lang/String;)Loix;
    .locals 1
...
.method public static d([BLast;)Loiy;
    .locals 2

    new-instance v0, Lmcx;

    invoke-direct {v0, p0}, Lmcx;-><init>([B)V

    invoke-static {v0}, Lmdb;->u(Lmda;)Loiy;
    ...
    iget-object p0, p0, Loiy;->b:Ljava/lang/Object;
    ...
    :cond_1
    :goto_1
    invoke-static {v1, p1}, Lmdb;->b(Last;Last;)Last;

    move-result-object p0

    invoke-static {v0, p0}, Loiy;->a(Ljava/lang/Object;Ljava/lang/Object;)Loiy;
...
.method public static e(Ljava/io/InputStream;)Loiy;
    .locals 1

    new-instance v0, Lmcy;

    invoke-direct {v0, p0}, Lmcy;-><init>(Ljava/io/InputStream;)V
...
.method public static g(Lmcz;Ljava/lang/String;)Z
    .locals 4
...
.method public static h(Ljava/lang/String;Last;)Z
    ...
    invoke-direct {v3, v1}, Lmcy;-><init>(Ljava/io/InputStream;)V

    invoke-static {v3, v2, v2}, Lmdb;->w(Lmda;ZZ)Ljava/util/List;

    move-result-object v3

    invoke-static {p1}, Lmdb;->y(Last;)[B
    ...
    :cond_2
    :try_start_3
    invoke-static {v3, p1}, Lmdb;->r(Ljava/util/List;[B)I
    :try_end_3
    ...
    :try_start_6
    invoke-static {p1, v3}, Lmdb;->x(Ljava/io/OutputStream;Ljava/util/List;)V
    :try_end_6
...
.method public static l(Ljava/lang/String;)Last;
    ...
    :try_start_1
    invoke-static {v1}, Lmdb;->m(Ljava/io/InputStream;)Last;
...
.method public static m(Ljava/io/InputStream;)Last;
    ...
    invoke-static {v0}, Lmdb;->A(Lmda;)Last;
...
.method public static o(Ljava/io/InputStream;Ljava/io/OutputStream;Last;Last;)V
    ...
    invoke-static {v0, p1, p2, p3}, Lmdb;->B(Lmda;Ljava/io/OutputStream;Last;Last;)V
...
.method private static r(Ljava/util/List;[B)I
    ...
    invoke-static {v1, v3, v0, v3}, Lmdb;->q([BI[BI)I

    move-result v1

    invoke-static {p1, v3, v0, v1}, Lmdb;->q([BI[BI)I

    invoke-static {v0}, Lmdb;->t([B)Lmcz;
    ...
    invoke-static {v1, v2}, Lmdb;->g(Lmcz;Ljava/lang/String;)Z
...
.method private static s(Ljava/util/List;)Last;
    ...
    invoke-static {v0, v2}, Lmdb;->g(Lmcz;Ljava/lang/String;)Z
...
.method private static t([B)Lmcz;
    .locals 4
    ...
    invoke-direct {v0, p0, v2, v3, v1}, Lmcz;-><init>([BIII)V

    return-object v0
.end method

.method private static u(Lmda;)Loiy;
    .locals 12
    ...
    invoke-static {p0, v0, v1}, Lmdb;->w(Lmda;ZZ)Ljava/util/List;
    ...
    invoke-static {v0, v2}, Loiy;->a(Ljava/lang/Object;Ljava/lang/Object;)Loiy;
    ...
    invoke-static {v8, v3}, Lmdb;->g(Lmcz;Ljava/lang/String;)Z
    ...
    iget v10, v8, Lmcz;->b:I

    iget v11, v8, Lmcz;->c:I
...
.method private static w(Lmda;ZZ)Ljava/util/List;
    .locals 6
    ...
    invoke-interface {p0}, Lmda;->d()Lmcz;
    ...
    invoke-interface {p0, v3}, Lmda;->c(I)V
    ...
    invoke-interface {p0, v3, v1}, Lmda;->b(II)Lmcz;

    move-result-object v1

    const-string v3, "http://ns.adobe.com/xmp/extension/\u0000"

    invoke-static {v1, v3}, Lmdb;->g(Lmcz;Ljava/lang/String;)Z

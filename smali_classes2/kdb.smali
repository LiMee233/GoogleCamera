...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-object v2, Lkdb;->a:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_1
    sput-object v2, Lkdb;->b:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_4
    sput-object v2, Lkdb;->c:Landroid/hardware/camera2/CaptureResult$Key;

    const/4 v2, 0x5

    invoke-static {v2}, Lkdb;->a(I)Z
    ...
    :goto_5
    sput-object v2, Lkdb;->d:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_6
    sput-object v0, Lkdb;->e:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_7
    sput-object v2, Lkdb;->f:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_8
    sput-object v2, Lkdb;->g:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_9
    sput-object v0, Lkdb;->h:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_a
    sput-object v2, Lkdb;->i:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_b
    sput-object v2, Lkdb;->j:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_c
    sput-object v0, Lkdb;->k:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_d
    sput-object v2, Lkdb;->l:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    :goto_e
    sput-object v0, Lkdb;->m:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    :goto_f
    sput-object v2, Lkdb;->n:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_11
    sput-object v0, Lkdb;->p:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_12
    sput-object v1, Lkdb;->q:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_13
    sput-object v1, Lkdb;->r:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_14
    sput-object v0, Lkdb;->s:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_15
    sput-object v3, Lkdb;->t:Landroid/hardware/camera2/CaptureRequest$Key;

...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lohj;->c:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v0, p0, Lohj;->d:Ljava/util/concurrent/atomic/AtomicBoolean;

    sget-object v0, Lj$/time/Instant;->EPOCH:Lj$/time/Instant;

    iput-object v0, p0, Lohj;->e:Lj$/time/Instant;
...
.method public final doFrame(J)V
    ...
    iget-object v0, p0, Lohj;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v0, p0, Lohj;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object p2, p0, Lohj;->e:Lj$/time/Instant;
    ...
    iput-object p1, p0, Lohj;->e:Lj$/time/Instant;
    ...
    iget-object p2, p0, Lohj;->b:Lj$/time/Duration;
    ...
    iget-object p1, p0, Lohj;->a:Lohn;

    check-cast p1, Lohr;

    iget-object p2, p1, Lohr;->b:Lohl;

    iget-boolean p2, p2, Lohl;->b:Z
    ...
    :cond_1
    iget-object p2, p1, Lohr;->d:Lohm;

    invoke-virtual {p2}, Lohm;->b()V

    sget-object p2, Lpfa;->a:Lpfa;

    invoke-static {}, Lj$/time/Instant;->now()Lj$/time/Instant;

    move-result-object p2

    iget-object v0, p1, Lohr;->h:Lj$/time/Instant;
    ...
    :cond_2
    iget-object v0, p1, Lohr;->b:Lohl;

    iget-object v0, v0, Lohl;->h:Lj$/time/Duration;
    ...
    :goto_0
    iget-object v1, p1, Lohr;->b:Lohl;

    iget-object v1, v1, Lohl;->h:Lj$/time/Duration;
    ...
    iput-object p2, p1, Lohr;->h:Lj$/time/Instant;

    iget-object p2, p1, Lohr;->d:Lohm;

    invoke-virtual {p2}, Lohm;->a()D
    ...
    :pswitch_0
    iget-object p2, p1, Lohr;->i:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    :goto_2
    iget-object p1, p1, Lohr;->k:Logv;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    new-instance v0, Lohp;

    invoke-direct {v0, p1}, Lohp;-><init>(Logv;)V
    ...
    :cond_6
    :goto_3
    iget-object p1, p0, Lohj;->c:Ljava/util/concurrent/atomic/AtomicBoolean;

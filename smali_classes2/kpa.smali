...
.method public static a(Lkoz;Landroid/os/Parcel;I)V
    .locals 3
    ...
    iget-object v1, p0, Lkoz;->b:Landroid/os/Bundle;
    ...
    iget-object v1, p0, Lkoz;->d:Landroid/app/ApplicationErrorReport;
    ...
    iget-object v1, p0, Lkoz;->f:Lcom/google/android/gms/common/data/BitmapTeleporter;
    ...
    iget-object v1, p0, Lkoz;->h:Ljava/util/List;

    const/16 v2, 0xa

    invoke-static {p1, v2, v1}, Lmin;->cM(Landroid/os/Parcel;ILjava/util/List;)V

    iget-boolean v1, p0, Lkoz;->i:Z

    const/16 v2, 0xb

    invoke-static {p1, v2, v1}, Lmin;->cw(Landroid/os/Parcel;IZ)V

    iget-object v1, p0, Lkoz;->j:Lkpd;

    const/16 v2, 0xc

    invoke-static {p1, v2, v1, p2}, Lmin;->cH(Landroid/os/Parcel;ILandroid/os/Parcelable;I)V

    iget-object v1, p0, Lkoz;->k:Lkpc;

    const/16 v2, 0xd

    invoke-static {p1, v2, v1, p2}, Lmin;->cH(Landroid/os/Parcel;ILandroid/os/Parcelable;I)V

    iget-boolean v1, p0, Lkoz;->l:Z

    const/16 v2, 0xe

    invoke-static {p1, v2, v1}, Lmin;->cw(Landroid/os/Parcel;IZ)V

    iget-object v1, p0, Lkoz;->m:Landroid/graphics/Bitmap;

    const/16 v2, 0xf

    invoke-static {p1, v2, v1, p2}, Lmin;->cH(Landroid/os/Parcel;ILandroid/os/Parcelable;I)V

    iget-object p2, p0, Lkoz;->n:Ljava/lang/String;

    const/16 v1, 0x10

    invoke-static {p1, v1, p2}, Lmin;->cI(Landroid/os/Parcel;ILjava/lang/String;)V

    iget-boolean p2, p0, Lkoz;->o:Z

    const/16 v1, 0x11

    invoke-static {p1, v1, p2}, Lmin;->cw(Landroid/os/Parcel;IZ)V

    iget-wide v1, p0, Lkoz;->p:J

    const/16 p0, 0x12

    invoke-static {p1, p0, v1, v2}, Lmin;->cB(Landroid/os/Parcel;IJ)V
...
.method public final bridge synthetic createFromParcel(Landroid/os/Parcel;)Ljava/lang/Object;
    ...
    :pswitch_1
    invoke-static {v0, v2}, Lmin;->cU(Landroid/os/Parcel;I)J
    ...
    invoke-direct/range {v6 .. v23}, Lkoz;-><init>(Ljava/lang/String;Landroid/os/Bundle;Ljava/lang/String;Landroid/app/ApplicationErrorReport;Ljava/lang/String;Lcom/google/android/gms/common/data/BitmapTeleporter;Ljava/lang/String;Ljava/util/List;ZLkpd;Lkpc;ZLandroid/graphics/Bitmap;Ljava/lang/String;ZJ)V

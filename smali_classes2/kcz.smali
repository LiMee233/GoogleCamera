...
.method static constructor <clinit>()V
    ...
    sput-boolean v6, Lkcz;->u:Z

    const/4 v7, 0x1

    invoke-static {v7}, Lkcz;->a(I)Z
    ...
    :goto_0
    sput-object v8, Lkcz;->a:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_5
    sput-object v8, Lkcz;->b:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_6
    sput-object v8, Lkcz;->c:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_8
    sput-object v8, Lkcz;->e:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_b
    sput-object v8, Lkcz;->f:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_e
    sput-object v8, Lkcz;->g:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_11
    sput-object v8, Lkcz;->h:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    :goto_12
    sput-object v8, Lkcz;->i:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_14
    sput-object v8, Lkcz;->j:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_15
    sput-object v8, Lkcz;->k:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_16
    sput-object v0, Lkcz;->l:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_17
    sput-object v0, Lkcz;->m:Landroid/hardware/camera2/CaptureResult$Key;

    invoke-static {v1}, Lkcz;->a(I)Z
    ...
    :goto_18
    sput-object v0, Lkcz;->n:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_1a
    sput-object v0, Lkcz;->o:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_1c
    sput-object v0, Lkcz;->p:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_1d
    sput-object v9, Lkcz;->q:Landroid/hardware/camera2/CaptureResult$Key;

...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    invoke-static {p1}, Lnye;->v(Landroid/content/Context;)I
    ...
    invoke-static {p1, v1, v2, v3}, Lodi;->a(Landroid/content/Context;Landroid/util/AttributeSet;II)Landroid/content/Context;
    ...
    invoke-static/range {v5 .. v10}, Lnzr;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)Landroid/content/res/TypedArray;
    ...
    iput-object v4, p0, Lnye;->c:Landroid/graphics/Rect;
    ...
    invoke-static {p1, v4, v0}, Lohc;->ar(Landroid/content/Context;ILjava/lang/String;)I

    move-result v0

    new-instance v4, Lobp;

    invoke-static {p1, v1, v2, v3}, Lobu;->a(Landroid/content/Context;Landroid/util/AttributeSet;II)Lobt;

    move-result-object v1

    invoke-virtual {v1}, Lobt;->a()Lobu;

    move-result-object v1

    invoke-direct {v4, v1}, Lobp;-><init>(Lobu;)V

    invoke-virtual {v4, p1}, Lobp;->f(Landroid/content/Context;)V

    invoke-static {v0}, Landroid/content/res/ColorStateList;->valueOf(I)Landroid/content/res/ColorStateList;

    move-result-object p1

    invoke-virtual {v4, p1}, Lobp;->h(Landroid/content/res/ColorStateList;)V
    ...
    iget-object p1, v4, Lobp;->a:Lobo;

    iget-object p1, p1, Lobo;->a:Lobu;

    invoke-virtual {p1, p2}, Lobu;->d(F)Lobu;

    move-result-object p1

    invoke-virtual {v4, p1}, Lobp;->b(Lobu;)V

    :cond_4
    iput-object v4, p0, Lnye;->b:Landroid/graphics/drawable/Drawable;
...
.method private static v(Landroid/content/Context;)I
    ...
    invoke-static {p0, v0}, Lohc;->as(Landroid/content/Context;I)Landroid/util/TypedValue;
...
.method public final b()Lie;
    ...
    iget-object v3, p0, Lnye;->b:Landroid/graphics/drawable/Drawable;

    instance-of v4, v3, Lobp;
    ...
    invoke-virtual {v3, v4}, Lobp;->g(F)V

    :cond_0
    iget-object v6, p0, Lnye;->b:Landroid/graphics/drawable/Drawable;

    iget-object v3, p0, Lnye;->c:Landroid/graphics/Rect;
    ...
    invoke-direct {v1, v0, v3}, Lnyd;-><init>(Landroid/app/Dialog;Landroid/graphics/Rect;)V

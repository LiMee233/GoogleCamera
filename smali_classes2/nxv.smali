...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    iput-boolean p1, p0, Lnxv;->e:Z

    new-instance p2, Lnxt;

    invoke-direct {p2, p0}, Lnxt;-><init>(Lnxv;)V

    iput-object p2, p0, Lnxv;->k:Lnxm;

    invoke-virtual {p0}, Lja;->d()V

    invoke-virtual {p0}, Lnxv;->getContext()Landroid/content/Context;
...
.method private final f(ILandroid/view/View;Landroid/view/ViewGroup$LayoutParams;)Landroid/view/View;
    ...
    invoke-direct {p0}, Lnxv;->g()V

    iget-object v0, p0, Lnxv;->h:Landroid/widget/FrameLayout;
    ...
    invoke-virtual {p0}, Lnxv;->getLayoutInflater()Landroid/view/LayoutInflater;
    ...
    :goto_0
    iget-boolean p1, p0, Lnxv;->j:Z

    if-eqz p1, :cond_1

    iget-object p1, p0, Lnxv;->b:Landroid/widget/FrameLayout;

    new-instance v1, Lnxq;

    invoke-direct {v1, p0}, Lnxq;-><init>(Lnxv;)V
    ...
    new-instance p2, Lnxr;

    invoke-direct {p2, p0}, Lnxr;-><init>(Lnxv;)V

    invoke-virtual {p1, p2}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object p1, p0, Lnxv;->b:Landroid/widget/FrameLayout;

    new-instance p2, Lnxs;

    invoke-direct {p2, p0}, Lnxs;-><init>(Lnxv;)V
    ...
    invoke-direct {p2, p3}, Lgue;-><init>(I)V

    invoke-virtual {p1, p2}, Landroid/widget/FrameLayout;->setOnTouchListener(Landroid/view/View$OnTouchListener;)V

    iget-object p1, p0, Lnxv;->h:Landroid/widget/FrameLayout;
...
.method private final g()V
    ...
    iput-object v0, p0, Lnxv;->h:Landroid/widget/FrameLayout;
    ...
    iput-object v0, p0, Lnxv;->i:Landroidx/coordinatorlayout/widget/CoordinatorLayout;
    ...
    iput-object v0, p0, Lnxv;->b:Landroid/widget/FrameLayout;
    ...
    iput-object v0, p0, Lnxv;->a:Lcom/google/android/material/bottomsheet/BottomSheetBehavior;

    iget-object v1, p0, Lnxv;->k:Lnxm;

    invoke-virtual {v0, v1}, Lcom/google/android/material/bottomsheet/BottomSheetBehavior;->A(Lnxm;)V

    iget-object v0, p0, Lnxv;->a:Lcom/google/android/material/bottomsheet/BottomSheetBehavior;

    iget-boolean v1, p0, Lnxv;->d:Z
...
.method public final cancel()V
    ...
    invoke-virtual {p0}, Lnxv;->a()Lcom/google/android/material/bottomsheet/BottomSheetBehavior;

    move-result-object v0

    iget-boolean v1, p0, Lnxv;->c:Z
...
.method public final onAttachedToWindow()V
    ...
    invoke-virtual {p0}, Lnxv;->getWindow()Landroid/view/Window;
    ...
    :goto_0
    iget-object v1, p0, Lnxv;->h:Landroid/widget/FrameLayout;
    ...
    :cond_1
    iget-object v1, p0, Lnxv;->i:Landroidx/coordinatorlayout/widget/CoordinatorLayout;
...
.method public final setCanceledOnTouchOutside(Z)V
    ...
    iput-boolean v0, p0, Lnxv;->d:Z

    :cond_0
    iput-boolean p1, p0, Lnxv;->e:Z

    iput-boolean v0, p0, Lnxv;->f:Z
...
.method public final setContentView(I)V
    ...
    invoke-direct {p0, p1, v0, v0}, Lnxv;->f(ILandroid/view/View;Landroid/view/ViewGroup$LayoutParams;)Landroid/view/View;
...
.method public final setContentView(Landroid/view/View;)V
    ...
    invoke-direct {p0, v0, p1, v1}, Lnxv;->f(ILandroid/view/View;Landroid/view/ViewGroup$LayoutParams;)Landroid/view/View;
...
.method public final setContentView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-direct {p0, v0, p1, p2}, Lnxv;->f(ILandroid/view/View;Landroid/view/ViewGroup$LayoutParams;)Landroid/view/View;

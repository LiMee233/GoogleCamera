...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lnhw;->a:[Ljava/lang/String;
    ...
    sput-object v0, Lnhw;->b:[Ljava/lang/String;
    ...
    sput-object v0, Lnhw;->c:[Ljava/lang/String;
...
.method public static a(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;)Landroid/content/res/AssetFileDescriptor;
    ...
    invoke-static {p0, p1, p2, v0}, Lnhw;->b(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Lnhv;)Landroid/content/res/AssetFileDescriptor;
...
.method public static b(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Lnhv;)Landroid/content/res/AssetFileDescriptor;
    .locals 17
    ...
    :cond_4
    sget-object v13, Lnhv;->a:Lnhv;

    iget-object v13, v3, Lnhv;->d:Looh;

    move-object v14, v13

    check-cast v14, Lorm;

    iget v14, v14, Lorm;->c:I
    ...
    :cond_7
    iget-object v6, v9, Lnhz;->a:Ljava/lang/String;
    ...
    sget-object v0, Lnhw;->b:[Ljava/lang/String;
    ...
    :cond_b
    sget-object v0, Lnhw;->c:[Ljava/lang/String;
    ...
    :cond_c
    sget-object v0, Lnhw;->a:[Ljava/lang/String;
    ...
    invoke-static {v0}, Lnhw;->e(Ljava/lang/Object;)V
    ...
    invoke-static {v2}, Lnhw;->e(Ljava/lang/Object;)V
    ...
    invoke-direct {v5, v4}, Lnhx;-><init>(Ljava/io/FileDescriptor;)V

    invoke-static {v5}, Lmyo;->p(Ljava/util/concurrent/Callable;)Ljava/lang/Object;
    ...
    invoke-direct {v4, v1}, Lnhy;-><init>(Ljava/lang/String;)V

    invoke-static {v4}, Lmyo;->p(Ljava/util/concurrent/Callable;)Ljava/lang/Object;
    ...
    sget-object v4, Lnhv;->a:Lnhv;

    iget-boolean v4, v3, Lnhv;->c:Z
    ...
    invoke-static {v4}, Lnhw;->c(Ljava/io/File;)Ljava/lang/String;
    ...
    invoke-direct {v4, v0, v5}, Lnht;-><init>(Landroid/content/Context;I)V

    invoke-static {v4}, Lnhw;->d(Ljava/util/concurrent/Callable;)[Ljava/io/File;
    ...
    invoke-static {v8}, Lnhw;->c(Ljava/io/File;)Ljava/lang/String;
    ...
    invoke-direct {v4, v0, v6}, Lnht;-><init>(Landroid/content/Context;I)V
    ...
    invoke-static {v7}, Lnhw;->c(Ljava/io/File;)Ljava/lang/String;
    ...
    invoke-static {v2}, Lnhw;->f(Landroid/content/res/AssetFileDescriptor;)V

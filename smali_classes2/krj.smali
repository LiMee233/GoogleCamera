...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lkrj;->a:Ljava/lang/Object;

    const/4 v0, 0x0

    sput-boolean v0, Lkrj;->c:Z
...
# virtual methods
.method public final a(Landroid/content/Context;Ljava/lang/String;Lkrm;)Landroid/os/IInterface;
    .locals 19
    ...
    :try_start_0
    sget-object v3, Lkrj;->a:Ljava/lang/Object;

    monitor-enter v3
    :try_end_0
    .catch Lkom; {:try_start_0 .. :try_end_0} :catch_4

    :try_start_1
    sget-object v4, Lkrj;->b:Lkop;
    :try_end_1
    ...
    :try_start_2
    sget-object v6, Lkop;->a:Ljava/lang/Boolean;

    sget-object v6, Lkop;->c:Ljava/lang/ThreadLocal;
    ...
    sget-object v8, Lkop;->c:Ljava/lang/ThreadLocal;

    invoke-virtual {v8, v7}, Ljava/lang/ThreadLocal;->set(Ljava/lang/Object;)V

    sget-object v8, Lkop;->d:Ljava/lang/ThreadLocal;
    ...
    move-result-wide v8
    :try_end_2
    .catch Lkom; {:try_start_2 .. :try_end_2} :catch_3
    .catchall {:try_start_2 .. :try_end_2} :catchall_5

    const-wide/16 v10, 0x0

    :try_start_3
    sget-object v12, Lkop;->d:Ljava/lang/ThreadLocal;
    ...
    sget-object v12, Lkop;->e:Lkon;

    invoke-static {v1, v12}, Lmin;->cj(Landroid/content/Context;Lkon;)Lkoo;

    move-result-object v12

    iget v13, v12, Lkoo;->c:I
    ...
    invoke-static/range {p1 .. p1}, Lkop;->c(Landroid/content/Context;)Lkop;
    ...
    :cond_2
    sget-object v10, Lkop;->d:Ljava/lang/ThreadLocal;
    ...
    :goto_0
    iget-object v7, v7, Lkok;->a:Landroid/database/Cursor;
    ...
    :cond_3
    sget-object v7, Lkop;->c:Ljava/lang/ThreadLocal;

    invoke-virtual {v7, v6}, Ljava/lang/ThreadLocal;->set(Ljava/lang/Object;)V
    :try_end_4
    .catch Lkom; {:try_start_4 .. :try_end_4} :catch_3
    ...
    :try_start_5
    iget v13, v12, Lkoo;->b:I
    :try_end_5
    .catch Lkom; {:try_start_5 .. :try_end_5} :catch_2
    .catchall {:try_start_5 .. :try_end_5} :catchall_4

    :try_start_6
    const-class v16, Lkop;

    monitor-enter v16
    :try_end_6
    .catch Landroid/os/RemoteException; {:try_start_6 .. :try_end_6} :catch_1
    .catch Lkom; {:try_start_6 .. :try_end_6} :catch_0
    .catchall {:try_start_6 .. :try_end_6} :catchall_3

    :try_start_7
    sget-object v17, Lkop;->a:Ljava/lang/Boolean;
    ...
    .catch Lkom; {:try_start_8 .. :try_end_8} :catch_0
    .catchall {:try_start_8 .. :try_end_8} :catchall_3

    :try_start_9
    sget-object v14, Lkop;->f:Lkor;
    ...
    :try_start_a
    sget-object v16, Lkop;->c:Ljava/lang/ThreadLocal;
    ...
    iget-object v11, v10, Lkok;->a:Landroid/database/Cursor;
    ...
    iget-object v10, v10, Lkok;->a:Landroid/database/Cursor;

    invoke-static {v5}, Lkoe;->b(Ljava/lang/Object;)Lkof;
    ...
    .catch Lkom; {:try_start_a .. :try_end_a} :catch_0
    ...
    invoke-static {v11}, Lkoe;->b(Ljava/lang/Object;)Lkof;

    move-result-object v5

    invoke-static {v10}, Lkoe;->b(Ljava/lang/Object;)Lkof;
    ...
    invoke-direct {v10, v5}, Lkod;-><init>(Landroid/os/IBinder;)V
    ...
    :goto_4
    invoke-static {v10}, Lkoe;->c(Lkof;)Ljava/lang/Object;
    ...
    invoke-direct {v5, v4}, Lkop;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {v4, v5}, Lkom;-><init>(Ljava/lang/String;)V

    throw v4
    :try_end_c
    .catch Landroid/os/RemoteException; {:try_start_c .. :try_end_c} :catch_1
    .catch Lkom; {:try_start_c .. :try_end_c} :catch_0
    ...
    .catch Lkom; {:try_start_e .. :try_end_e} :catch_0
    ...
    :cond_e
    invoke-static/range {p1 .. p1}, Lkop;->d(Landroid/content/Context;)Lkoq;

    move-result-object v5

    if-eqz v5, :cond_1b

    invoke-virtual {v5}, Lkoq;->e()I

    move-result v10

    if-lt v10, v4, :cond_12

    sget-object v4, Lkop;->c:Ljava/lang/ThreadLocal;
    ...
    invoke-static/range {p1 .. p1}, Lkoe;->b(Ljava/lang/Object;)Lkof;

    move-result-object v10

    iget-object v4, v4, Lkok;->a:Landroid/database/Cursor;

    invoke-static {v4}, Lkoe;->b(Ljava/lang/Object;)Lkof;
    ...
    invoke-direct {v4, v5}, Lkop;-><init>(Landroid/content/Context;)V
    :try_end_10
    .catch Landroid/os/RemoteException; {:try_start_10 .. :try_end_10} :catch_1
    .catch Lkom; {:try_start_10 .. :try_end_10} :catch_0
    ...
    :try_start_11
    sget-object v4, Lkop;->d:Ljava/lang/ThreadLocal;
    ...
    :goto_a
    iget-object v4, v7, Lkok;->a:Landroid/database/Cursor;
    ...
    :try_end_11
    .catch Lkom; {:try_start_11 .. :try_end_11} :catch_3
    ...
    .catch Lkom; {:try_start_12 .. :try_end_12} :catch_0
    ...
    .catch Lkom; {:try_start_14 .. :try_end_14} :catch_0
    ...
    invoke-direct {v5, v10, v4}, Lkom;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    throw v5
    :try_end_15
    .catch Lkom; {:try_start_15 .. :try_end_15} :catch_2
    ...
    invoke-virtual {v4}, Lkom;->getMessage()Ljava/lang/String;
    ...
    iget v5, v12, Lkoo;->a:I

    if-eqz v5, :cond_20

    new-instance v10, Lkol;

    invoke-direct {v10, v5}, Lkol;-><init>(I)V

    invoke-static {v1, v10}, Lmin;->cj(Landroid/content/Context;Lkon;)Lkoo;
    ...
    :goto_e
    sput-object v12, Lkrj;->b:Lkop;
    :try_end_17
    .catch Lkom; {:try_start_17 .. :try_end_17} :catch_3
    ...
    :try_start_19
    sget-object v5, Lkop;->d:Ljava/lang/ThreadLocal;
    ...
    :goto_f
    iget-object v5, v7, Lkok;->a:Landroid/database/Cursor;
    ...
    :cond_24
    sget-object v5, Lkop;->c:Ljava/lang/ThreadLocal;

    invoke-virtual {v5, v6}, Ljava/lang/ThreadLocal;->set(Ljava/lang/Object;)V

    throw v4
    :try_end_19
    .catch Lkom; {:try_start_19 .. :try_end_19} :catch_3
    ...
    :try_start_1b
    invoke-virtual {v1, v2}, Lkop;->b(Ljava/lang/String;)Landroid/os/IBinder;

    move-result-object v1
    :try_end_1b
    .catch Lkom; {:try_start_1b .. :try_end_1b} :catch_4
    ...
    invoke-interface {v3, v1}, Lkrm;->a(Landroid/os/IBinder;)Landroid/os/IInterface;
    ...
    :goto_12
    invoke-direct {v1, v2}, Lkrl;-><init>(Ljava/lang/String;)V
    ...
    throw v1
    :try_end_1d
    .catch Lkom; {:try_start_1d .. :try_end_1d} :catch_4
    ...
    invoke-virtual {v1}, Lkom;->getMessage()Ljava/lang/String;
    ...
    invoke-direct {v3, v2, v1}, Lkrl;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V

...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lkhk;->d:Ljava/lang/Object;
...
# virtual methods
.method public final a(Landroid/content/Context;ILkmj;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    .locals 5
    ...
    :cond_2
    invoke-static {p1, p2}, Lkme;->b(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_4
    invoke-static {p1, p2}, Lkme;->c(Landroid/content/Context;I)Ljava/lang/String;
...
.method public final b(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    iput-object p2, v2, Lkhw;->aa:Landroid/app/Dialog;

    if-eqz p4, :cond_0

    iput-object p4, v2, Lkhw;->ab:Landroid/content/DialogInterface$OnCancelListener;
    ...
    iput-object p2, v2, Lkhh;->a:Landroid/app/Dialog;

    if-eqz p4, :cond_2

    iput-object p4, v2, Lkhh;->b:Landroid/content/DialogInterface$OnCancelListener;

    :cond_2
    invoke-virtual {v2, p1, p3}, Lkhh;->show(Landroid/app/FragmentManager;Ljava/lang/String;)V
...
.method public final c(Landroid/content/Context;ILandroid/app/PendingIntent;)V
    ...
    invoke-direct {p2, p0, p1}, Lkhj;-><init>(Lkhk;Landroid/content/Context;)V
    ...
    invoke-static {p1, v5}, Lkme;->e(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1}, Lkme;->a(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v7

    invoke-static {p1, v1, v7}, Lkme;->d(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v8}, Lmin;->dk(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p1}, Lmin;->cp(Landroid/content/Context;)Z

    move-result v5

    if-eqz v5, :cond_7

    invoke-static {v2}, Lmin;->dq(Z)V
    ...
    invoke-static {p1}, Lmin;->cq(Landroid/content/Context;)V
    ...
    sget-object p3, Lkhk;->d:Ljava/lang/Object;
    ...
    :pswitch_0
    sget-object p1, Lkhu;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final d(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)V
    ...
    invoke-virtual {p0, p1, p2, v0}, Lkhl;->g(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;

    move-result-object v0

    new-instance v1, Lkmh;

    invoke-direct {v1, v0, p1, p3}, Lkmh;-><init>(Landroid/content/Intent;Landroid/app/Activity;I)V

    invoke-virtual {p0, p1, p2, v1, p4}, Lkhk;->a(Landroid/content/Context;ILkmj;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lkhk;->b(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V

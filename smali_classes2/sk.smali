...
.method public static a(Lkmk;Landroid/os/Parcel;I)V
    .locals 3
    ...
    iget-boolean p2, p0, Lkmk;->m:Z

    const/16 v1, 0xe

    invoke-static {p1, v1, p2}, Lmin;->cw(Landroid/os/Parcel;IZ)V

    iget-object p0, p0, Lkmk;->n:Ljava/lang/String;

    const/16 p2, 0xf

    invoke-static {p1, p2, p0}, Lmin;->cI(Landroid/os/Parcel;ILjava/lang/String;)V
...
.method public static final b(Landroid/os/Parcel;)Lcom/google/android/gms/feedback/ErrorReport;
    ...
    invoke-static/range {p0 .. p0}, Lmin;->cT(Landroid/os/Parcel;)I
    ...
    invoke-static/range {p0 .. p0}, Lmin;->cQ(Landroid/os/Parcel;)I
    ...
    :pswitch_9
    sget-object v3, Lkpc;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    :pswitch_d
    invoke-static {v0, v2}, Lmin;->di(Landroid/os/Parcel;I)[Ljava/lang/String;
    ...
    :pswitch_e
    sget-object v3, Lkpb;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-static {v0, v2, v3}, Lmin;->dh(Landroid/os/Parcel;ILandroid/os/Parcelable$Creator;)[Ljava/lang/Object;
...
.method public final synthetic createFromParcel(Landroid/os/Parcel;)Ljava/lang/Object;
    ...
    invoke-static {v3}, Lmin;->cP(I)I

    move-result v6

    packed-switch v6, :pswitch_data_1

    invoke-static {v0, v3}, Lmin;->dd(Landroid/os/Parcel;I)V

    goto :goto_1

    :pswitch_2
    sget-object v5, Lknc;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-static {v0, v3, v5}, Lmin;->da(Landroid/os/Parcel;ILandroid/os/Parcelable$Creator;)Ljava/util/ArrayList;
    ...
    :pswitch_3
    invoke-static {v0, v3}, Lmin;->cR(Landroid/os/Parcel;I)I
    ...
    :cond_0
    invoke-static {v0, v2}, Lmin;->db(Landroid/os/Parcel;I)V

    new-instance v0, Lknk;

    invoke-direct {v0, v4, v5}, Lknk;-><init>(ILjava/util/List;)V
    ...
    :pswitch_7
    invoke-static {v0, v3}, Lmin;->de(Landroid/os/Parcel;I)Z
    ...
    invoke-direct/range {v5 .. v10}, Lknj;-><init>(IZZII)V
    ...
    invoke-static {v0, v3, v4}, Lmin;->cX(Landroid/os/Parcel;ILandroid/os/Parcelable$Creator;)Landroid/os/Parcelable;
    ...
    :pswitch_e
    invoke-static {v0, v3}, Lmin;->cW(Landroid/os/Parcel;I)Landroid/os/IBinder;
    ...
    invoke-direct/range {v6 .. v11}, Lknh;-><init>(ILandroid/os/IBinder;Lkhg;ZZ)V
    ...
    invoke-static {v7}, Lmin;->cP(I)I

    move-result v8

    packed-switch v8, :pswitch_data_4

    invoke-static {v0, v7}, Lmin;->dd(Landroid/os/Parcel;I)V
    ...
    invoke-static {v0, v7, v6}, Lmin;->cX(Landroid/os/Parcel;ILandroid/os/Parcelable$Creator;)Landroid/os/Parcelable;
    ...
    :pswitch_12
    invoke-static {v0, v7}, Lmin;->cR(Landroid/os/Parcel;I)I
    ...
    invoke-static {v0, v7, v5}, Lmin;->cX(Landroid/os/Parcel;ILandroid/os/Parcelable$Creator;)Landroid/os/Parcelable;
    ...
    invoke-direct {v0, v4, v5, v3, v6}, Lkng;-><init>(ILandroid/accounts/Account;ILcom/google/android/gms/auth/api/signin/GoogleSignInAccount;)V
    ...
    :pswitch_18
    invoke-static {v0, v3}, Lmin;->cY(Landroid/os/Parcel;I)Ljava/lang/String;
    ...
    :pswitch_1a
    invoke-static {v0, v3}, Lmin;->cU(Landroid/os/Parcel;I)J
    ...
    invoke-direct/range {v8 .. v19}, Lknc;-><init>(IIIJJLjava/lang/String;Ljava/lang/String;II)V
    ...
    invoke-static {v0, v3, v4}, Lmin;->dh(Landroid/os/Parcel;ILandroid/os/Parcelable$Creator;)[Ljava/lang/Object;
    ...
    :pswitch_28
    invoke-static {v0, v3}, Lmin;->cV(Landroid/os/Parcel;I)Landroid/os/Bundle;
    ...
    invoke-direct/range {v6 .. v20}, Lkmk;-><init>(IIILjava/lang/String;Landroid/os/IBinder;[Lcom/google/android/gms/common/api/Scope;Landroid/os/Bundle;Landroid/accounts/Account;[Lkhi;[Lkhi;ZIZLjava/lang/String;)V
    ...
    :pswitch_30
    invoke-static {v0, v3}, Lmin;->dg(Landroid/os/Parcel;I)[I
    ...
    :pswitch_35
    sget-object v4, Lknj;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    invoke-direct/range {v6 .. v12}, Lkmg;-><init>(Lknj;ZZ[II[I)V
    ...
    :pswitch_37
    sget-object v6, Lkmg;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    invoke-static {v0, v7, v3}, Lmin;->dh(Landroid/os/Parcel;ILandroid/os/Parcelable$Creator;)[Ljava/lang/Object;
    ...
    :pswitch_3a
    invoke-static {v0, v7}, Lmin;->cV(Landroid/os/Parcel;I)Landroid/os/Bundle;
    ...
    invoke-direct {v0, v5, v3, v4, v6}, Lkmf;-><init>(Landroid/os/Bundle;[Lkhi;ILkmg;)V
    ...
    invoke-direct {v0, v4, v5}, Lkma;-><init>(ILjava/lang/String;)V
    ...
    invoke-static {v0, v3, v5}, Lmin;->dh(Landroid/os/Parcel;ILandroid/os/Parcelable$Creator;)[Ljava/lang/Object;
    ...
    :sswitch_4
    invoke-static {v0, v3}, Lmin;->di(Landroid/os/Parcel;I)[Ljava/lang/String;
    ...
    invoke-static {v6}, Lmin;->cP(I)I

    move-result v7

    packed-switch v7, :pswitch_data_a

    invoke-static {v0, v6}, Lmin;->dd(Landroid/os/Parcel;I)V

    goto :goto_17

    :pswitch_40
    invoke-static {v0, v6}, Lmin;->cR(Landroid/os/Parcel;I)I
    ...
    invoke-static {v0, v6, v5}, Lmin;->cX(Landroid/os/Parcel;ILandroid/os/Parcelable$Creator;)Landroid/os/Parcelable;
    ...
    invoke-direct/range {v6 .. v11}, Lcom/google/android/gms/common/api/Status;-><init>(IILjava/lang/String;Landroid/app/PendingIntent;Lkhg;)V
    ...
    invoke-direct {v0, v5, v4, v6, v7}, Lkhi;-><init>(Ljava/lang/String;IJ)V
    ...
    :pswitch_4c
    invoke-static {v0, v7}, Lmin;->cY(Landroid/os/Parcel;I)Ljava/lang/String;
    ...
    invoke-direct {v0, v4, v3, v5, v6}, Lkhg;-><init>(IILandroid/app/PendingIntent;Ljava/lang/String;)V
    ...
    :pswitch_53
    invoke-static {v0, v3}, Lmin;->cS(Landroid/os/Parcel;I)I
    ...
    invoke-direct {v2, v3, v0}, Lknn;-><init>(Ljava/lang/String;Landroid/os/Parcel;)V
    ...
    invoke-direct/range {v6 .. v18}, Lkhe;-><init>(Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;ZLjava/lang/String;ZILjava/lang/Integer;ZI)V
    ...
    :pswitch_5e
    sget-object v4, Lkto;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    :pswitch_60
    invoke-static {v0, v3}, Lmin;->dj(Landroid/os/Parcel;I)[[B
    ...
    :pswitch_64
    invoke-static {v0, v3}, Lmin;->df(Landroid/os/Parcel;I)[B
    ...
    :pswitch_65
    sget-object v4, Lkhe;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    invoke-direct/range {v6 .. v14}, Lkgu;-><init>(Lkhe;[B[I[Ljava/lang/String;[I[[BZ[Lkto;)V
    ...
    :pswitch_69
    invoke-static {v0, v6}, Lmin;->cY(Landroid/os/Parcel;I)Ljava/lang/String;
    ...
    invoke-direct {v0, v5, v4, v3}, Lkgt;-><init>(Ljava/lang/String;II)V
    ...
    invoke-direct {v0, v5, v3, v4}, Lkpb;-><init>(Landroid/os/ParcelFileDescriptor;Ljava/lang/String;Ljava/lang/String;)V
...
.method public final synthetic newArray(I)[Ljava/lang/Object;
    ...
    :pswitch_5
    new-array p1, p1, [Lknc;

    return-object p1

    :pswitch_6
    new-array p1, p1, [Lkmk;
    ...
    :pswitch_10
    new-array p1, p1, [Lkhe;

    return-object p1

    :pswitch_11
    new-array p1, p1, [Lkgu;

    return-object p1

    :pswitch_12
    new-array p1, p1, [Lkgt;

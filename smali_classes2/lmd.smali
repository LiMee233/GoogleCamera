...
.method static constructor <clinit>()V
    ...
    sput-object v0, Llmd;->h:Ljava/nio/charset/Charset;
...
.method public constructor <init>(Ljava/io/InputStream;Lcom/google/android/libraries/camera/exif/ExifInterface;)V
    ...
    iput-boolean v0, p0, Llmd;->s:Z

    new-instance v1, Ljava/util/TreeMap;

    invoke-direct {v1}, Ljava/util/TreeMap;-><init>()V

    iput-object v1, p0, Llmd;->g:Ljava/util/TreeMap;

    iput-object p2, p0, Llmd;->w:Lcom/google/android/libraries/camera/exif/ExifInterface;

    new-instance p2, Lllv;

    invoke-direct {p2, p1}, Lllv;-><init>(Ljava/io/InputStream;)V

    invoke-virtual {p2}, Lllv;->d()S
    ...
    :goto_3
    iput-boolean p2, p0, Llmd;->s:Z

    new-instance p2, Lllv;

    invoke-direct {p2, p1}, Lllv;-><init>(Ljava/io/InputStream;)V

    iput-object p2, p0, Llmd;->a:Lllv;

    iget-boolean p1, p0, Llmd;->s:Z
    ...
    invoke-virtual {p2, p1}, Lllv;->e(Ljava/nio/ByteOrder;)V
    ...
    invoke-direct {p0, v0, p1, p2}, Llmd;->g(IJ)V
    ...
    iput-object p1, p0, Llmd;->u:[B

    invoke-virtual {p0, p1}, Llmd;->b([B)I
    ...
    invoke-direct {p1, v2}, Llly;-><init>(Ljava/lang/String;)V
...
.method private final f(Llme;)V
    ...
    iget-short v0, p1, Llme;->a:S

    iget v1, p1, Llme;->e:I

    sget-short v2, Llmd;->i:S
    ...
    invoke-direct {p0, v1, v2}, Llmd;->i(II)Z
    ...
    invoke-virtual {p1, v3}, Llme;->b(I)J

    move-result-wide v1

    invoke-direct {p0, v0, v1, v2}, Llmd;->g(IJ)V

    return-void

    :cond_2
    :goto_0
    sget-short v2, Llmd;->j:S
    ...
    invoke-direct {p0, v4, v0, v1}, Llmd;->g(IJ)V

    return-void

    :cond_6
    :goto_2
    sget-short v2, Llmd;->l:S
    ...
    iget-object p1, p0, Llmd;->g:Ljava/util/TreeMap;
    ...
    :cond_9
    iput-object p1, p0, Llmd;->f:Llme;

    return-void

    :cond_a
    :goto_4
    sget-short v2, Llmd;->n:S
    ...
    invoke-direct {p0, v3, v0, v1}, Llmd;->h(IJ)V
    ...
    :cond_c
    iget-object v0, p0, Llmd;->g:Ljava/util/TreeMap;
    ...
    invoke-direct {v2, p1, v3}, Llma;-><init>(Llme;Z)V
    ...
    :cond_d
    sget-short v2, Llmd;->o:S

    if-ne v0, v2, :cond_e

    sget v0, Lcom/google/android/libraries/camera/exif/ExifInterface;->m:I

    invoke-direct {p0, v1, v0}, Llmd;->i(II)Z
...
.method private final g(IJ)V
    ...
    invoke-direct {p3, p1}, Llmb;-><init>(I)V
...
.method private final h(IJ)V
    ...
    invoke-direct {p3, p1}, Llmc;-><init>(I)V
...
.method private final i(II)Z
    ...
    iget-object v0, p0, Llmd;->w:Lcom/google/android/libraries/camera/exif/ExifInterface;
...
.method public final a()I
    ...
    iget-object v2, v1, Llmd;->a:Lllv;

    invoke-virtual {v2}, Lllv;->c()J
    ...
    invoke-direct/range {v11 .. v16}, Llme;-><init>(SSIIZ)V
    ...
    iget-object v4, v1, Llmd;->a:Lllv;

    invoke-virtual {v4}, Lllv;->c()J
    ...
    invoke-virtual {v2, v0}, Llme;->j([B)Z
    ...
    invoke-direct {v0, v2}, Llly;-><init>(Ljava/lang/String;)V

    throw v0

    :cond_5
    iget-boolean v0, v2, Llme;->c:Z

    iput-boolean v9, v2, Llme;->c:Z

    invoke-virtual {v1, v2}, Llmd;->e(Llme;)V

    iput-boolean v0, v2, Llme;->c:Z
    ...
    :goto_2
    iput-object v0, v1, Llmd;->c:Llme;

    if-nez v0, :cond_6

    invoke-virtual/range {p0 .. p0}, Llmd;->a()I
    ...
    :cond_6
    iget-boolean v2, v1, Llmd;->r:Z

    if-eqz v2, :cond_7

    invoke-direct {v1, v0}, Llmd;->f(Llme;)V
    ...
    invoke-virtual/range {p0 .. p0}, Llmd;->d()J
    ...
    invoke-direct {v1, v10, v11, v12}, Llmd;->g(IJ)V

    goto :goto_4

    :cond_b
    iget-object v0, v1, Llmd;->g:Ljava/util/TreeMap;
    ...
    iget-object v11, v1, Llmd;->a:Lllv;

    iget v11, v11, Lllv;->a:I
    ...
    iget-object v7, v1, Llmd;->a:Lllv;

    int-to-long v11, v0

    iget v13, v7, Lllv;->a:I
    ...
    :goto_5
    iget-object v7, v1, Llmd;->g:Ljava/util/TreeMap;
    ...
    :goto_6
    iput-boolean v10, v1, Llmd;->r:Z

    iget-boolean v0, v4, Llmb;->b:Z
    ...
    :cond_11
    instance-of v0, v4, Llmc;

    if-eqz v0, :cond_12

    check-cast v4, Llmc;

    iput-object v4, v1, Llmd;->d:Llmc;
    ...
    iget-object v0, v4, Llma;->a:Llme;

    iput-object v0, v1, Llmd;->c:Llme;

    if-eqz v0, :cond_13

    iget-short v3, v0, Llme;->b:S

    if-eq v3, v6, :cond_13

    invoke-virtual {v1, v0}, Llmd;->e(Llme;)V

    iget-object v0, v1, Llmd;->c:Llme;

    invoke-direct {v1, v0}, Llmd;->f(Llme;)V

    :cond_13
    iget-boolean v0, v4, Llma;->b:Z
...
.method public final e(Llme;)V
    ...
    iget-object v1, p0, Llmd;->g:Ljava/util/TreeMap;
    ...
    invoke-virtual {p1}, Llme;->toString()Ljava/lang/String;
    ...
    iget-object v0, v0, Llma;->a:Llme;

    invoke-virtual {v0}, Llme;->toString()Ljava/lang/String;
    ...
    new-instance v5, Llib;

    int-to-long v6, v3

    int-to-long v3, v4

    invoke-direct {v5, v6, v7, v3, v4}, Llib;-><init>(JJ)V
    ...
    :cond_6
    invoke-virtual {p1, v2}, Llme;->m([Llib;)Z
    ...
    :cond_7
    invoke-virtual {p1, v2}, Llme;->k([I)Z
    ...
    invoke-direct {v7, v3, v4, v5, v6}, Llib;-><init>(JJ)V
    ...
    :cond_9
    invoke-virtual {p1, v2}, Llme;->l([J)Z
    ...
    iget-object v3, p0, Llmd;->a:Lllv;

    invoke-virtual {v3}, Lllv;->d()S
    ...
    sget-object v1, Llmd;->h:Ljava/nio/charset/Charset;
    ...
    invoke-virtual {v2, v3, v0}, Lllv;->f([BI)V
    ...
    :goto_8
    invoke-virtual {p1, v0}, Llme;->i(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v0}, Llmd;->b([B)I

    invoke-virtual {p1, v0}, Llme;->j([B)Z

...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p1, p0, Lodd;->c:Landroid/graphics/Rect;

    invoke-virtual {p0}, Lodd;->getContext()Landroid/content/Context;
    ...
    invoke-virtual {p0, v2}, Lodd;->setKeyListener(Landroid/text/method/KeyListener;)V
    ...
    iput-object v0, p0, Lodd;->b:Landroid/view/accessibility/AccessibilityManager;
    ...
    invoke-virtual {p0}, Lodd;->getAdapter()Landroid/widget/ListAdapter;
    ...
    invoke-direct {p1, p0}, Lodc;-><init>(Lodd;)V
...
.method private final b()Lodf;
    .locals 2

    invoke-virtual {p0}, Lodd;->getParent()Landroid/view/ViewParent;
...
.method public final a(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lodd;->convertSelectionToString(Ljava/lang/Object;)Ljava/lang/CharSequence;

    move-result-object p1

    const/4 v0, 0x0

    invoke-virtual {p0, p1, v0}, Lodd;->setText(Ljava/lang/CharSequence;Z)V
...
.method protected final onMeasure(II)V
    ...
    invoke-virtual {p0}, Lodd;->getMeasuredWidth()I
    ...
    invoke-virtual {p0}, Lodd;->getMeasuredHeight()I
    ...
    :cond_5
    iget-object p2, p0, Lodd;->c:Landroid/graphics/Rect;

    invoke-virtual {p1, p2}, Landroid/graphics/drawable/Drawable;->getPadding(Landroid/graphics/Rect;)Z

    iget-object p1, p0, Lodd;->c:Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, p1, p2}, Lodd;->setMeasuredDimension(II)V
...
.method public final showDropDown()V
    ...
    iget-object v0, p0, Lodd;->b:Landroid/view/accessibility/AccessibilityManager;

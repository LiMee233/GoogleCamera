...
.method public final run()V
    ...
    invoke-direct {v6, v8, v5}, Lnye;-><init>(Landroid/content/Context;I)V
    ...
    invoke-virtual {v6, v5}, Lnye;->t(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v6, v1}, Lnye;->m(Ljava/lang/CharSequence;)V

    invoke-virtual {v6, v7}, Lnye;->k(Z)V

    new-instance v1, Lbqw;

    invoke-direct {v1, v4}, Lbqw;-><init>(Landroid/content/DialogInterface$OnClickListener;)V

    invoke-virtual {v6, v1}, Lnye;->p(Landroid/content/DialogInterface$OnKeyListener;)V
    ...
    invoke-virtual {v6, v1, v4}, Lnye;->o(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)V
    ...
    invoke-virtual {v6, v1, v2}, Lnye;->r(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)V

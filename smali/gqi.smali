...
.method public constructor <init>(Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;Z)V
    ...
    iput-object p1, p0, Lgqi;->d:Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;
    ...
    iput-object v0, p0, Lgqi;->e:Landroid/widget/FrameLayout;
    ...
    iput-object v0, p0, Lgqi;->a:Landroid/widget/RelativeLayout;
    ...
    invoke-static {v2, v3}, Luu;->a(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iput-object v0, p0, Lgqi;->f:Lohs;

    iget-object p1, p1, Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;->b:Ljzj;

    iput-object p1, p0, Lgqi;->g:Ljzj;
...
.method public final a()Landroid/animation/Animator;
    ...
    :goto_0
    iget-object v3, p0, Lgqi;->e:Landroid/widget/FrameLayout;
    ...
    iget-object v4, p0, Lgqi;->e:Landroid/widget/FrameLayout;

    iget v6, p0, Lgqi;->h:I

    invoke-direct {v3, v4, v6}, Ljzl;-><init>(Landroid/view/View;I)V

    invoke-virtual {v0, v3}, Landroid/animation/ValueAnimator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    iget-object v3, p0, Lgqi;->g:Ljzj;

    sget-object v4, Ljzj;->b:Ljzj;

    if-ne v3, v4, :cond_1

    iget-object v3, p0, Lgqi;->e:Landroid/widget/FrameLayout;

    invoke-static {v3}, Ljzk;->a(Landroid/view/View;)[I

    move-result-object v3

    aget v3, v3, v8

    iget-object v4, p0, Lgqi;->a:Landroid/widget/RelativeLayout;

    invoke-static {v4}, Ljzk;->a(Landroid/view/View;)[I
    ...
    iget-object v6, p0, Lgqi;->a:Landroid/widget/RelativeLayout;
    ...
    iget-object v3, p0, Lgqi;->a:Landroid/widget/RelativeLayout;

    iget v4, p0, Lgqi;->c:I

    invoke-direct {v2, v3, v4}, Ljzl;-><init>(Landroid/view/View;I)V

    invoke-virtual {v1, v2}, Landroid/animation/ObjectAnimator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    new-instance v2, Ljzc;

    iget-object v3, p0, Lgqi;->d:Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;

    invoke-direct {v2, v3}, Ljzc;-><init>(Landroid/view/View;)V

    invoke-virtual {v1, v2}, Landroid/animation/ObjectAnimator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    new-instance v2, Lgqg;

    invoke-direct {v2, p0}, Lgqg;-><init>(Lgqi;)V

    invoke-static {v2}, Lmjo;->a(Lj$/util/function/Consumer;)Landroid/animation/Animator$AnimatorListener;
    ...
    invoke-direct {v4, p0}, Lgqh;-><init>(Lgqi;)V
    ...
    :cond_4
    invoke-static {v0}, Lzy;->a(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-direct {v0, p0}, Lgqf;-><init>(Lgqi;)V

    invoke-static {v0}, Lmjo;->b(Lj$/util/function/Consumer;)Landroid/animation/Animator$AnimatorListener;

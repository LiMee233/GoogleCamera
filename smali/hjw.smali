...
.method public constructor <init>(ILandroid/graphics/Rect;ILandroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;)V
    ...
    invoke-direct/range {v0 .. v12}, Lhjw;-><init>(ILandroid/graphics/Rect;ILandroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;FFF)V
...
.method public constructor <init>(ILandroid/graphics/Rect;ILandroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;FFF)V
    ...
    iput-object p2, p0, Lhjw;->a:Landroid/graphics/Rect;

    iput p3, p0, Lhjw;->b:I

    iput-object p4, p0, Lhjw;->c:Landroid/graphics/PointF;

    iput-object p5, p0, Lhjw;->d:Landroid/graphics/PointF;

    iput-object p6, p0, Lhjw;->e:Landroid/graphics/PointF;

    iput-object p7, p0, Lhjw;->f:Landroid/graphics/PointF;

    iput-object p8, p0, Lhjw;->g:Landroid/graphics/PointF;

    iput-object p9, p0, Lhjw;->h:Landroid/graphics/PointF;

    iput p1, p0, Lhjw;->i:I

    iput p10, p0, Lhjw;->j:F

    iput p11, p0, Lhjw;->k:F

    iput p12, p0, Lhjw;->l:F
...
.method public constructor <init>(Landroid/graphics/Rect;I)V
    ...
    invoke-direct/range {v0 .. v6}, Lhjw;-><init>(ILandroid/graphics/Rect;ILandroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;)V

    return-void
.end method

.method public static a(Landroid/hardware/camera2/params/Face;)Lhjw;
    .locals 8

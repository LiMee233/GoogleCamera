...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lxy;->a:[Ljava/lang/Class;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lxy;->b:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Lxy;->k:Landroid/text/TextUtils$TruncateAt;

    sget-object v0, Landroid/text/Layout$Alignment;->ALIGN_CENTER:Landroid/text/Layout$Alignment;

    iput-object v0, p0, Lxy;->l:Landroid/text/Layout$Alignment;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lxy;->m:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lxy;->n:Landroid/graphics/Rect;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lxy;->o:Z
...
.method public final a(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V
    ...
    iget-object v0, p0, Lxy;->f:Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Lxy;->b:Landroid/graphics/Rect;
    ...
    iget-object v5, p0, Lxy;->c:Landroid/text/TextPaint;
    ...
    invoke-virtual {p0, v5}, Lxy;->a(Landroid/text/TextPaint;)V
    ...
    iget-object v6, p0, Lxy;->c:Landroid/text/TextPaint;
    ...
    iget-object v4, p0, Lxy;->f:Ljava/lang/CharSequence;
    ...
    iget-object v4, p0, Lxy;->k:Landroid/text/TextUtils$TruncateAt;
    ...
    iget-object v7, p0, Lxy;->f:Ljava/lang/CharSequence;
    ...
    :goto_4
    iput-object v4, p0, Lxy;->d:Ljava/lang/String;
    ...
    iget-object v4, p0, Lxy;->l:Landroid/text/Layout$Alignment;
    ...
    iput-object v0, p0, Lxy;->h:Landroid/text/StaticLayout;

    iput-boolean v3, p0, Lxy;->p:Z

    iput-boolean v1, p0, Lxy;->q:Z

    :cond_a
    iget-boolean v0, p0, Lxy;->q:Z
    ...
    iget-object p2, p0, Lxy;->b:Landroid/graphics/Rect;
    ...
    :goto_8
    iget-object v4, p0, Lxy;->b:Landroid/graphics/Rect;

    invoke-virtual {v4}, Landroid/graphics/Rect;->height()I

    move-result v4

    iget-object v5, p0, Lxy;->b:Landroid/graphics/Rect;

    invoke-virtual {v5}, Landroid/graphics/Rect;->height()I

    move-result v5

    iget-object v6, p0, Lxy;->m:Landroid/graphics/Rect;

    iget-object v7, p0, Lxy;->b:Landroid/graphics/Rect;
    ...
    iget-object p2, p0, Lxy;->h:Landroid/text/StaticLayout;
    ...
    iget-object v7, p0, Lxy;->m:Landroid/graphics/Rect;

    iget-object v8, p0, Lxy;->n:Landroid/graphics/Rect;

    invoke-static/range {v4 .. v9}, Landroid/view/Gravity;->apply(IIILandroid/graphics/Rect;Landroid/graphics/Rect;I)V

    iput-boolean v3, p0, Lxy;->q:Z

    :cond_e
    invoke-virtual {p1}, Landroid/graphics/Canvas;->save()I

    iget-object p2, p0, Lxy;->n:Landroid/graphics/Rect;

    iget p2, p2, Landroid/graphics/Rect;->left:I

    int-to-float p2, p2

    iget-object v0, p0, Lxy;->n:Landroid/graphics/Rect;
...
.method public final a(Landroid/text/Layout$Alignment;)V
    ...
    iget-object v0, p0, Lxy;->l:Landroid/text/Layout$Alignment;

    if-eq v0, p1, :cond_0

    iput-object p1, p0, Lxy;->l:Landroid/text/Layout$Alignment;
...
.method public final a(Landroid/text/TextPaint;)V
    ...
    iput-object p1, p0, Lxy;->c:Landroid/text/TextPaint;
...
.method public final a(Ljava/lang/CharSequence;)V
    ...
    iget-object v0, p0, Lxy;->e:Ljava/lang/CharSequence;
    ...
    iput-object p1, p0, Lxy;->e:Ljava/lang/CharSequence;
    ...
    sget-object v5, Lxy;->a:[Ljava/lang/Class;
    ...
    :cond_3
    iput-object p1, p0, Lxy;->f:Ljava/lang/CharSequence;
...
.method public final a(Z)V
    ...
    iget-boolean v0, p0, Lxy;->o:Z

    if-eq v0, p1, :cond_0

    iput-boolean p1, p0, Lxy;->o:Z

    iget-object p1, p0, Lxy;->d:Ljava/lang/String;
...
.method public final a()Z
    ...
    iget-object v0, p0, Lxy;->h:Landroid/text/StaticLayout;

...
.method public synthetic constructor <init>(Lhwf;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lhwb;->a:Lhwf;

    iput-object p2, p0, Lhwb;->b:Ljava/lang/String;
...
.method public final run()V
    ...
    iget-object v1, p0, Lhwb;->b:Ljava/lang/String;
    ...
    iget-object v8, v0, Lhwf;->i:Landroid/content/pm/PackageInstaller;
    ...
    :try_start_3
    iget-object v9, v0, Lhwf;->b:Landroid/content/Context;
    ...
    invoke-static {v1}, Lhwf;->d(Ljava/io/InputStream;)Ljava/io/InputStream;
    ...
    iget-object v8, v0, Lhwf;->b:Landroid/content/Context;
    ...
    invoke-static {v6, v9}, Lobm;->ar(ZLjava/lang/Object;)V
    ...
    invoke-static {v9, v11}, Lobm;->ar(ZLjava/lang/Object;)V

    invoke-static {v6, v6}, Lnhs;->a(II)Z
    ...
    invoke-static {v12, v11}, Lnhs;->a(II)Z
    ...
    invoke-static {v9, v13}, Lobm;->ar(ZLjava/lang/Object;)V
    ...
    :cond_3
    invoke-static {v6, v3}, Lnhs;->a(II)Z
    ...
    :cond_4
    invoke-static {v6, v5}, Lnhs;->a(II)Z
    ...
    :cond_5
    invoke-static {v6, v2}, Lnhs;->a(II)Z
    ...
    invoke-static {v6, v1}, Lnhs;->a(II)Z
    ...
    sget-object v1, Lnhs;->a:Landroid/content/ClipData;
    ...
    invoke-interface {v3, v7}, Loub;->G(I)Louv;
    ...
    invoke-interface {v3, v7, v2}, Loub;->p(Ljava/lang/String;I)V
    ...
    :cond_9
    :goto_5
    iget-object v3, v0, Lhwf;->c:Ldeh;

    sget-object v9, Ldeh;->c:Ldeh;

    invoke-virtual {v3, v9}, Ldeh;->b(Ldeh;)Z

    move-result v3

    if-eqz v3, :cond_a

    iget-object v3, v0, Lhwf;->j:Lhwj;

    invoke-virtual {v3}, Lhwj;->b()V
    ...
    invoke-virtual {v0, v4, v8}, Lhwl;->b(II)V

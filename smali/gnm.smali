...
# direct methods
.method public constructor <init>(Llva;Lcmf;)V
    .locals 2
    ...
    iput-object p1, p0, Lgnm;->a:Llvb;

    iput-object p2, p0, Lgnm;->b:Lcmf;
...
.method public final a(Lmpf;DD)V
    ...
    invoke-interface {p1, p4}, Lmpf;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-interface {p1, p5}, Lmpf;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-interface {p5, v0, v1, v2, v3}, Lcmf;->a(JJ)V

    :cond_1
    :goto_0
    iget-wide p4, p0, Lgnm;->c:D
    ...
    invoke-interface {p1, p4}, Llvb;->d(Ljava/lang/String;)V

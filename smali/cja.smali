...
.method public constructor <init>(Ligc;Lcin;)V
    .locals 4
    ...
    iput-object v2, p0, Lcja;->e:Lpic;

    sget-object v2, Lciz;->a:Lciz;

    iput-object v2, p0, Lcja;->i:Lciz;

    iput-object p1, p0, Lcja;->p:Ligc;

    iput-object p2, p0, Lcja;->j:Lcin;

    iput-object v0, p0, Lcja;->b:Lphq;

    iput-object v1, p0, Lcja;->c:Lphq;
    ...
    iget-object p2, p1, Ligc;->b:Ligz;

    invoke-interface {p2}, Ligz;->b()Lj$/time/Duration;
    ...
    invoke-static {v0, v1}, Loxc;->O(J)I
    ...
    iput-object p2, p1, Ligc;->e:Lciy;

    return-void
.end method

.method public static final d(Ljava/lang/Runnable;Lphq;)V
    .locals 1
...
.method public final a(Llxi;)Llxi;
    ...
    iput-object p1, p0, Lcja;->f:Llxi;

    invoke-interface {p1}, Llxi;->b()Landroid/media/AudioFormat;
    ...
    invoke-direct {v0, p1, p0, v1}, Lcis;-><init>(Llxi;Lcjb;Lcir;)V
...
.method public final b(I)V
    ...
    invoke-interface {v4, v5, v6}, Llxi;->e(Ljava/nio/ByteBuffer;I)Llgn;
    ...
    :cond_1
    iget-object v5, v1, Lcja;->p:Ligc;

    iget-object v6, v5, Ligc;->b:Ligz;

    invoke-virtual {v4}, Llgn;->c()Ljava/nio/ByteBuffer;

    move-result-object v7

    invoke-interface {v6, v7}, Ligz;->i(Ljava/nio/ByteBuffer;)Z

    move-result v6

    if-eqz v6, :cond_2

    iget-object v5, v5, Ligc;->a:Lcjd;

    invoke-virtual {v4}, Llgn;->b()J
    ...
    invoke-interface/range {v11 .. v16}, Loub;->B(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public final c()V
    ...
    iget-object v0, p0, Lcja;->f:Llxi;

    invoke-interface {v0}, Llxi;->d()V

    iget-object v0, p0, Lcja;->p:Ligc;

    iget-object v0, v0, Ligc;->b:Ligz;

    invoke-interface {v0}, Ligz;->c()V

    invoke-direct {p0}, Lcja;->e()V

    iget-object v0, p0, Lcja;->c:Lphq;

    invoke-interface {v0}, Lphq;->shutdown()V

    iget-object v0, p0, Lcja;->b:Lphq;
    ...
    invoke-interface {v0, v2, v3, v4}, Lphq;->awaitTermination(JLjava/util/concurrent/TimeUnit;)Z
    ...
    invoke-interface {v0, v1, v2, v3}, Lphq;->awaitTermination(JLjava/util/concurrent/TimeUnit;)Z
    :try_end_1
...
.method public final close()V
    ...
    iget-object v1, p0, Lcja;->f:Llxi;

    invoke-interface {v1}, Llxi;->close()V

    iget-object v1, p0, Lcja;->p:Ligc;

    invoke-virtual {v1}, Ligc;->close()V

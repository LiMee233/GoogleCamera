...
.method public constructor <init>(Lawl;Landroid/os/Handler;)V
    ...
    iput-object v0, p0, Lfcj;->g:Landroid/graphics/SurfaceTexture;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lfcj;->d:Z

    iput-object p1, p0, Lfcj;->b:Lawl;

    iput-object p2, p0, Lfcj;->a:Landroid/os/Handler;
...
# virtual methods
.method public final declared-synchronized a(Landroid/view/WindowManager;Ldde;Lfdd;Z)Laxn;
    .locals 10

    monitor-enter p0

    :try_start_0
    iput-object p3, p0, Lfcj;->e:Lfdd;

    const/4 p3, 0x1

    iput-boolean p3, p0, Lfcj;->c:Z

    iget-object v0, p0, Lfcj;->b:Lawl;
    :try_end_0
    ...
    iget-object p4, p0, Lfcj;->b:Lawl;

    invoke-virtual {p4}, Lawl;->f()Laxh;

    move-result-object p4

    invoke-static {p2, v0}, Lfcm;->a(Ldde;Lawy;)Lawv;
    ...
    iget-object v2, p2, Lfck;->a:Laxn;

    iput-object v2, p0, Lfcj;->f:Laxn;
    ...
    invoke-static {v2, v4, v5}, Ld;->v(Louv;Ljava/lang/String;C)V
    ...
    invoke-static {p3, v2, v4}, Ld;->v(Louv;Ljava/lang/String;C)V
    ...
    iget-object p2, p0, Lfcj;->g:Landroid/graphics/SurfaceTexture;

    invoke-virtual {p1, p2}, Lawl;->l(Landroid/graphics/SurfaceTexture;)V

    iget-boolean p1, p0, Lfcj;->c:Z

    if-eqz p1, :cond_11

    iget-object p1, p0, Lfcj;->b:Lawl;

    iget-object p2, p0, Lfcj;->f:Laxn;

    iget-object p3, p0, Lfcj;->a:Landroid/os/Handler;

    iget-object p4, p0, Lfcj;->e:Lfdd;

    invoke-virtual {p1, p3, v1}, Lawl;->q(Landroid/os/Handler;Lfdd;)V
    ...
    :cond_f
    invoke-virtual {p1, p3, p4}, Lawl;->q(Landroid/os/Handler;Lfdd;)V
    ...
    iget-object p2, p0, Lfcj;->a:Landroid/os/Handler;

    iget-object p3, p0, Lfcj;->e:Lfdd;

    invoke-virtual {p1, p2, p3}, Lawl;->p(Landroid/os/Handler;Lfdd;)V

    :goto_a
    iget-object p1, p0, Lfcj;->f:Laxn;
    :try_end_3

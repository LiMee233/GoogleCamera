...
# direct methods
.method public constructor <init>(Lxv;ZZZ)V
    .locals 8

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lxs;->h:Lxv;

    iput-boolean p2, p0, Lxs;->i:Z

    iput-boolean p3, p0, Lxs;->j:Z

    iput-boolean p4, p0, Lxs;->k:Z
    ...
    invoke-direct {p3, p1}, Landroid/support/wearable/complications/rendering/ComplicationStyle$Builder;-><init>(Lxv;)V
    ...
    :goto_3
    invoke-virtual {p3}, Landroid/support/wearable/complications/rendering/ComplicationStyle$Builder;->a()Lxv;
    ...
    iput-object p3, p0, Lxs;->a:Landroid/text/TextPaint;

    iget v1, p1, Lxv;->d:I

    invoke-virtual {p3, v1}, Landroid/text/TextPaint;->setColor(I)V

    iget-object p3, p0, Lxs;->a:Landroid/text/TextPaint;

    invoke-virtual {p3, p2}, Landroid/text/TextPaint;->setAntiAlias(Z)V

    iget-object p3, p0, Lxs;->a:Landroid/text/TextPaint;

    iget-object v1, p1, Lxv;->f:Landroid/graphics/Typeface;
    ...
    :goto_5
    iput-object v2, p0, Lxs;->l:Landroid/graphics/ColorFilter;

    new-instance v2, Landroid/text/TextPaint;

    invoke-direct {v2}, Landroid/text/TextPaint;-><init>()V

    iput-object v2, p0, Lxs;->b:Landroid/text/TextPaint;

    iget v3, p1, Lxv;->e:I

    invoke-virtual {v2, v3}, Landroid/text/TextPaint;->setColor(I)V

    iget-object v2, p0, Lxs;->b:Landroid/text/TextPaint;

    invoke-virtual {v2, p2}, Landroid/text/TextPaint;->setAntiAlias(Z)V

    iget-object v2, p0, Lxs;->b:Landroid/text/TextPaint;

    iget-object v3, p1, Lxv;->g:Landroid/graphics/Typeface;
    ...
    iput-object v2, p0, Lxs;->c:Landroid/graphics/Paint;

    iget v3, p1, Lxv;->s:I

    invoke-virtual {v2, v3}, Landroid/graphics/Paint;->setColor(I)V

    iget-object v2, p0, Lxs;->c:Landroid/graphics/Paint;
    ...
    iput-object v2, p0, Lxs;->d:Landroid/graphics/Paint;

    iget v3, p1, Lxv;->t:I

    invoke-virtual {v2, v3}, Landroid/graphics/Paint;->setColor(I)V

    iget-object v2, p0, Lxs;->d:Landroid/graphics/Paint;
    ...
    iput-object v2, p0, Lxs;->e:Landroid/graphics/Paint;

    sget-object v3, Landroid/graphics/Paint$Style;->STROKE:Landroid/graphics/Paint$Style;

    invoke-virtual {v2, v3}, Landroid/graphics/Paint;->setStyle(Landroid/graphics/Paint$Style;)V

    iget-object v2, p0, Lxs;->e:Landroid/graphics/Paint;
    ...
    :cond_9
    iget-object p3, p0, Lxs;->e:Landroid/graphics/Paint;
    ...
    iput-object p3, p0, Lxs;->f:Landroid/graphics/Paint;

    iget p4, p1, Lxv;->b:I

    invoke-virtual {p3, p4}, Landroid/graphics/Paint;->setColor(I)V

    iget-object p3, p0, Lxs;->f:Landroid/graphics/Paint;
    ...
    iput-object p3, p0, Lxs;->g:Landroid/graphics/Paint;

    iget p1, p1, Lxv;->u:I

    invoke-virtual {p3, p1}, Landroid/graphics/Paint;->setColor(I)V

    iget-object p1, p0, Lxs;->g:Landroid/graphics/Paint;
...
.method public final a()Z
    ...
    iget-boolean v0, p0, Lxs;->i:Z

    if-eqz v0, :cond_0

    iget-boolean v0, p0, Lxs;->k:Z

...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcis;->a:Loue;

    return-void
.end method

.method public constructor <init>(Llxi;Lcjb;Lcir;)V
    .locals 1
...
.method public final addOnRoutingChangedListener(Landroid/media/AudioRouting$OnRoutingChangedListener;Landroid/os/Handler;)V
    ...
    invoke-interface {v0, p1, p2}, Llxi;->addOnRoutingChangedListener(Landroid/media/AudioRouting$OnRoutingChangedListener;Landroid/os/Handler;)V
...
.method public final b()Landroid/media/AudioFormat;
    ...
    invoke-interface {v0}, Llxi;->b()Landroid/media/AudioFormat;
...
.method public final c()V
    ...
    invoke-static {v3, v4, v7}, Lobm;->aE(ZLjava/lang/String;Ljava/lang/Object;)V

    move-object v3, v1

    check-cast v3, Lcja;

    iget-object v3, v3, Lcja;->f:Llxi;
    ...
    iget-object v4, v4, Lcja;->b:Lphq;

    invoke-static {v3, v4}, Lcja;->d(Ljava/lang/Runnable;Lphq;)V
...
.method public final e(Ljava/nio/ByteBuffer;I)Llgn;
    ...
    invoke-virtual {v3, p1, p2}, Lcip;->a(Ljava/nio/ByteBuffer;I)Llgn;
    ...
    invoke-static {p2, v3, v4, p1}, Ld;->w(Louv;Ljava/lang/String;CLjava/lang/Throwable;)V
...
.method public final getPreferredDevice()Landroid/media/AudioDeviceInfo;
    ...
    invoke-interface {v0}, Llxi;->getPreferredDevice()Landroid/media/AudioDeviceInfo;
...
.method public final getRoutedDevice()Landroid/media/AudioDeviceInfo;
    ...
    invoke-interface {v0}, Llxi;->getRoutedDevice()Landroid/media/AudioDeviceInfo;
...
.method public final removeOnRoutingChangedListener(Landroid/media/AudioRouting$OnRoutingChangedListener;)V
    ...
    invoke-interface {v0, p1}, Llxi;->removeOnRoutingChangedListener(Landroid/media/AudioRouting$OnRoutingChangedListener;)V
...
.method public final setPreferredDevice(Landroid/media/AudioDeviceInfo;)Z
    ...
    invoke-interface {v0, p1}, Llxi;->setPreferredDevice(Landroid/media/AudioDeviceInfo;)Z

...
.method public constructor <init>(Lcom/google/vr/ndk/base/DaydreamApi;Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
    ...
    iput-object p1, p0, Lpjo;->c:Lcom/google/vr/ndk/base/DaydreamApi;

    iput-object p2, p0, Lpjo;->a:Landroid/app/PendingIntent;

    iput-object p3, p0, Lpjo;->b:Landroid/content/ComponentName;
...
.method public final run()V
    ...
    iget-object v0, p0, Lpjo;->c:Lcom/google/vr/ndk/base/DaydreamApi;
    ...
    :try_start_0
    iget-object v0, p0, Lpjo;->a:Landroid/app/PendingIntent;
    ...
    :cond_0
    :try_start_1
    iget-object v2, p0, Lpjo;->a:Landroid/app/PendingIntent;

    iget-object v3, p0, Lpjo;->b:Landroid/content/ComponentName;

    invoke-interface {v0, v2, v3}, Lpkh;->a(Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
    :try_end_1

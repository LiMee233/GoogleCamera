...
.method public final run()V
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, Lkjt;->a:Lkjv;

    sget-object v1, Lkjv;->a:Lkje;

    iget-boolean v1, v0, Lkjv;->g:Z

    if-nez v1, :cond_a

    iget-object v1, v0, Lkjv;->b:Lkjr;

    invoke-interface {v1}, Lkjr;->a()Landroid/media/MediaCodec;
    ...
    sget-object v1, Lkjf;->b:Lkjh;

    invoke-virtual {v0}, Lkje;->toString()Ljava/lang/String;

    move-result-object v0

    const-string v2, "MediaCodec timed out."

    invoke-interface {v1, v0, v2}, Lkjh;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v4, v0, Lkjv;->c:Lkjw;

    invoke-virtual {v4, v3}, Lkjw;->a(Landroid/media/MediaFormat;)I
    ...
    iget-object v7, v0, Lkjv;->e:Ljava/lang/Object;

    monitor-enter v7

    :try_start_1
    iget-object v9, v0, Lkjv;->d:Ljava/util/Queue;

    new-instance v10, Lkju;

    invoke-direct {v10, v5, v3}, Lkju;-><init>(Ljava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V

    invoke-interface {v9, v10}, Ljava/util/Queue;->offer(Ljava/lang/Object;)Z

    iget-object v5, v0, Lkjv;->e:Ljava/lang/Object;
    ...
    :goto_4
    invoke-static {v2, v1}, Lkjf;->a(Lkje;Ljava/lang/String;)V

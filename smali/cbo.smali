...
# direct methods
.method public constructor <init>(Lcbl;Llon;)V
    .locals 1
    ...
    iput-object v0, p0, Lcbo;->d:Landroid/media/AudioRouting$OnRoutingChangedListener;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Lcbo;->h:Ljava/lang/Object;

    iput-object p1, p0, Lcbo;->a:Lcbl;

    iput-object p2, p0, Lcbo;->b:Llnu;
    ...
    iput-object p1, p0, Lcbo;->c:Landroid/os/HandlerThread;

    invoke-virtual {p1}, Landroid/os/HandlerThread;->start()V

    new-instance p1, Landroid/os/Handler;

    iget-object p2, p0, Lcbo;->c:Landroid/os/HandlerThread;
    ...
    iput-object p1, p0, Lcbo;->e:Landroid/os/Handler;

    const/4 p1, 0x0

    iput-boolean p1, p0, Lcbo;->g:Z
...
.method public final a()V
    ...
    iget-object v0, p0, Lcbo;->h:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-boolean v1, p0, Lcbo;->g:Z

    if-nez v1, :cond_1

    iget-object v1, p0, Lcbo;->f:Landroid/media/AudioRouting;

    if-eqz v1, :cond_0

    iget-object v2, p0, Lcbo;->d:Landroid/media/AudioRouting$OnRoutingChangedListener;
    ...
    iput-object v1, p0, Lcbo;->f:Landroid/media/AudioRouting;
...
.method public final a(Landroid/media/AudioRouting;)V
    ...
    iput-object p1, p0, Lcbo;->f:Landroid/media/AudioRouting;

    invoke-virtual {p0, p1}, Lcbo;->b(Landroid/media/AudioRouting;)V

    iget-object v1, p0, Lcbo;->d:Landroid/media/AudioRouting$OnRoutingChangedListener;

    iget-object v2, p0, Lcbo;->e:Landroid/os/Handler;
...
.method public final b(Landroid/media/AudioRouting;)V
    ...
    invoke-virtual {v0}, Lcbl;->a()Landroid/media/AudioDeviceInfo;
    ...
    invoke-static {v0}, Lcbl;->a(Landroid/media/AudioDeviceInfo;)Ljava/lang/String;
...
.method public final close()V
    ...
    iput-boolean v1, p0, Lcbo;->g:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :try_start_1
    iget-object v1, p0, Lcbo;->c:Landroid/os/HandlerThread;

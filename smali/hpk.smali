...
.method public constructor <init>(Landroid/hardware/SensorManager;Ljava/util/concurrent/Executor;)V
    ...
    iput-object p1, p0, Lhpk;->a:Landroid/hardware/SensorManager;

    iput-object p2, p0, Lhpk;->c:Ljava/util/concurrent/Executor;
    ...
    :goto_0
    iput-object p2, p0, Lhpk;->b:Landroid/hardware/Sensor;
...
.method public final a(Landroid/hardware/SensorEventListener;)V
    ...
    iget-object v0, p0, Lhpk;->b:Landroid/hardware/Sensor;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lhpk;->c:Ljava/util/concurrent/Executor;

    new-instance v1, Lhpj;

    const/4 v2, 0x0

    invoke-direct {v1, p0, p1, v2}, Lhpj;-><init>(Lhpk;Landroid/hardware/SensorEventListener;I)V

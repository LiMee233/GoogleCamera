...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Ldft;->b:Ljava/util/TreeSet;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Ldft;->c:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Ldft;->d:Ljava/util/Map;

    return-void
.end method

.method private final declared-synchronized l(Lbtz;)Loix;
    .locals 6

    monitor-enter p0

    :try_start_0
    invoke-interface {p1}, Lbtz;->d()Lhso;
    ...
    invoke-static {v4, v5, p1}, Lobm;->aE(ZLjava/lang/String;Ljava/lang/Object;)V

    if-eqz v0, :cond_2

    iget-object p1, p0, Ldft;->c:Ljava/util/Map;
    ...
    :goto_1
    iget-object v0, p0, Ldft;->d:Ljava/util/Map;
    ...
    invoke-static {v2, v1, v0, p1}, Lobm;->aF(ZLjava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
...
.method private final declared-synchronized m(Lbty;)V
    ...
    invoke-direct {p0, p1}, Ldft;->l(Lbtz;)Loix;
    ...
    iget-object v2, p0, Ldft;->c:Ljava/util/Map;
    ...
    :cond_2
    iget-object v0, p0, Ldft;->b:Ljava/util/TreeSet;
    ...
    iget-object v2, p0, Ldft;->b:Ljava/util/TreeSet;
...
.method final declared-synchronized d(Lhso;)Lbty;
    .locals 1

    monitor-enter p0

    :try_start_0
    iget-object v0, p0, Ldft;->c:Ljava/util/Map;
...
.method final declared-synchronized e(Lbty;)Lbty;
    ...
    invoke-direct {p0, v0}, Ldft;->l(Lbtz;)Loix;
    ...
    :cond_0
    :try_start_1
    invoke-virtual {p0, p1}, Ldft;->k(Lbty;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method final declared-synchronized g(Ljava/util/Collection;)V
    ...
    iget-object v4, p0, Ldft;->b:Ljava/util/TreeSet;

    invoke-virtual {v4}, Ljava/util/TreeSet;->size()I

    move-result v4

    invoke-static {v0, v3, v4}, Lobm;->aD(ZLjava/lang/String;I)V
    ...
    iget-object v4, p0, Ldft;->d:Ljava/util/Map;
    ...
    iget-object v4, p0, Ldft;->c:Ljava/util/Map;
    ...
    invoke-interface {v3}, Lbtz;->d()Lhso;
    ...
    iget-object v5, p0, Ldft;->d:Ljava/util/Map;
    ...
    iget-object v10, p0, Ldft;->d:Ljava/util/Map;
    ...
    invoke-static {v5, v8}, Lobm;->aC(ZLjava/lang/Object;)V
    ...
    iget-object v8, p0, Ldft;->c:Ljava/util/Map;
...
.method final declared-synchronized i(Landroid/net/Uri;)V
    ...
    :try_start_0
    invoke-virtual {p0, p1}, Ldft;->c(Landroid/net/Uri;)Lbty;

    move-result-object v0

    if-nez v0, :cond_0

    sget-object v0, Ldft;->a:Loue;
    ...
    :cond_0
    :try_start_1
    invoke-direct {p0, v0}, Ldft;->m(Lbty;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public final declared-synchronized iterator()Ljava/util/Iterator;
    ...
    iget-object v1, p0, Ldft;->b:Ljava/util/TreeSet;
...
.method final declared-synchronized j(Lbty;)V
    ...
    :try_start_0
    invoke-direct {p0, p1}, Ldft;->m(Lbty;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method final declared-synchronized k(Lbty;)V
    ...
    invoke-static {v3, v4, p1}, Lobm;->aE(ZLjava/lang/String;Ljava/lang/Object;)V

...
.method public static n(Laii;Lqlc;)Ljava/lang/Object;
    .locals 5
    ...
    invoke-direct {v0, p1}, Laim;-><init>(Lqlc;)V
    ...
    sget-object v3, Lqrb;->c:Lqld;

    invoke-interface {v2, v3}, Lqli;->get(Lqlg;)Lqlf;
    ...
    invoke-direct {v3, p1}, Lain;-><init>(Lqre;)V

    invoke-interface {v2, v3}, Lqrb;->o(Lqmp;)Lqqm;
    ...
    invoke-static {v2, p1, v0}, Lfx;->q(Ljava/util/concurrent/Executor;Lqrb;Lqlc;)Ljava/lang/Object;
    ...
    invoke-direct {v1, p0, p1}, Laiz;-><init>(Lqrb;Lqle;)V
    ...
    invoke-direct {p0, v2, v0}, Lqvp;-><init>(Ljava/lang/Object;Ljava/lang/ThreadLocal;)V

    invoke-interface {p1, v1}, Lqle;->plus(Lqli;)Lqli;
...
.method public static o(Laii;Lqmp;Lqlc;)Ljava/lang/Object;
    .locals 5
    ...
    invoke-direct {v0, p2}, Laio;-><init>(Lqlc;)V
    ...
    sget-object v2, Laiz;->c:Lqld;

    invoke-interface {p2, v2}, Lqli;->get(Lqlg;)Lqlf;
    ...
    invoke-static {p0, v0}, Lfx;->n(Laii;Lqlc;)Ljava/lang/Object;
    ...
    invoke-direct {v2, p0, p1, v3}, Laip;-><init>(Laii;Lqmp;Lqlc;)V
    ...
    invoke-static {p2, v2, v0}, Lqnh;->g(Lqli;Lqmt;Lqlc;)Ljava/lang/Object;
...
.method private static q(Ljava/util/concurrent/Executor;Lqrb;Lqlc;)Ljava/lang/Object;
    .locals 2
    ...
    invoke-direct {v0, p2, v1}, Lqpj;-><init>(Lqlc;I)V

    invoke-virtual {v0}, Lqpj;->r()V

    new-instance p2, Laij;

    invoke-direct {p2, p1}, Laij;-><init>(Lqrb;)V

    invoke-interface {v0, p2}, Lqpi;->a(Lqmp;)V

    :try_start_0
    new-instance p2, Lail;

    invoke-direct {p2, v0, p1}, Lail;-><init>(Lqpi;Lqrb;)V
    ...
    invoke-interface {v0, p1}, Lqpi;->c(Ljava/lang/Throwable;)V

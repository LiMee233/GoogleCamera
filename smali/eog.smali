...
.method public synthetic constructor <init>(Lcom/google/android/apps/camera/keepalive/ProcessGcService;Landroid/app/job/JobParameters;)V
    ...
    iput-object p2, p0, Leog;->b:Landroid/app/job/JobParameters;
...
.method public final run()V
    ...
    iget-object v1, p0, Leog;->b:Landroid/app/job/JobParameters;

    iget-object v2, v0, Lcom/google/android/apps/camera/keepalive/ProcessGcService;->c:Lenv;

    invoke-virtual {v2}, Lenv;->c()Z

    move-result v2

    if-eqz v2, :cond_0

    sget-object v2, Lcom/google/android/apps/camera/keepalive/ProcessGcService;->a:Loue;
    ...
    invoke-direct {v2, v0}, Leof;-><init>(Lcom/google/android/apps/camera/keepalive/ProcessGcService;)V

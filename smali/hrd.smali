...
# direct methods
.method public constructor <init>(Lhrg;Landroid/graphics/Bitmap;Ljava/io/File;Lhpq;)V
    .locals 0
    ...
    iput-object p3, p0, Lhrd;->c:Ljava/io/File;

    iput-object p4, p0, Lhrd;->d:Lhpq;
...
.method public final run()V
    ...
    iget-object v0, p0, Lhrd;->a:Lhrg;

    iget-object v1, p0, Lhrd;->b:Landroid/graphics/Bitmap;

    iget-object v2, p0, Lhrd;->c:Ljava/io/File;

    iget-object v3, p0, Lhrd;->d:Lhpq;

    :try_start_0
    iget-object v4, v0, Lhrg;->c:Lhrh;
    ...
    invoke-static {v6}, Losd;->b(Ljava/io/File;)V
    ...
    invoke-virtual {v5, v6, v7}, Llxz;->a(J)V
    ...
    :try_start_1
    iget-object v5, v5, Llxz;->a:Lcom/google/android/libraries/camera/exif/ExifInterface;

    if-eqz v1, :cond_0

    new-instance v7, Loox;

    invoke-direct {v7, v6}, Loox;-><init>(Ljava/io/OutputStream;)V
    :try_end_1
    ...
    invoke-virtual {v7}, Loox;->flush()V
    :try_end_4
    .catchall {:try_start_4 .. :try_end_4} :catchall_2

    :try_start_5
    invoke-virtual {v7}, Loox;->close()V
    :try_end_5

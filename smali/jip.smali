...
# direct methods
.method public constructor <init>(Landroid/support/constraint/ConstraintLayout;Ljcd;Landroid/view/WindowManager;Landroid/view/TextureView$SurfaceTextureListener;)V
    .locals 1
    ...
    iput-object v0, p0, Ljip;->e:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Ljip;->j:Landroid/graphics/RectF;
    ...
    iput-object v0, p0, Ljip;->l:Landroid/view/Surface;

    iput-object v0, p0, Ljip;->m:Landroid/graphics/SurfaceTexture;

    iput-object p1, p0, Ljip;->a:Landroid/support/constraint/ConstraintLayout;
    ...
    iput-object v0, p0, Ljip;->b:Landroid/view/TextureView;

    invoke-virtual {v0, p0}, Landroid/view/TextureView;->setSurfaceTextureListener(Landroid/view/TextureView$SurfaceTextureListener;)V

    iput-object p3, p0, Ljip;->c:Landroid/view/WindowManager;

    iput-object p2, p0, Ljip;->f:Ljcd;

    iput-object p4, p0, Ljip;->d:Landroid/view/TextureView$SurfaceTextureListener;
...
.method public final a()I
    ...
    iget-object v0, p0, Ljip;->b:Landroid/view/TextureView;
...
.method public final c()Loix;
    ...
    iget-object v3, p0, Ljip;->b:Landroid/view/TextureView;
    ...
    invoke-static {v1, v3}, Ljnk;->b(Landroid/graphics/Bitmap;I)Ljnk;
...
.method public final d()Lpho;
    ...
    iget-object v0, p0, Ljip;->a:Landroid/support/constraint/ConstraintLayout;

    iget-object v1, p0, Ljip;->b:Landroid/view/TextureView;
...
.method public final f()V
    ...
    iget-object v0, p0, Ljip;->j:Landroid/graphics/RectF;
    ...
    iget-object v1, p0, Ljip;->e:Ljava/util/ArrayList;
    ...
    invoke-direct {v2, v0}, Ljio;-><init>(Ljava/util/List;)V
    ...
    iget-object v0, p0, Ljip;->f:Ljcd;

    invoke-virtual {v0}, Ljcd;->b()Lcom/google/android/apps/camera/ui/views/MainActivityLayout;
...
.method public final onLayoutChange(Landroid/view/View;IIIIIIII)V
    ...
    iget-object p1, p0, Ljip;->b:Landroid/view/TextureView;
    ...
    iget-object p1, p0, Ljip;->f:Ljcd;

    invoke-virtual {p1}, Ljcd;->c()Z

    move-result p1

    iget-object p2, p0, Ljip;->c:Landroid/view/WindowManager;

    invoke-static {p2}, Lfcx;->d(Landroid/view/WindowManager;)I
...
.method public final onSurfaceTextureAvailable(Landroid/graphics/SurfaceTexture;II)V
    ...
    iput-object p1, p0, Ljip;->m:Landroid/graphics/SurfaceTexture;

    iget-object v0, p0, Ljip;->d:Landroid/view/TextureView$SurfaceTextureListener;

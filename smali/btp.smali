...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lbtp;->a:Loue;

    return-void
.end method

.method public constructor <init>(Landroid/os/Handler;Lbtl;Llkb;Llvo;Ldkb;Landroid/app/admin/DevicePolicyManager;Ljava/util/concurrent/Executor;Ljava/util/concurrent/Semaphore;)V
    .locals 1
    ...
    iput-object p5, p0, Lbtp;->o:Ldkb;

    iput-object p3, p0, Lbtp;->h:Llkb;

    iput-object p4, p0, Lbtp;->i:Llvo;
...
.method private final n(Lbtl;Llvq;Landroid/os/Handler;Lavw;)V
    .locals 2
    ...
    throw p1
    :try_end_0
    .catch Ldlo; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-direct {p1, p4, p2}, Lbtm;-><init>(Lavw;Llvq;)V
...
.method public final declared-synchronized g(I)V
    ...
    :try_start_0
    iget-object v0, p0, Lbtp;->e:Llvq;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Llvq;->a()I
...
.method public final declared-synchronized h()V
    ...
    invoke-direct {p0, v1, v0, v2, p0}, Lbtp;->n(Lbtl;Llvq;Landroid/os/Handler;Lavw;)V
...
.method public final j(I)V
    ...
    invoke-interface {v1, v2, v0, p1}, Loub;->s(Ljava/lang/String;II)V

    return-void

    :cond_1
    iget-object v0, p0, Lbtp;->o:Ldkb;

    iget-object v1, p0, Lbtp;->i:Llvo;

    invoke-interface {v1, p1}, Llvo;->c(I)Llvq;

    move-result-object p1

    iget-object v1, v0, Ldkb;->a:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v2, v0, Ldkb;->b:Llvq;

    if-eqz v2, :cond_2

    invoke-virtual {v2, p1}, Llvq;->equals(Ljava/lang/Object;)Z
...
.method public final synthetic l()V
    ...
    invoke-interface {v1, v0}, Llvo;->c(I)Llvq;
    ...
    :try_start_0
    iget-object v2, p0, Lbtp;->e:Llvq;

    if-eqz v2, :cond_1

    invoke-virtual {v2, v1}, Llvq;->equals(Ljava/lang/Object;)Z
    ...
    :cond_1
    iput-object v1, p0, Lbtp;->e:Llvq;

    monitor-exit p0
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object v1, p0, Lbtp;->h:Llkb;

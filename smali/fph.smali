...
# direct methods
.method public constructor <init>(Lgva;Llcy;Landroid/util/DisplayMetrics;Lkaq;Ljava/util/concurrent/ScheduledExecutorService;)V
    .locals 1
    ...
    iput-object v0, p0, Lfph;->b:Lfvr;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    iput-object v0, p0, Lfph;->j:Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-static {}, Lj$/util/Optional;->empty()Lj$/util/Optional;

    move-result-object v0

    iput-object v0, p0, Lfph;->c:Lj$/util/Optional;
    ...
    iput-object p1, p0, Lfph;->h:Lgva;

    iput-object p2, p0, Lfph;->a:Llcy;

    iput-object p3, p0, Lfph;->g:Landroid/util/DisplayMetrics;

    iput-object p4, p0, Lfph;->k:Lkaq;

    iput-object p5, p0, Lfph;->i:Ljava/util/concurrent/ScheduledExecutorService;
...
.method private final declared-synchronized g(Landroid/util/Range;)V
    ...
    :try_start_0
    iget-object v0, p0, Lfph;->j:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_0
    :try_start_1
    iget-object v0, p0, Lfph;->i:Ljava/util/concurrent/ScheduledExecutorService;

    new-instance v2, Lfpg;

    invoke-direct {v2, p0, p1, v1}, Lfpg;-><init>(Lfph;Landroid/util/Range;I)V
...
.method public final a(Landroid/view/MotionEvent;Landroid/view/MotionEvent;Landroid/graphics/Rect;Z)V
    ...
    iget-object p4, p0, Lfph;->b:Lfvr;

    invoke-virtual {p4, p1}, Lfvr;->b(Landroid/view/MotionEvent;)V

    iget-object p4, p0, Lfph;->k:Lkaq;

    invoke-interface {p4}, Lkaq;->c()F

    move-result p4

    iget-object v0, p0, Lfph;->k:Lkaq;

    invoke-interface {v0}, Lkaq;->b()F
    ...
    :cond_1
    iget-object v0, p0, Lfph;->c:Lj$/util/Optional;
    ...
    :cond_2
    iget-object v0, p0, Lfph;->g:Landroid/util/DisplayMetrics;

    iget v0, v0, Landroid/util/DisplayMetrics;->heightPixels:I

    iget-object v3, p0, Lfph;->g:Landroid/util/DisplayMetrics;
    ...
    invoke-static {p2, p3}, Lfph;->f(FF)Landroid/util/Range;
    ...
    invoke-static {p3, v0}, Lfph;->f(FF)Landroid/util/Range;

    move-result-object p3

    invoke-static {p1, p3}, Lfph;->d(FLandroid/util/Range;)F
    ...
    invoke-static {p1, p2}, Lfph;->e(FLandroid/util/Range;)F

    move-result p2

    iget-object p3, p0, Lfph;->b:Lfvr;

    invoke-virtual {p3}, Lfvr;->a()F
    ...
    invoke-static {p2, p4}, Lfph;->d(FLandroid/util/Range;)F
    ...
    invoke-static {p2, p4}, Lfph;->e(FLandroid/util/Range;)F
    ...
    :cond_d
    iget-object p2, p0, Lfph;->g:Landroid/util/DisplayMetrics;

    iget p2, p2, Landroid/util/DisplayMetrics;->heightPixels:I

    iget-object p3, p0, Lfph;->g:Landroid/util/DisplayMetrics;
    ...
    invoke-direct {p0, p4}, Lfph;->g(Landroid/util/Range;)V
...
.method public final c(Landroid/util/Range;)V
    ...
    invoke-direct {v1, p0, p1, v2}, Lfpg;-><init>(Lfph;Landroid/util/Range;I)V

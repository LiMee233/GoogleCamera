...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0, v1}, Lixw;-><init>(Loac;[B)V
...
.method public constructor <init>(Loac;)V
    ...
    invoke-direct {p0, p1, v0}, Lixw;-><init>(Loac;[B)V

    return-void
.end method

.method public constructor <init>(Loac;[B)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lixw;->d:Loac;

    invoke-static {}, Lcom/google/android/apps/camera/jni/tracking/RoiTrackerNative;->createHandle()J

    move-result-wide p1

    iput-wide p1, p0, Lixw;->b:J

    const-wide/16 p1, 0x0

    iput-wide p1, p0, Lixw;->c:J
...
# virtual methods
.method public final declared-synchronized a(Lmpq;)Liyx;
    .locals 31
    ...
    invoke-interface/range {p1 .. p1}, Lmpq;->f()J

    move-result-wide v8

    invoke-interface {v7, v8, v9}, Liyt;->a(J)[F
    ...
    :goto_0
    invoke-interface/range {p1 .. p1}, Lmpq;->g()Landroid/hardware/HardwareBuffer;
    ...
    invoke-virtual {v9, v10}, Liyw;->a(Landroid/graphics/RectF;)V

    invoke-virtual {v9, v6}, Liyw;->a(F)V

    invoke-static {v0}, Lixw;->a(I)I
    ...
    invoke-virtual {v9, v2, v3}, Liyw;->a(J)V

    invoke-virtual {v9}, Liyw;->a()Liyx;
...
.method public final declared-synchronized a(Lmpq;Landroid/graphics/PointF;)Liyx;
    .locals 31
    ...
    iput-wide v2, v1, Lixw;->c:J

    iget-object v2, v1, Lixw;->d:Loac;
    ...
    invoke-direct {v5, v6, v7}, Lluo;-><init>(II)V

    invoke-interface/range {p1 .. p1}, Lmpq;->f()J

    move-result-wide v6

    invoke-interface {v2, v5, v6, v7}, Liyt;->a(Lluo;J)Z
    ...
    invoke-virtual {v6, v9}, Liyw;->a(Landroid/graphics/RectF;)V

    const/high16 v0, 0x3f800000    # 1.0f

    invoke-virtual {v6, v0}, Liyw;->a(F)V

    invoke-static {v2}, Lixw;->a(I)I
    ...
    invoke-virtual {v6, v2, v3}, Liyw;->a(J)V

    invoke-virtual {v6}, Liyw;->a()Liyx;
...
.method public final declared-synchronized close()V
    ...
    invoke-interface {v0}, Liyt;->close()V

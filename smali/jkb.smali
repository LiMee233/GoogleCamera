...
.method public constructor <init>(Lchh;)V
    ...
    iput-object p1, p0, Ljkb;->b:Lchh;

    return-void
.end method

.method public static c(Landroid/content/Context;)Loac;
    .locals 4
    ...
    invoke-direct {v0, p0}, Lpih;-><init>(Landroid/content/pm/PackageManager;)V

    const-string p0, "com.google.vr.apps.ornament"

    const-string v1, "app_name"

    invoke-virtual {v0, p0, v1}, Lpih;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static d(Landroid/content/Context;)Loac;
    .locals 4
    ...
    invoke-virtual {v0, p0, v1}, Lpih;->b(Ljava/lang/String;Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    :goto_0
    sget-object v1, Ljkb;->a:Ljava/lang/String;
...
.method public static e(Landroid/content/Context;)Loac;
    .locals 4
    ...
    invoke-virtual {v0}, Lpih;->a()Ljava/lang/String;
...
.method public final a(Landroid/content/Context;)Z
    ...
    invoke-direct {v0, p1}, Lpih;-><init>(Landroid/content/pm/PackageManager;)V

    const-string p1, "com.google.vr.apps.ornament"

    const-string v1, "com.google.vr.apps.ornament.app.MainActivity"

    invoke-virtual {v0, p1, v1}, Lpih;->c(Ljava/lang/String;Ljava/lang/String;)Z

    move-result p1

    if-nez p1, :cond_0

    sget-object p1, Ljkb;->a:Ljava/lang/String;
    ...
    :cond_0
    invoke-virtual {p0, v0}, Ljkb;->a(Lpih;)Z
...
.method public final a(Lpih;)Z
    ...
    invoke-virtual {p1, v0, v1}, Lpih;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object p1, Lpih;->a:Ljava/lang/String;
    ...
    iget-object p1, p1, Lpih;->b:Landroid/content/pm/PackageManager;

...
# direct methods
.method public constructor <init>(Laar;Lbst;Lbsu;Laaq;Landroid/content/res/Resources;Lfjr;Ldde;Lbui;Llvo;Lhue;[B[B)V
    .locals 0
    ...
    sget-object p1, Lhtt;->b:Lhuj;

    invoke-interface {p10, p1}, Lhue;->a(Lhtr;)Llcm;

    move-result-object p1

    iput-object p1, p0, Lbsq;->f:Llcm;

    iput-object p6, p0, Lbsq;->i:Lfjr;

    iput-object p7, p0, Lbsq;->j:Ldde;
    ...
    invoke-static {p4}, Lmin;->bV(Landroid/os/Looper;)Landroid/os/Handler;
    ...
    iget-object p4, p2, Lbst;->a:Llcy;

    iput-object p4, p0, Lbsq;->k:Llcy;

    const/4 p4, 0x0

    iput p4, p0, Lbsq;->l:I

    iget-object p4, p8, Lbui;->b:Llan;

    new-instance p5, Lbsp;

    invoke-direct {p5, p9, p2, p3}, Lbsp;-><init>(Llvo;Lbst;Lbsu;)V

    sget-object p2, Lpgm;->a:Lpgm;

    invoke-interface {p1, p5, p2}, Llcm;->a(Llih;Ljava/util/concurrent/Executor;)Llic;
...
.method public final a(Lhim;)V
    ...
    invoke-interface {v11}, Llzz;->getBuffer()Ljava/nio/ByteBuffer;
    ...
    invoke-interface {v11}, Llzz;->getRowStride()I
    ...
    invoke-direct {v0, v5, v6}, Lpjf;-><init>(J)V

    new-instance v4, Lpjf;

    invoke-direct {v4, v11, v12}, Lpjf;-><init>(J)V
    ...
    invoke-static {v0}, Lpjf;->a(Lpjf;)J

    move-result-wide v12

    invoke-static {v4}, Lpjf;->a(Lpjf;)J
    ...
    invoke-virtual {v5, v6}, Lldl;->fB(Ljava/lang/Object;)V

    iget-object v4, v4, Lbsu;->b:Ldde;
    ...
    :cond_10
    iget-object v0, v1, Lbsq;->j:Ldde;

    sget-object v3, Ldcr;->a:Lddh;
...
.method public final d(Llvq;)V
    ...
    invoke-virtual {v1, p1}, Lbst;->d(Llvq;)Lbss;
    ...
    iget-object p1, v0, Lbsu;->b:Ldde;

    sget-object v0, Ldcr;->a:Lddh;

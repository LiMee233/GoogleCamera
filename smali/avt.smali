...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lavt;->b:Landroid/graphics/Paint;
    ...
    sput-object v0, Lavt;->c:Landroid/graphics/Paint;
    ...
    sput-object v0, Lavt;->e:Ljava/util/Set;
    ...
    :goto_0
    sput-object v0, Lavt;->a:Ljava/util/concurrent/locks/Lock;

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0, v2}, Landroid/graphics/Paint;-><init>(I)V

    sput-object v0, Lavt;->d:Landroid/graphics/Paint;
...
.method public static a(Lapg;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    .locals 6
    ...
    invoke-static {p1}, Lavt;->a(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap$Config;

    move-result-object v1

    invoke-interface {p0, p2, p3, v1}, Lapg;->a(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;

    move-result-object p0

    invoke-static {p1, p0}, Lavt;->a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)V

    invoke-static {p1, p0, v0}, Lavt;->a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Landroid/graphics/Matrix;)V
...
.method public static a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Landroid/graphics/Matrix;)V
    ...
    sget-object p1, Lavt;->b:Landroid/graphics/Paint;
    ...
    invoke-static {v0}, Lavt;->a(Landroid/graphics/Canvas;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    sget-object p0, Lavt;->a:Ljava/util/concurrent/locks/Lock;
    ...
    sget-object p1, Lavt;->a:Ljava/util/concurrent/locks/Lock;
...
.method public static b(Lapg;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    .locals 2
    ...
    invoke-interface {p0, p3, v0, v1}, Lapg;->a(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, p0, p3}, Lavt;->a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Landroid/graphics/Matrix;)V
...
.method public static c(Lapg;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    .locals 1
    ...
    :cond_1
    :goto_0
    invoke-static {p0, p1, p2, p3}, Lavt;->b(Lapg;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
...
.method public static d(Lapg;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    .locals 6
    ...
    invoke-static {p1}, Lavt;->b(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap$Config;
    ...
    invoke-interface {p0, v2, v4, p3}, Lapg;->a(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    invoke-interface {p0, p2, p2, v2}, Lapg;->a(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    sget-object v2, Lavt;->a:Ljava/util/concurrent/locks/Lock;
    ...
    invoke-static {v2}, Lavt;->a(Landroid/graphics/Canvas;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-interface {p0, p3}, Lapg;->a(Landroid/graphics/Bitmap;)V

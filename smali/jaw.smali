...
# static fields
.field private static final g:Ljap;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ljaw;->g:Ljap;

    return-void
.end method

.method public constructor <init>(Landroid/app/Activity;Ldde;Llap;Llcy;)V
    .locals 1

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    sget-object v0, Ljaw;->g:Ljap;

    iput-object v0, p0, Ljaw;->k:Ljap;

    iput-object p1, p0, Ljaw;->h:Landroid/app/Activity;

    iput-object p2, p0, Ljaw;->a:Ldde;

    iput-object p3, p0, Ljaw;->i:Llap;

    iput-object p4, p0, Ljaw;->j:Llcy;
...
.method private final l(Landroid/view/ViewGroup;I)V
    ...
    iget-object v0, p0, Ljaw;->n:Landroid/view/ViewGroup;

    if-eq p1, v0, :cond_0

    iget-object v0, p0, Ljaw;->b:Lcom/google/android/apps/camera/ui/elapsedtimeui/ElapsedTimerView;

    invoke-virtual {p1, v0}, Landroid/view/ViewGroup;->removeView(Landroid/view/View;)V

    iget-object p1, p0, Ljaw;->n:Landroid/view/ViewGroup;
    ...
    :cond_0
    iget-object p1, p0, Ljaw;->b:Lcom/google/android/apps/camera/ui/elapsedtimeui/ElapsedTimerView;
    ...
    iget-object p2, p0, Ljaw;->b:Lcom/google/android/apps/camera/ui/elapsedtimeui/ElapsedTimerView;
...
.method private final m()V
    ...
    iget-object v0, p0, Ljaw;->c:Landroid/widget/TextView;
...
.method public final a(Z)V
    ...
    invoke-direct {v0, p0, v1}, Ljas;-><init>(Ljaw;I)V
    ...
    invoke-virtual {p0}, Ljaw;->k()V

    :goto_0
    iget-object p1, p0, Ljaw;->a:Ldde;

    sget-object v0, Lddk;->a:Lddh;

    invoke-interface {p1}, Ldde;->d()V

    sget-object p1, Ljaw;->g:Ljap;

    iput-object p1, p0, Ljaw;->k:Ljap;

    iget-object p1, p0, Ljaw;->j:Llcy;
    ...
    iget-object p1, p0, Ljaw;->h:Landroid/app/Activity;
    ...
    iget-object p1, p0, Ljaw;->o:Landroid/view/View;
...
.method public final b()V
    ...
    iget-object v2, p0, Ljaw;->l:Landroid/content/res/Resources;

    const/4 v3, 0x1

    new-array v3, v3, [Ljava/lang/Object;

    iget-wide v4, p0, Ljaw;->e:J
...
.method public final c()V
    ...
    invoke-direct {p0}, Ljaw;->m()V

    :cond_0
    return-void
.end method

.method public final d(Ljap;)V
    .locals 0
...
.method public final e()V
    ...
    iget-object v0, p0, Ljaw;->l:Landroid/content/res/Resources;
    ...
    iget-object v1, p0, Ljaw;->l:Landroid/content/res/Resources;
    ...
    iget-object v2, p0, Ljaw;->d:Landroid/widget/TextView;
    ...
    invoke-direct {v5, p0}, Ljav;-><init>(Ljaw;)V
    ...
    :cond_0
    iget-object v2, p0, Ljaw;->h:Landroid/app/Activity;
    ...
    iget-object v5, p0, Ljaw;->k:Ljap;

    iget-boolean v6, v5, Ljap;->b:Z

    if-eqz v6, :cond_1

    iget-object v5, p0, Ljaw;->h:Landroid/app/Activity;
    ...
    iget-object v5, p0, Ljaw;->a:Ldde;

    sget-object v6, Ldct;->r:Lddf;
    ...
    :cond_5
    iget-object v1, p0, Ljaw;->d:Landroid/widget/TextView;

    invoke-virtual {v1, v0, v3, v0, v3}, Landroid/widget/TextView;->setPadding(IIII)V

    iget-object v0, p0, Ljaw;->d:Landroid/widget/TextView;
...
.method public final f()V
    ...
    new-array v1, v0, [Llcm;

    iget-object v2, p0, Ljaw;->k:Ljap;

    iget-object v3, v2, Ljap;->d:Llcm;

    const/4 v4, 0x0

    aput-object v3, v1, v4

    iget-object v2, v2, Ljap;->e:Llcm;
    ...
    invoke-direct {v2, p0}, Ljar;-><init>(Ljaw;)V

    iget-object v5, p0, Ljaw;->i:Llap;

    invoke-interface {v1, v2, v5}, Llcm;->a(Llih;Ljava/util/concurrent/Executor;)Llic;

    move-result-object v1

    iput-object v1, p0, Ljaw;->q:Llic;

    const-wide/16 v1, 0x0

    invoke-virtual {p0, v1, v2}, Ljaw;->h(J)V

    iget-object v5, p0, Ljaw;->n:Landroid/view/ViewGroup;

    if-eqz v5, :cond_0

    iget-object v5, p0, Ljaw;->b:Lcom/google/android/apps/camera/ui/elapsedtimeui/ElapsedTimerView;

    invoke-virtual {v5}, Lcom/google/android/apps/camera/ui/elapsedtimeui/ElapsedTimerView;->getDisplay()Landroid/view/Display;

    move-result-object v5

    iget-object v6, p0, Ljaw;->b:Lcom/google/android/apps/camera/ui/elapsedtimeui/ElapsedTimerView;
    ...
    invoke-static {v5, v6}, Ljrx;->a(Landroid/view/Display;Landroid/content/Context;)Ljrx;
    ...
    invoke-virtual {v5}, Ljrx;->ordinal()I
    ...
    invoke-direct {p0, v6, v5}, Ljaw;->l(Landroid/view/ViewGroup;I)V
    ...
    iget-object v8, p0, Ljaw;->o:Landroid/view/View;
    ...
    iget-object v9, p0, Ljaw;->l:Landroid/content/res/Resources;
    ...
    iget-object v10, p0, Ljaw;->b:Lcom/google/android/apps/camera/ui/elapsedtimeui/ElapsedTimerView;
    ...
    iget-object v7, p0, Ljaw;->b:Lcom/google/android/apps/camera/ui/elapsedtimeui/ElapsedTimerView;
    ...
    :cond_0
    :goto_0
    invoke-virtual {p0}, Ljaw;->j()V

    iget-object v5, p0, Ljaw;->a:Ldde;

    sget-object v6, Ldct;->J:Lddf;
    ...
    invoke-virtual {p0, v1, v2}, Ljaw;->g(J)V
    ...
    :goto_1
    iget-object v1, p0, Ljaw;->b:Lcom/google/android/apps/camera/ui/elapsedtimeui/ElapsedTimerView;
    ...
    invoke-direct {v2, p0, v4}, Ljas;-><init>(Ljaw;I)V

    invoke-virtual {v1, v2}, Landroid/view/ViewPropertyAnimator;->withStartAction(Ljava/lang/Runnable;)Landroid/view/ViewPropertyAnimator;

    iget-object v1, p0, Ljaw;->j:Llcy;
    ...
    iget-object v1, p0, Ljaw;->h:Landroid/app/Activity;
    ...
    iget-object v1, p0, Ljaw;->o:Landroid/view/View;
...
.method public final g(J)V
    ...
    iget-object p2, p0, Ljaw;->d:Landroid/widget/TextView;
...
.method public final h(J)V
    ...
    iget-object p2, p0, Ljaw;->c:Landroid/widget/TextView;
...
.method public final i(Landroid/widget/LinearLayout;)V
    ...
    iput-object v0, p0, Ljaw;->l:Landroid/content/res/Resources;

    move-object v0, p1

    check-cast v0, Lcom/google/android/apps/camera/ui/elapsedtimeui/ElapsedTimerView;

    iput-object v0, p0, Ljaw;->b:Lcom/google/android/apps/camera/ui/elapsedtimeui/ElapsedTimerView;

    invoke-virtual {v0}, Lcom/google/android/apps/camera/ui/elapsedtimeui/ElapsedTimerView;->b()Landroid/widget/TextView;

    move-result-object v0

    iput-object v0, p0, Ljaw;->c:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Ljaw;->d:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Ljaw;->m:Landroid/view/View;
    ...
    iput-object v1, p0, Ljaw;->n:Landroid/view/ViewGroup;
    ...
    iput-object v0, p0, Ljaw;->o:Landroid/view/View;
    ...
    invoke-direct {v0, p0}, Ljat;-><init>(Ljaw;)V
...
.method public final j()V
    ...
    iget-object v4, p0, Ljaw;->c:Landroid/widget/TextView;
    ...
    invoke-direct {v5, p0}, Ljau;-><init>(Ljaw;)V

    const v6, 0x7f090006

    invoke-static {v4, v6, v5}, Lei;->e(Landroid/content/Context;ILeg;)V

    iget-object v4, p0, Ljaw;->l:Landroid/content/res/Resources;
    ...
    :cond_0
    iget-object v4, p0, Ljaw;->b:Lcom/google/android/apps/camera/ui/elapsedtimeui/ElapsedTimerView;
    ...
    iget-object v5, p0, Ljaw;->c:Landroid/widget/TextView;
    ...
    iget-object v0, p0, Ljaw;->k:Ljap;

    iget-boolean v4, v0, Ljap;->b:Z

    if-eqz v4, :cond_2

    iget-object v0, p0, Ljaw;->h:Landroid/app/Activity;
    ...
    iget-object v4, p0, Ljaw;->k:Ljap;

    iget-boolean v4, v4, Ljap;->c:Z
    ...
    iget-object v1, p0, Ljaw;->k:Ljap;

    iget-boolean v1, v1, Ljap;->a:Z
    ...
    invoke-virtual {p0}, Ljaw;->e()V

    return-void

    :cond_8
    iget-object v1, p0, Ljaw;->c:Landroid/widget/TextView;
    ...
    iget-object v2, p0, Ljaw;->c:Landroid/widget/TextView;

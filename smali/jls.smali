...
.field private final l:Ljme;


# direct methods
.method public constructor <init>(Ljme;Landroid/view/View;ILandroid/view/View;IIIIIZZZ)V
    .locals 11
    ...
    iput-object v4, v0, Ljls;->b:Ljava/util/List;
    ...
    iput-object v4, v0, Ljls;->h:Ljava/util/concurrent/atomic/AtomicBoolean;

    sget-object v4, Lisb;->j:Lisb;

    iput-object v4, v0, Ljls;->c:Ljava/lang/Runnable;

    iput-boolean v5, v0, Ljls;->j:Z
    ...
    invoke-direct {v6, v4, v7}, Ljml;-><init>(Landroid/content/Context;Z)V

    invoke-virtual {v6, v5}, Ljml;->setWillNotDraw(Z)V

    iget-object v7, v6, Ljml;->b:Landroid/graphics/Paint;

    const/4 v8, 0x1

    invoke-virtual {v6, v8, v7}, Ljml;->setLayerType(ILandroid/graphics/Paint;)V

    iget-object v7, v6, Ljml;->c:Landroid/graphics/Paint;

    invoke-virtual {v6, v8, v7}, Ljml;->setLayerType(ILandroid/graphics/Paint;)V

    new-instance v7, Ljmf;

    invoke-direct {v7, v6}, Ljmf;-><init>(Ljml;)V

    invoke-virtual {v6, v7}, Ljml;->setOnClickListener(Landroid/view/View$OnClickListener;)V
    ...
    iget-object v9, v6, Ljml;->v:Landroid/hardware/display/DisplayManager$DisplayListener;
    ...
    iget-object v4, v6, Ljml;->u:Ljava/util/List;

    new-instance v9, Ljmi;

    invoke-direct {v9, v7, v6}, Ljmi;-><init>(Landroid/hardware/display/DisplayManager;Ljml;)V

    invoke-interface {v4, v9}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    iput-object v6, v0, Ljls;->a:Ljml;

    iput-object v1, v6, Ljml;->i:Landroid/view/View;

    new-instance v4, Landroid/widget/PopupWindow;

    invoke-direct {v4, v6}, Landroid/widget/PopupWindow;-><init>(Landroid/view/View;)V

    iput-object v4, v6, Ljml;->f:Landroid/widget/PopupWindow;

    invoke-virtual {v6, p2}, Ljml;->addView(Landroid/view/View;)V

    invoke-static {p3}, Ljls;->s(I)Z
    ...
    :cond_4
    invoke-static {p3, p4}, Ljls;->r(ILandroid/view/View;)I
    ...
    iput-object v3, v0, Ljls;->e:Landroid/view/View;
    ...
    iput-boolean v1, v0, Ljls;->g:Z

    move-object v1, p1

    iput-object v1, v0, Ljls;->l:Ljme;

    iput-object v3, v6, Ljml;->k:Landroid/view/View;

    iget-object v1, v6, Ljml;->k:Landroid/view/View;

    if-eqz v1, :cond_b

    iget-object v2, v6, Ljml;->a:[I
    ...
    iput-object v7, v6, Ljml;->l:Landroid/graphics/Rect;
...
.method public final close()V
    ...
    iget-object v0, p0, Ljls;->c:Ljava/lang/Runnable;

    invoke-interface {v0}, Ljava/lang/Runnable;->run()V

    iget-object v0, p0, Ljls;->a:Ljml;

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Ljml;->b(Z)V
...
.method public final e()Ljava/util/Date;
    ...
    iget-object v0, p0, Ljls;->i:Ljava/util/Date;
...
.method public final g()V
    ...
    iget-object v0, p0, Ljls;->h:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final i(Ljava/util/Date;)V
    ...
    iput-object p1, p0, Ljls;->i:Ljava/util/Date;
...
.method public final j()V
    ...
    iget-object v1, p0, Ljls;->e:Landroid/view/View;

    invoke-virtual {v1, v0}, Landroid/view/View;->getGlobalVisibleRect(Landroid/graphics/Rect;)Z

    iget-object v1, p0, Ljls;->a:Ljml;

    iput-object v0, v1, Ljml;->l:Landroid/graphics/Rect;

    const/4 v0, 0x0

    invoke-virtual {v1, v0}, Ljml;->setVisibility(I)V

    iget-object v2, v1, Ljml;->f:Landroid/widget/PopupWindow;

    iget-object v3, v1, Ljml;->k:Landroid/view/View;
    ...
    invoke-direct {v5, v1}, Ljmh;-><init>(Ljml;)V
    ...
    invoke-direct {v5, v1, v2, v4}, Ljmj;-><init>(Ljml;Ljava/lang/ref/WeakReference;I)V

    invoke-virtual {v3, v5}, Landroid/view/View;->post(Ljava/lang/Runnable;)Z

    new-instance v5, Ljmj;

    invoke-direct {v5, v1, v2, v0}, Ljmj;-><init>(Ljml;Ljava/lang/ref/WeakReference;I)V

    iget-wide v0, v1, Ljml;->q:J
    ...
    iget-object v3, v2, Ljlr;->b:Ljava/util/concurrent/Executor;

    iget-object v2, v2, Ljlr;->a:Ljava/lang/Runnable;
    ...
    invoke-direct {v3, v1, v2}, Ljlq;-><init>(Ljml;Ljlr;)V

    iget-wide v5, v2, Ljlr;->c:J

    invoke-virtual {v1, v3, v5, v6}, Ljml;->postDelayed(Ljava/lang/Runnable;J)Z

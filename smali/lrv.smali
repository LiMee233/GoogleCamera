...
# direct methods
.method public constructor <init>(Llrx;ILandroid/media/MediaCodec$BufferInfo;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Llrv;->a:Llrx;

    iput p2, p0, Llrv;->b:I

    iput-object p3, p0, Llrv;->c:Landroid/media/MediaCodec$BufferInfo;
...
.method public final run()V
    ...
    iget-object v0, p0, Llrv;->a:Llrx;

    iget v1, p0, Llrv;->b:I

    iget-object v2, p0, Llrv;->c:Landroid/media/MediaCodec$BufferInfo;
    ...
    :cond_1
    iget-object v4, v0, Llsa;->p:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    iget-object v4, v0, Llsa;->q:Ljava/util/concurrent/atomic/AtomicLong;

    iget-wide v7, v2, Landroid/media/MediaCodec$BufferInfo;->presentationTimeUs:J

    long-to-double v7, v7

    iget-wide v9, v0, Llsa;->j:D
    ...
    iget-object v4, v0, Llsa;->n:Ljava/util/Deque;
    ...
    invoke-virtual {v9, v10}, Lojl;->c(Ljava/lang/Comparable;)Z

    move-result v10

    if-nez v10, :cond_6

    invoke-virtual {v9}, Lojl;->a()Z
    ...
    :cond_4
    iget-object v4, v0, Llsa;->g:Landroid/media/MediaCodec;
    ...
    iget-object v4, v0, Llsa;->m:Ljava/util/List;

    new-instance v8, Llsb;

    invoke-direct {v8, v2, v7}, Llsb;-><init>(Landroid/media/MediaCodec$BufferInfo;Ljava/nio/ByteBuffer;)V

    invoke-interface {v4, v8}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    iget-wide v7, v0, Llsa;->w:J
    ...
    iput-boolean v7, v0, Llsa;->r:Z

    iget-object v3, v0, Llsa;->k:Llsk;

    sget-object v4, Llsc;->c:Llsc;
    ...
    :cond_5
    invoke-virtual {v0, v2, v4}, Llsa;->a(Landroid/media/MediaCodec$BufferInfo;Ljava/nio/ByteBuffer;)V

    :cond_6
    :goto_2
    iget-object v3, v0, Llsa;->g:Landroid/media/MediaCodec;

    invoke-virtual {v3, v1, v6}, Landroid/media/MediaCodec;->releaseOutputBuffer(IZ)V

    invoke-virtual {v0, v2}, Llsa;->a(Landroid/media/MediaCodec$BufferInfo;)V

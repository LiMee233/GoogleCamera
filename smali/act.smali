...
.method public constructor <init>(Lhld;[B)V
    .locals 2
    ...
    invoke-direct {v0, p1, p2}, Lacj;-><init>(Lhld;[B)V
...
.method final d(F)V
    ...
    iget-object v0, v0, Ljfv;->c:Lcom/google/android/apps/camera/ui/modeswitcher/ModeSwitcher;

    iget-object v1, v0, Lcom/google/android/apps/camera/ui/modeswitcher/ModeSwitcher;->c:Ljfq;

    invoke-virtual {v0}, Lcom/google/android/apps/camera/ui/modeswitcher/ModeSwitcher;->b()Ljrj;

    move-result-object v0

    iget-object v2, v1, Ljfq;->h:Landroid/widget/TextView;

    iget-object v3, v1, Ljfq;->b:Lolo;

    invoke-interface {v3, v0}, Lolo;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v3

    if-eq v2, v3, :cond_0

    invoke-virtual {v1, v0}, Ljfq;->d(Ljrj;)V

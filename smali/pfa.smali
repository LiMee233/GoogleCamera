...
.method public constructor <init>(I)V
    ...
    iput-object p1, p0, Lpfa;->a:Ljava/util/List;

    invoke-static {}, Ljava/util/Collections;->emptyMap()Ljava/util/Map;

    move-result-object p1

    iput-object p1, p0, Lpfa;->b:Ljava/util/Map;

    invoke-static {}, Ljava/util/Collections;->emptyMap()Ljava/util/Map;

    move-result-object p1

    iput-object p1, p0, Lpfa;->d:Ljava/util/Map;
...
.method private final a(Ljava/lang/Comparable;)I
    ...
    iget-object v0, p0, Lpfa;->a:Ljava/util/List;
    ...
    iget-object v2, p0, Lpfa;->a:Ljava/util/List;
    ...
    iget-object v2, v2, Lpex;->a:Ljava/lang/Comparable;
    ...
    iget-object v3, p0, Lpfa;->a:Ljava/util/List;
    ...
    iget-object v3, v3, Lpex;->a:Ljava/lang/Comparable;
...
.method static a(I)Lpfa;
    .locals 1

    new-instance v0, Lpfa;

    invoke-direct {v0, p0}, Lpfa;-><init>(I)V
...
.method private final d()Ljava/util/SortedMap;
    ...
    iget-object v0, p0, Lpfa;->b:Ljava/util/Map;
    ...
    iput-object v0, p0, Lpfa;->b:Ljava/util/Map;
    ...
    iput-object v0, p0, Lpfa;->d:Ljava/util/Map;
...
.method public final a(Ljava/lang/Comparable;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p0, p1}, Lpfa;->a(Ljava/lang/Comparable;)I

    move-result v0

    if-ltz v0, :cond_0

    iget-object p1, p0, Lpfa;->a:Ljava/util/List;
    ...
    invoke-virtual {p1, p2}, Lpex;->setValue(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v1, p0, Lpfa;->a:Ljava/util/List;
    ...
    iput-object v1, p0, Lpfa;->a:Ljava/util/List;
    ...
    invoke-direct {p0}, Lpfa;->d()Ljava/util/SortedMap;

    move-result-object v2

    iget-object v3, v1, Lpex;->a:Ljava/lang/Comparable;

    iget-object v1, v1, Lpex;->b:Ljava/lang/Object;
    ...
    invoke-direct {v2, p0, p1, p2}, Lpex;-><init>(Lpfa;Ljava/lang/Comparable;Ljava/lang/Object;)V
...
.method public final b()Ljava/lang/Iterable;
    ...
    :cond_0
    sget-object v0, Lpew;->b:Ljava/lang/Iterable;
...
.method public final c(I)Ljava/lang/Object;
    ...
    iget-object p1, p1, Lpex;->b:Ljava/lang/Object;
    ...
    invoke-direct {v2, p0, v3}, Lpex;-><init>(Lpfa;Ljava/util/Map$Entry;)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0}, Lpfa;->a()I

    move-result v2

    invoke-virtual {p1}, Lpfa;->a()I
    ...
    invoke-virtual {p0, v4}, Lpfa;->b(I)Ljava/util/Map$Entry;

    move-result-object v5

    invoke-virtual {p1, v4}, Lpfa;->b(I)Ljava/util/Map$Entry;
    ...
    iget-object p1, p1, Lpfa;->b:Ljava/util/Map;
    ...
    :cond_4
    invoke-virtual {p0}, Lpfa;->entrySet()Ljava/util/Set;

    move-result-object v0

    invoke-virtual {p1}, Lpfa;->entrySet()Ljava/util/Set;
...
.method public final hashCode()I
    ...
    invoke-virtual {v3}, Lpex;->hashCode()I
...
.method public final bridge synthetic put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lpfa;->a(Ljava/lang/Comparable;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final remove(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_1
    invoke-virtual {p0, v0}, Lpfa;->c(I)Ljava/lang/Object;
...
.method public final size()I
    ...
    iget-object v1, p0, Lpfa;->b:Ljava/util/Map;

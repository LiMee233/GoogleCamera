...
.method public constructor <init>(Landroid/os/PowerManager;Ljava/util/concurrent/Executor;)V
    ...
    iput-object p1, p0, Limm;->b:Landroid/os/PowerManager;

    iput-object p2, p0, Limm;->e:Ljava/util/concurrent/Executor;
...
.method final declared-synchronized a(Landroid/os/PowerManager$OnThermalStatusChangedListener;)V
    ...
    iget-object v1, p0, Limm;->e:Ljava/util/concurrent/Executor;

    new-instance v2, Liml;

    invoke-direct {v2, p0, p1, v0}, Liml;-><init>(Limm;Landroid/os/PowerManager$OnThermalStatusChangedListener;I)V

...
.method public constructor <init>(Lbm;Lbv;Ljava/lang/String;Ljava/lang/String;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Law;->a:Lbm;

    iput-object p2, p0, Law;->b:Lbv;
...
.method public final a(Lav;II)V
    .locals 10

    iget-object v0, p0, Law;->a:Lbm;

    if-eqz v0, :cond_11

    iget-object v0, v0, Lbm;->c:Lbt;
    ...
    :cond_3
    :goto_0
    iget-object v5, v0, Lbt;->a:Ljava/util/HashMap;
    ...
    invoke-interface {p1, p3}, Lav;->b(Ljava/lang/String;)Landroid/database/Cursor;
    ...
    :cond_f
    iget-object p2, p0, Law;->b:Lbv;

    invoke-virtual {p2, p1}, Lbv;->b(Lav;)Lbw;

    move-result-object p2

    iget-boolean p3, p2, Lbw;->a:Z

    if-eqz p3, :cond_10

    invoke-virtual {p0, p1}, Law;->a(Lav;)V
    ...
    invoke-interface {p1, p2}, Lav;->c(Ljava/lang/String;)V
    ...
    invoke-virtual {p2, p1}, Lbv;->a(Lav;)V

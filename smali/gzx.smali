...
.method public final a(Llmp;)V
    ...
    :try_start_2
    iget-object v1, v0, Lgzy;->h:Lebd;

    invoke-interface {v1, v7}, Lebd;->a(Llzs;)I
    ...
    :try_start_3
    iget-object v2, v0, Lgzy;->h:Lebd;

    invoke-interface {v2, v1}, Lebd;->m(I)Lcom/google/googlex/gcam/PhysicalStabilityParams;
    ...
    iget-object v3, v0, Lgzy;->h:Lebd;

    invoke-interface {v3, v1}, Lebd;->m(I)Lcom/google/googlex/gcam/PhysicalStabilityParams;
    ...
    invoke-direct {v4, v5, v3, v6}, Lhnk;-><init>(Landroid/util/Range;Lj$/time/Duration;Lj$/time/Duration;)V

    iput-object v4, v0, Lgzy;->l:Lhnk;

    :cond_2
    iget-object v3, v0, Lgzy;->m:Lhnk;
    ...
    invoke-direct {v3, v5, v2, v6}, Lhnk;-><init>(Landroid/util/Range;Lj$/time/Duration;Lj$/time/Duration;)V

    iput-object v3, v0, Lgzy;->m:Lhnk;

    :cond_3
    iget-object v2, v0, Lgzy;->h:Lebd;

    invoke-interface {v2, v1}, Lebd;->n(I)Lcom/google/googlex/gcam/ViewfinderResults;
    ...
    iget-object v3, v0, Lgzy;->l:Lhnk;

    if-eqz v3, :cond_4

    invoke-virtual {v3, v2, v5, v6}, Lhnk;->a(FJ)V
    ...
    invoke-virtual {v5, v2, v3}, Lhnk;->c(J)Z
    ...
    :cond_6
    iget-object v5, v0, Lgzy;->h:Lebd;

    invoke-interface {v5, v1}, Lebd;->n(I)Lcom/google/googlex/gcam/ViewfinderResults;
    ...
    :cond_7
    iget-object v4, v0, Lgzy;->h:Lebd;

    invoke-interface {v4, v1}, Lebd;->m(I)Lcom/google/googlex/gcam/PhysicalStabilityParams;
    ...
    :goto_1
    iget-object v1, v0, Lgzy;->l:Lhnk;

    if-eqz v1, :cond_9

    invoke-virtual {v1, v2, v3}, Lhnk;->c(J)Z
    ...
    iget-object v1, v0, Lgzy;->g:Leal;

    iget-object v2, v0, Lgzy;->i:Llvn;
    ...
    invoke-virtual/range {v1 .. v6}, Leal;->g(Llzs;ZZLlwb;Z)V

    iget-object v1, v0, Lgzy;->f:Lbta;

    invoke-virtual {v1, v7}, Lbta;->a(Llzs;)V

    sget-object v1, Landroid/hardware/camera2/CaptureResult;->SENSOR_EXPOSURE_TIME:Landroid/hardware/camera2/CaptureResult$Key;

    invoke-interface {v7, v1}, Llzs;->d(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    :cond_c
    iget-object v0, v0, Lgzy;->o:Lflg;

    iget-object v0, v0, Lflg;->a:Lpjz;
    ...
    iget-object v2, v0, Lpjz;->d:Ljava/lang/Object;
    ...
    :cond_e
    iget-object v3, v0, Lpjz;->g:Ljava/util/concurrent/Future;
    ...
    :goto_4
    iget-object v4, v0, Lpjz;->h:Ljava/util/concurrent/Future;
    ...
    :cond_11
    iget-object v3, v0, Lpjz;->e:Ljava/util/concurrent/ExecutorService;

    new-instance v4, Lpjy;

    invoke-direct {v4, v0, v1, v7}, Lpjy;-><init>(Lpjz;Lmaa;Llzs;)V

    invoke-interface {v3, v4}, Ljava/util/concurrent/ExecutorService;->submit(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/Future;

    move-result-object v1

    iput-object v1, v0, Lpjz;->g:Ljava/util/concurrent/Future;
    ...
    invoke-interface {v0, v2, v1}, Lliq;->i(Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_5

...
.method public constructor <init>(Lqkb;)V
    ...
    iput-object v0, p0, Lgtr;->c:Landroid/util/SparseArray;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, p0, Lgtr;->d:Landroid/util/SparseArray;

    iput-object p1, p0, Lgtr;->a:Lqkb;
...
.method private final m()Z
    ...
    iget-object v0, p0, Lgtr;->c:Landroid/util/SparseArray;
...
.method public final a()V
    ...
    iget-object v0, p0, Lgtr;->b:Lcom/google/android/apps/camera/optionsbar/common/LinearMinibarImpl;
...
.method public final h(Lhte;)V
    .locals 1

    sget-object v0, Lhte;->a:Lhte;

    invoke-virtual {v0, p1}, Lhte;->equals(Ljava/lang/Object;)Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object p1, p0, Lgtr;->b:Lcom/google/android/apps/camera/optionsbar/common/LinearMinibarImpl;

    sget-object v0, Lhte;->a:Lhte;

    invoke-virtual {p1, v0}, Lcom/google/android/apps/camera/optionsbar/common/LinearMinibarImpl;->l(Lhte;)V

    invoke-virtual {p0}, Lgtr;->f()V
    ...
    invoke-virtual {v0, p1}, Lcom/google/android/apps/camera/optionsbar/common/LinearMinibarImpl;->l(Lhte;)V
...
.method public final j(Lhtg;Ljava/lang/String;)V
    .locals 4

    iget-object v0, p0, Lgtr;->a:Lqkb;

    invoke-interface {v0}, Lqkb;->get()Ljava/lang/Object;

    move-result-object v0

    invoke-interface {v0}, Lgts;->H()Z
...
.method public final k()V
    ...
    iget-object v3, p0, Lgtr;->a:Lqkb;

    invoke-interface {v3}, Lqkb;->get()Ljava/lang/Object;

    move-result-object v3

    invoke-interface {v3}, Lgts;->G()Z

    move-result v3

    if-eqz v3, :cond_0

    iget-object v3, p0, Lgtr;->b:Lcom/google/android/apps/camera/optionsbar/common/LinearMinibarImpl;
    ...
    :goto_0
    iget-object v4, p0, Lgtr;->b:Lcom/google/android/apps/camera/optionsbar/common/LinearMinibarImpl;
...
.method public final l(Ljava/lang/String;Z)V
    ...
    iget-object v0, p0, Lgtr;->d:Landroid/util/SparseArray;
    ...
    invoke-direct {p0}, Lgtr;->m()Z

    move-result p1

    if-nez p1, :cond_5

    iget-object p1, p0, Lgtr;->c:Landroid/util/SparseArray;
    ...
    sget-object p1, Lgtq;->b:Lgtq;

    :goto_1
    iget-object p2, p0, Lgtr;->c:Landroid/util/SparseArray;
    ...
    sget-object p2, Lgtq;->a:Lgtq;

    invoke-virtual {p1}, Lgtq;->ordinal()I

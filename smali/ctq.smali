...
.method public final b(Landroid/view/View;Z)V
    ...
    iget-object v1, v0, Lcts;->h:Ljfl;

    invoke-interface {v1, v3}, Ljfl;->l(Z)V

    iget-object v1, v0, Lcts;->i:Ljkz;

    invoke-interface {v1, v3}, Ljkz;->F(Z)V

    iget-object v0, v0, Lcts;->f:Lepi;
    ...
    iget-object v0, v0, Lctr;->b:Loln;

    invoke-static {p2}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v1

    invoke-virtual {v0, v1}, Loln;->d(Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-static {v4, v5}, Ljrx;->a(Landroid/view/Display;Landroid/content/Context;)Ljrx;
    ...
    invoke-direct {v4, v0}, Ljlx;-><init>(Ljava/lang/String;)V

    invoke-virtual {v4, p1, v5}, Ljlx;->h(Landroid/view/View;I)V

    invoke-interface {v4}, Ljly;->k()V
    ...
    invoke-virtual {v4, p1, v5}, Ljlx;->l(Landroid/view/View;I)V

    invoke-interface {v4}, Ljly;->j()V
    ...
    invoke-virtual {v4, p1}, Ljlx;->s(Landroid/view/View;)V

    invoke-interface {v4}, Ljly;->i()V

    :goto_2
    iget-object p1, v1, Lcts;->d:Ldde;
    ...
    iput-boolean p1, v4, Ljlx;->h:Z

    invoke-interface {v4}, Ljlz;->n()V

    invoke-interface {v4}, Ljma;->o()V

    iput-boolean v3, v4, Ljlx;->f:Z
    ...
    iget-object p2, v1, Lcts;->g:Llap;

    invoke-interface {v4, p1, p2}, Ljma;->f(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V

    iput-boolean v2, v4, Ljlx;->e:Z

    iget-object p1, v1, Lcts;->e:Lelv;

    iput-object p1, v4, Ljlx;->i:Lelv;

    invoke-interface {v4}, Ljma;->a()Llic;

    move-result-object p1

    iput-object p1, v1, Lcts;->k:Llic;

...
# direct methods
.method public constructor <init>(Ldde;Leac;Lqkb;Ldeh;Llzf;)V
    .locals 7
    ...
    :goto_0
    iget-boolean p5, p5, Llzf;->a:Z

    new-instance v6, Lcom/google/googlex/gcam/InitParams;

    invoke-direct {v6}, Lcom/google/googlex/gcam/InitParams;-><init>()V

    sget-object v0, Lddl;->d:Lddh;

    const/4 v1, 0x0

    invoke-static {p1, v0, v1}, Lebz;->a(Ldde;Lddh;Ljava/lang/Integer;)Lcom/google/googlex/gcam/ThreadPoolConfig;
    ...
    invoke-virtual {p2}, Leac;->b()Z

    move-result p1

    if-eqz p1, :cond_3

    sget p1, Lsgcam/Shamim;->Hexagon:I
...
.method private static a(Ldde;Lddh;Ljava/lang/Integer;)Lcom/google/googlex/gcam/ThreadPoolConfig;
    .locals 8

    invoke-interface {p0, p1}, Ldde;->a(Lddh;)Loix;

...
.method public constructor <init>(Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;ZZZLandroid/view/View;)V
    ...
    iput-object p1, p0, Lgty;->d:Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;
    ...
    iput-object v0, p0, Lgty;->e:Landroid/widget/FrameLayout;
    ...
    iput-object v0, p0, Lgty;->a:Landroid/view/View;
    ...
    iput-object v0, p0, Lgty;->f:Looz;

    iget-object p1, p1, Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;->b:Ljrx;

    iput-object p1, p0, Lgty;->g:Ljrx;

    iput-boolean p2, p0, Lgty;->b:Z

    iput-boolean p3, p0, Lgty;->h:Z

    iput-boolean p4, p0, Lgty;->i:Z

    iput-object p5, p0, Lgty;->k:Landroid/view/View;
...
.method public final a()Landroid/animation/Animator;
    ...
    :goto_0
    iget-object v7, p0, Lgty;->e:Landroid/widget/FrameLayout;
    ...
    new-instance v7, Ljrz;

    iget-object v8, p0, Lgty;->e:Landroid/widget/FrameLayout;

    iget v9, p0, Lgty;->j:I

    invoke-direct {v7, v8, v9}, Ljrz;-><init>(Landroid/view/View;I)V
    ...
    iget-object v1, p0, Lgty;->k:Landroid/view/View;

    invoke-static {v1}, Ljry;->e(Landroid/view/View;)[I

    move-result-object v1

    aget v1, v1, v6

    iget-object v7, p0, Lgty;->a:Landroid/view/View;

    invoke-static {v7}, Ljry;->e(Landroid/view/View;)[I
    ...
    iget-object v7, p0, Lgty;->k:Landroid/view/View;

    invoke-virtual {v7}, Landroid/view/View;->getHeight()I

    move-result v7

    iget-object v8, p0, Lgty;->a:Landroid/view/View;
    ...
    iget-object v3, p0, Lgty;->a:Landroid/view/View;

    iget v4, p0, Lgty;->c:I

    invoke-direct {v2, v3, v4}, Ljrz;-><init>(Landroid/view/View;I)V

    invoke-virtual {v1, v2}, Landroid/animation/ObjectAnimator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    iget-boolean v2, p0, Lgty;->h:Z

    if-nez v2, :cond_3

    new-instance v2, Ljrs;

    iget-object v3, p0, Lgty;->d:Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuContainer;

    invoke-direct {v2, v3}, Ljrs;-><init>(Landroid/view/View;)V
    ...
    invoke-direct {v2, p0, v5}, Lgtw;-><init>(Lgty;I)V
    ...
    invoke-direct {v3, p0}, Lgtx;-><init>(Lgty;)V
    ...
    invoke-static {v0}, Lohc;->z(Ljava/util/List;)Ljava/util/List;
    ...
    iget-boolean v0, p0, Lgty;->b:Z

    if-eqz v0, :cond_6

    new-instance v0, Lgtw;

    invoke-direct {v0, p0, v6}, Lgtw;-><init>(Lgty;I)V

    invoke-static {v0}, Lmin;->ew(Lj$/util/function/Consumer;)Landroid/animation/Animator$AnimatorListener;

...
.method public constructor <init>(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)V
    ...
    iput-object p1, p0, Llzk;->a:Landroid/hardware/camera2/CaptureRequest$Key;

    const-string p1, "Parameter values cannot be null."

    invoke-static {p2, p1}, Luu;->a(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p1

    iput-object p1, p0, Llzk;->b:Ljava/lang/Object;
...
.method public final a()Ljava/lang/String;
    ...
    iget-object v0, p0, Llzk;->a:Landroid/hardware/camera2/CaptureRequest$Key;
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    instance-of v2, p1, Llzk;

    if-eqz v2, :cond_0

    check-cast p1, Llzk;

    iget-object v2, p0, Llzk;->a:Landroid/hardware/camera2/CaptureRequest$Key;

    invoke-virtual {v2}, Landroid/hardware/camera2/CaptureRequest$Key;->getName()Ljava/lang/String;

    move-result-object v2

    iget-object v3, p1, Llzk;->a:Landroid/hardware/camera2/CaptureRequest$Key;

    invoke-virtual {v3}, Landroid/hardware/camera2/CaptureRequest$Key;->getName()Ljava/lang/String;

    move-result-object v3

    invoke-static {v2, v3}, Luu;->c(Ljava/lang/Object;Ljava/lang/Object;)Z

    move-result v2

    if-eqz v2, :cond_0

    iget-object v2, p0, Llzk;->b:Ljava/lang/Object;
...
.method public final hashCode()I
    ...
    iget-object v1, p0, Llzk;->a:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    iget-object v1, p0, Llzk;->b:Ljava/lang/Object;

...
# direct methods
.method public constructor <init>(Liuq;Lhui;Landroid/util/DisplayMetrics;Landroid/content/Context;Ldde;)V
    .locals 1
    ...
    iput-object v0, p0, Lfvm;->g:Landroid/view/View;

    iput-object v0, p0, Lfvm;->d:Landroid/view/View;

    iput-object p1, p0, Lfvm;->a:Liuq;

    iput-object p2, p0, Lfvm;->e:Lhui;

    iput-object p4, p0, Lfvm;->b:Landroid/content/Context;

    iput-object p3, p0, Lfvm;->f:Landroid/util/DisplayMetrics;

    iput-object p5, p0, Lfvm;->c:Ldde;
...
.method public final a()V
    ...
    iget-object v0, p0, Lfvm;->g:Landroid/view/View;

    if-nez v0, :cond_3

    new-instance v0, Landroid/widget/FrameLayout;

    iget-object v1, p0, Lfvm;->b:Landroid/content/Context;
    ...
    invoke-direct {v2, p0, v3}, Lfvl;-><init>(Lfvm;I)V
    ...
    iget-object v4, p0, Lfvm;->f:Landroid/util/DisplayMetrics;
    ...
    iget-object v5, p0, Lfvm;->f:Landroid/util/DisplayMetrics;
    ...
    iget-object v3, p0, Lfvm;->b:Landroid/content/Context;
    ...
    :cond_3
    iget-object v0, p0, Lfvm;->a:Liuq;

    const/4 v1, 0x7

    const v2, 0x7f1402e4

    iget-object v3, p0, Lfvm;->g:Landroid/view/View;

    invoke-virtual {v0, v1, v2, v3}, Liuq;->f(IILandroid/view/View;)V

    iget-object v0, p0, Lfvm;->e:Lhui;

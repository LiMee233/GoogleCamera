...
.method public final run()V
    ...
    invoke-virtual {v2}, Landroidx/work/ListenableWorker;->a()Lpho;

    move-result-object v2

    new-instance v5, Lasq;

    invoke-direct {v5, v0, v2}, Lasq;-><init>(Landroidx/work/impl/workers/ConstraintTrackingWorker;Lpho;)V

    invoke-virtual {v0}, Landroidx/work/ListenableWorker;->g()Ljava/util/concurrent/Executor;

    move-result-object v6

    invoke-interface {v2, v5, v6}, Lpho;->d(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V
    :try_end_0
    ...
    invoke-virtual {v5, v1}, Lkuq;->h([Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v2, v1}, Lkuq;->h([Ljava/lang/Throwable;)V
    ...
    invoke-static {v1, v2, v3}, Lkuq;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V

...
.method public final run()V
    ...
    iget-object v1, v0, Lbfj;->a:Lbfk;

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtime()J

    move-result-wide v2

    iget-wide v4, v1, Lbfk;->e:J
    ...
    iput-wide v2, v1, Lbfk;->e:J

    iget-object v2, v1, Lbfk;->b:Leru;

    invoke-interface {v2}, Leru;->k()V

    iget-object v2, v1, Lbfk;->a:Lbfc;

    invoke-interface {v2}, Lbfc;->a()Landroid/content/Intent;
    ...
    invoke-static {v2}, Lbfd;->e(Landroid/content/Intent;)Z
    ...
    iget-object v3, v1, Lbfk;->d:Liji;

    invoke-interface {v3}, Liji;->b()Z
    ...
    :cond_10
    invoke-static {v2}, Lbfd;->f(Landroid/content/Intent;)Ljys;
    ...
    invoke-virtual {v3, v5}, Ljys;->equals(Ljava/lang/Object;)Z

    move-result v3

    if-eqz v3, :cond_12

    invoke-static {v2}, Lbfd;->k(Landroid/content/Intent;)Z
    ...
    :goto_a
    iget-object v2, v1, Lbfk;->c:Ldvf;

    invoke-virtual {v2}, Ldvf;->b()Landroid/app/KeyguardManager;

    move-result-object v2

    iget-object v14, v1, Lbfk;->b:Leru;
    ...
    iget-object v1, v1, Lbfk;->d:Liji;

    invoke-interface {v1}, Liji;->b()Z

    move-result v20

    invoke-interface/range {v14 .. v20}, Leru;->a(IIIZZZ)V

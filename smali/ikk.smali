...
.method private final f(Ljava/lang/String;Ljava/lang/String;Landroid/content/DialogInterface$OnClickListener;)Lid;
    ...
    iget-object v1, p0, Likk;->a:Landroid/content/Context;

    iget v2, p0, Likk;->b:I

    invoke-direct {v0, v1, v2}, Lnye;-><init>(Landroid/content/Context;I)V

    invoke-virtual {v0, p1}, Lnye;->t(Ljava/lang/CharSequence;)V

    invoke-virtual {v0, p2}, Lnye;->m(Ljava/lang/CharSequence;)V

    iget-object p1, p0, Likk;->a:Landroid/content/Context;
    ...
    invoke-direct {p2, p0}, Likj;-><init>(Likk;)V

    invoke-virtual {v0, p1, p2}, Lnye;->r(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)V
    ...
    invoke-virtual {v0, p1, p3}, Lnye;->o(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)V
...
.method public final a(Ljava/lang/String;Ljava/lang/String;Landroid/content/DialogInterface$OnClickListener;)Lid;
    ...
    invoke-virtual {v0, p1, p3}, Lnye;->r(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)V
...
.method public final b(Landroid/content/DialogInterface$OnClickListener;)Lie;
    ...
    iget-object v0, p0, Likk;->a:Landroid/content/Context;
    ...
    invoke-direct {p0, v0, v1, p1}, Likk;->f(Ljava/lang/String;Ljava/lang/String;Landroid/content/DialogInterface$OnClickListener;)Lid;

    move-result-object p1

    invoke-static {p1}, Likk;->e(Lid;)Lie;

...
.method static constructor <clinit>()V
    ...
    sget-object v1, Lkda;->r:Landroid/hardware/camera2/CaptureRequest$Key;
...
.method public constructor <init>(Ldde;Lpkm;Llvn;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lgzu;->d:Ldde;

    iput-object p2, p0, Lgzu;->e:Lpkm;
...
.method public final b(Llpa;Lcom/google/googlex/gcam/FrameRequestVector;Llzs;I)Ljava/util/List;
    .locals 18
    ...
    invoke-direct {v10, v11}, Lgzs;-><init>(Llpa;)V

    iget-object v12, v0, Lgzu;->e:Lpkm;

    invoke-virtual {v12, v4, v2, v10}, Lpkm;->u(Lcom/google/googlex/gcam/FrameRequest;Llzs;Lgzs;)V

    invoke-static/range {p1 .. p1}, Llpa;->a(Llpa;)Llpa;
    ...
    invoke-direct {v13, v4, v8}, Lhcb;-><init>(Llpb;Lcom/google/googlex/gcam/FrameRequest;)V
    ...
    :cond_2
    iget-object v5, v0, Lgzu;->e:Lpkm;

    invoke-virtual {v5, v8, v2, v10}, Lpkm;->u(Lcom/google/googlex/gcam/FrameRequest;Llzs;Lgzs;)V
    ...
    invoke-direct {v14, v13, v15}, Lhcb;-><init>(Llpb;Lcom/google/googlex/gcam/FrameRequest;)V
...
.method public final c(Llpa;Lgod;Llqb;IIZ)V
    .locals 0

    invoke-virtual {p1, p3}, Llpa;->f(Llqb;)V

    add-int/2addr p4, p5

    invoke-interface {p2, p4}, Lgod;->e(I)V

    new-instance p3, Lgzt;

    invoke-direct {p3, p2}, Lgzt;-><init>(Lgod;)V

    invoke-virtual {p1, p3}, Llpa;->g(Lmin;)V
    ...
    invoke-virtual {p1, p2, p3}, Llpa;->d(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)V

    sget-object p2, Lkcw;->a:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    invoke-virtual {p1, p2, p4}, Llpa;->d(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)V

    :cond_0
    if-nez p6, :cond_1

    iget-object p2, p0, Lgzu;->d:Ldde;

    invoke-static {p2, p1}, Lenk;->x(Ldde;Llpa;)V

    :cond_1
    sget-object p2, Lkcz;->p:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    sget-object p2, Lkda;->r:Landroid/hardware/camera2/CaptureRequest$Key;

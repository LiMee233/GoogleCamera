...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lkpq;->d:Z

    sput-boolean v0, Lkpq;->b:Z

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lkpq;->c:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lkpq;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static a(Landroid/content/Context;I)I
    ...
    sget-object v0, Lkpq;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    sget-object v0, Lkvj;->a:Ljava/lang/Object;

    monitor-enter v0

    :try_start_1
    sget-boolean v2, Lkvj;->b:Z

    if-nez v2, :cond_1

    sput-boolean v1, Lkvj;->b:Z
    ...
    :try_start_2
    invoke-virtual {v3, v2, v4}, Lkwp;->a(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    ...
    :cond_4
    :goto_3
    invoke-static {p0}, Lkwh;->b(Landroid/content/Context;)V

    sget-object v0, Lkwh;->a:Ljava/lang/Boolean;
    ...
    sput-object v0, Lkwh;->a:Ljava/lang/Boolean;
    ...
    invoke-static {p0}, Lkpr;->a(Landroid/content/Context;)Lkpr;

    invoke-static {v6, v1}, Lkpr;->a(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {v5, v1}, Lkpr;->a(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {p0}, Lkwh;->a(I)I

    move-result p0

    invoke-static {p1}, Lkwh;->a(I)I
...
.method public static a(I)Ljava/lang/String;
    ...
    invoke-static {p0}, Lkox;->a(I)Ljava/lang/String;
...
.method public static a(Landroid/content/Context;)Z
    ...
    invoke-virtual {v0, v3, v4}, Lkwp;->b(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    invoke-static {v0, v1}, Lkpr;->a(Landroid/content/pm/PackageInfo;Z)Z

    move-result p0

    if-nez p0, :cond_0

    invoke-static {v0, v2}, Lkpr;->a(Landroid/content/pm/PackageInfo;Z)Z

    move-result p0

    if-eqz p0, :cond_0

    sput-boolean v2, Lkpq;->d:Z

    goto :goto_0

    :cond_0
    sput-boolean v1, Lkpq;->d:Z
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :goto_0
    sput-boolean v2, Lkpq;->b:Z
...
.method public static b(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1}, Lkpq;->a(Landroid/content/Context;Ljava/lang/String;)Z

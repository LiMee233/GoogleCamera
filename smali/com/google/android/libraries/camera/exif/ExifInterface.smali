...
.method public constructor <init>()V
    ...
    invoke-direct {v0, v1}, Lllw;-><init>(Ljava/nio/ByteOrder;)V

    iput-object v0, p0, Lcom/google/android/libraries/camera/exif/ExifInterface;->bB:Lllw;
...
.method public static w(D)[Llib;
    ...
    invoke-direct {v8, v9, v10, v11, v12}, Llib;-><init>(JJ)V
    ...
    invoke-direct {v0, v8, v9, v11, v12}, Llib;-><init>(JJ)V
    ...
    invoke-direct {v0, p0, p1, v1, v2}, Llib;-><init>(JJ)V
...
.method private static final z(J)Ljava/lang/String;
    ...
    invoke-static {p0, p1}, Lobm;->ai(Ljava/lang/String;I)Ljava/lang/String;
...
.method public final a(I)Llib;
    ...
    invoke-virtual {p0, p1, v0}, Lcom/google/android/libraries/camera/exif/ExifInterface;->v(II)[Llib;
    ...
    invoke-direct {v0, p1}, Llib;-><init>(Llib;)V
...
.method public final b(I)Ljava/lang/Integer;
    ...
    invoke-virtual {p0, p1, v0}, Lcom/google/android/libraries/camera/exif/ExifInterface;->l(II)Llme;
...
.method public final i(ILjava/lang/Object;)Llme;
    .locals 9
    ...
    invoke-direct/range {v0 .. v5}, Llme;-><init>(SSIIZ)V
    ...
    invoke-virtual {v8, p1}, Llme;->h(I)Z
    ...
    invoke-virtual {v8, p2}, Llme;->i(Ljava/lang/String;)Z
    ...
    invoke-virtual {v8, p2}, Llme;->k([I)Z
    ...
    invoke-virtual {v8, p2}, Llme;->l([J)Z
    ...
    :cond_5
    instance-of p1, p2, Llib;

    if-eqz p1, :cond_6

    check-cast p2, Llib;

    new-array p1, v6, [Llib;

    aput-object p2, p1, v7

    invoke-virtual {v8, p1}, Llme;->m([Llib;)Z
    ...
    invoke-virtual {v8, p2}, Llme;->m([Llib;)Z
    ...
    invoke-virtual {v8, p2}, Llme;->j([B)Z
    ...
    invoke-virtual {v8, v0}, Llme;->l([J)Z
    ...
    :cond_d
    invoke-virtual {v8, p1}, Llme;->k([I)Z
    ...
    :cond_13
    invoke-virtual {v8, p1}, Llme;->l([J)Z
    ...
    :cond_16
    invoke-virtual {v8, p1}, Llme;->j([B)Z
...
.method public final l(II)Llme;
    .locals 2

    invoke-static {p2}, Llme;->f(I)Z
    ...
    iget-object v0, p0, Lcom/google/android/libraries/camera/exif/ExifInterface;->bB:Lllw;

    iget-object v0, v0, Lllw;->a:[Llmh;
    ...
    :cond_1
    invoke-virtual {p2, p1}, Llmh;->b(S)Llme;
...
.method public final m(Ljava/io/OutputStream;)Ljava/io/OutputStream;
    ...
    iget-object p1, p0, Lcom/google/android/libraries/camera/exif/ExifInterface;->bB:Lllw;

    invoke-direct {v1, v2, p0, p1}, Llmf;-><init>(Ljava/io/OutputStream;Lcom/google/android/libraries/camera/exif/ExifInterface;Lllw;)V

    invoke-direct {v0, v1}, Llml;-><init>(Llmk;)V
...
.method public final p(I)V
    ...
    iget-object v1, p0, Lcom/google/android/libraries/camera/exif/ExifInterface;->bB:Lllw;

    invoke-static {p1}, Lcom/google/android/libraries/camera/exif/ExifInterface;->n(I)S

    move-result p1

    invoke-virtual {v1, p1, v0}, Lllw;->h(SI)Z
...
.method public final q(Ljava/io/InputStream;)V
    ...
    invoke-direct {v0, p1, p0}, Llmd;-><init>(Ljava/io/InputStream;Lcom/google/android/libraries/camera/exif/ExifInterface;)V

    new-instance p1, Lllw;

    iget-object v1, v0, Llmd;->a:Lllv;

    iget-object v1, v1, Lllv;->b:Ljava/nio/ByteBuffer;

    invoke-virtual {v1}, Ljava/nio/ByteBuffer;->order()Ljava/nio/ByteOrder;

    move-result-object v1

    invoke-direct {p1, v1}, Lllw;-><init>(Ljava/nio/ByteOrder;)V

    invoke-virtual {v0}, Llmd;->a()I

    move-result v1
    :try_end_0
    .catch Llly; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :try_start_1
    iget-object v1, v0, Llmd;->e:Llme;

    goto/16 :goto_2

    :pswitch_0
    iget-object v1, v0, Llmd;->f:Llme;
    ...
    invoke-virtual {v1, v3}, Llme;->b(I)J
    ...
    invoke-virtual {v0, v1}, Llmd;->b([B)I

    move-result v4

    if-ne v3, v4, :cond_1

    iput-object v1, p1, Lllw;->b:[B
    ...
    :pswitch_1
    iget-object v1, v0, Llmd;->c:Llme;

    if-eqz v1, :cond_8

    iget-short v2, v1, Llme;->b:S

    const/4 v3, 0x7

    if-ne v2, v3, :cond_2

    invoke-virtual {v0, v1}, Llmd;->e(Llme;)V

    :cond_2
    iget v2, v1, Llme;->e:I

    invoke-virtual {p1, v2}, Lllw;->b(I)Llmh;

    move-result-object v2

    if-eqz v2, :cond_8

    invoke-virtual {v2, v1}, Llmh;->e(Llme;)V
    ...
    iget-object v3, v0, Llmd;->a:Lllv;

    iget v3, v3, Lllv;->a:I

    if-lt v2, v3, :cond_8

    iget-object v3, v0, Llmd;->g:Ljava/util/TreeMap;
    ...
    invoke-direct {v4, v1, v5}, Llma;-><init>(Llme;Z)V
    ...
    invoke-virtual {p1, v1}, Lllw;->d(Llmh;)V
    ...
    iget-object v2, v0, Llmd;->d:Llmc;

    iget v2, v2, Llmc;->a:I

    iget-object v3, p1, Lllw;->c:Ljava/util/ArrayList;
    ...
    iget-object v4, p1, Lllw;->c:Ljava/util/ArrayList;
    ...
    :cond_6
    iget-object v2, p1, Lllw;->c:Ljava/util/ArrayList;
    ...
    move-result v1
    :try_end_1
    .catch Llly; {:try_start_1 .. :try_end_1} :catch_0

    goto/16 :goto_0

    :cond_9
    iput-object p1, p0, Lcom/google/android/libraries/camera/exif/ExifInterface;->bB:Lllw;
...
.method public final v(II)[Llib;
    .locals 1

    invoke-virtual {p0, p1, p2}, Lcom/google/android/libraries/camera/exif/ExifInterface;->l(II)Llme;
    ...
    :cond_0
    iget-object p1, p1, Llme;->f:Ljava/lang/Object;
...
.method public final x(IJLjava/util/TimeZone;)V
    ...
    invoke-virtual {p0, p1, v2}, Lcom/google/android/libraries/camera/exif/ExifInterface;->i(ILjava/lang/Object;)Llme;
    ...
    :cond_2
    invoke-virtual {p0, v2}, Lcom/google/android/libraries/camera/exif/ExifInterface;->y(Llme;)V
    ...
    invoke-virtual {p0, v2, p4}, Lcom/google/android/libraries/camera/exif/ExifInterface;->i(ILjava/lang/Object;)Llme;

    move-result-object p4

    if-eqz p4, :cond_6

    invoke-virtual {p0, p4}, Lcom/google/android/libraries/camera/exif/ExifInterface;->y(Llme;)V
    ...
    :goto_3
    invoke-static {p2, p3}, Lmin;->bl(J)Ljava/lang/String;

    move-result-object p2

    invoke-virtual {p0, p1, p2}, Lcom/google/android/libraries/camera/exif/ExifInterface;->i(ILjava/lang/Object;)Llme;
    ...
    :cond_9
    invoke-virtual {p0, p1}, Lcom/google/android/libraries/camera/exif/ExifInterface;->y(Llme;)V
...
.method public final y(Llme;)V
    .locals 1

    iget-object v0, p0, Lcom/google/android/libraries/camera/exif/ExifInterface;->bB:Lllw;

    invoke-virtual {v0, p1}, Lllw;->j(Llme;)V

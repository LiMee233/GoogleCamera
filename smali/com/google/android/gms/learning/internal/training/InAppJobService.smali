...
.method private tryLoadDynamiteImpl()Z
    ...
    iget-object v1, p0, Lcom/google/android/gms/learning/internal/training/InAppJobService;->dynamiteImpl:Lkrq;
    ...
    sget-object v5, Lkru;->a:Lkru;

    invoke-static {p0, v4, v5}, Lkrn;->a(Landroid/content/Context;Ljava/lang/String;Lkrm;)Landroid/os/IInterface;

    move-result-object v4

    check-cast v4, Lkrq;
    :try_end_0
    .catch Lkrl; {:try_start_0 .. :try_end_0} :catch_1
    ...
    invoke-static {v6}, Lkoe;->b(Ljava/lang/Object;)Lkof;

    move-result-object v6

    invoke-interface {v4, v5, v6}, Lkrq;->i(Lkof;Lkof;)Z
    ...
    :cond_2
    iput-object v4, p0, Lcom/google/android/gms/learning/internal/training/InAppJobService;->dynamiteImpl:Lkrq;
...
.method public getBgExecutor()Ljava/util/concurrent/ExecutorService;
    ...
    sget-object v0, Lkrv;->a:Ljava/util/concurrent/ExecutorService;
...
.method public onDestroy()V
    ...
    iget-object v0, p0, Lcom/google/android/gms/learning/internal/training/InAppJobService;->dynamiteImpl:Lkrq;

    if-eqz v0, :cond_0

    :try_start_0
    invoke-interface {v0}, Lkrq;->f()V
    :try_end_0
...
.method public onRebind(Landroid/content/Intent;)V
    ...
    :try_start_0
    invoke-interface {v0, p1}, Lkrq;->g(Landroid/content/Intent;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    :try_start_0
    invoke-interface {v0, p1, p2, p3}, Lkrq;->e(Landroid/content/Intent;II)I
...
.method public declared-synchronized onStartJob(Landroid/app/job/JobParameters;)Z
    ...
    invoke-static {p0, p1}, Lkro;->a(Landroid/content/Context;Landroid/app/job/JobParameters;)V
    :try_end_0
    ...
    invoke-interface {v0, p1}, Lkrq;->j(Landroid/app/job/JobParameters;)Z
...
.method public onStopJob(Landroid/app/job/JobParameters;)Z
    ...
    :try_start_0
    invoke-interface {v0, p1}, Lkrq;->k(Landroid/app/job/JobParameters;)Z
...
.method public onTrimMemory(I)V
    ...
    :try_start_0
    invoke-interface {v0, p1}, Lkrq;->h(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onUnbind(Landroid/content/Intent;)Z
    ...
    :try_start_0
    invoke-interface {v0, p1}, Lkrq;->l(Landroid/content/Intent;)Z

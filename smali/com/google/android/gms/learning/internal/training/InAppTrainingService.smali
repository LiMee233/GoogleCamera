...
.method public onBind(Landroid/content/Intent;)Landroid/os/IBinder;
    ...
    iget-object v0, p0, Lcom/google/android/gms/learning/internal/training/InAppTrainingService;->dynamiteImpl:Lkrt;

    if-eqz v0, :cond_0

    :try_start_0
    invoke-interface {v0, p1}, Lkrt;->f(Landroid/content/Intent;)Landroid/os/IBinder;
    ...
    invoke-direct {p1, v0}, Lkri;-><init>(Ljava/lang/String;)V
...
.method public onCreate()V
    ...
    sget-object v3, Lkru;->d:Lkru;

    invoke-static {p0, v2, v3}, Lkrn;->a(Landroid/content/Context;Ljava/lang/String;Lkrm;)Landroid/os/IInterface;

    move-result-object v2

    check-cast v2, Lkrt;

    iput-object v2, p0, Lcom/google/android/gms/learning/internal/training/InAppTrainingService;->dynamiteImpl:Lkrt;
    :try_end_0
    ...
    invoke-interface {v2, v3}, Lkrt;->g(Lkof;)V
    :try_end_1
...
.method public onRebind(Landroid/content/Intent;)V
    ...
    :try_start_0
    invoke-interface {v0, p1}, Lkrt;->i(Landroid/content/Intent;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    :try_start_0
    invoke-interface {v0, p1, p2, p3}, Lkrt;->e(Landroid/content/Intent;II)I
...
.method public onTrimMemory(I)V
    ...
    :try_start_0
    invoke-interface {v0, p1}, Lkrt;->j(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onUnbind(Landroid/content/Intent;)Z
    ...
    :try_start_0
    invoke-interface {v0, p1}, Lkrt;->k(Landroid/content/Intent;)Z

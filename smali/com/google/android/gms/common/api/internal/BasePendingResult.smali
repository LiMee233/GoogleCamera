...
.field private mResultGuardian:Lkjn;
...
.method constructor <init>()V
    ...
    invoke-direct {v0, v1}, Lkjm;-><init>(Landroid/os/Looper;)V

    iput-object v0, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->e:Lkjm;
...
.method protected constructor <init>(Lkik;)V
    ...
    iget-object v0, v0, Lkkf;->a:Lkih;

    iget-object v0, v0, Lkih;->h:Landroid/os/Looper;
    ...
    invoke-direct {v1, v0}, Lkjm;-><init>(Landroid/os/Looper;)V

    iput-object v1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->e:Lkjm;
...
.method public static i(Lkit;)V
    .locals 3

    instance-of v0, p0, Lkiq;
...
# virtual methods
.method protected abstract a(Lcom/google/android/gms/common/api/Status;)Lkit;
.end method

.method public final g()Lkit;
    .locals 4
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->g:Lkit;

    const/4 v3, 0x0

    iput-object v3, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->g:Lkit;

    iput-object v3, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->f:Lkiu;
...
.method public final h(Lcom/google/android/gms/common/api/Status;)V
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->a(Lcom/google/android/gms/common/api/Status;)Lkit;
...
.method public final j(Lkit;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->g:Lkit;
    ...
    iget-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->f:Lkiu;

    if-nez p1, :cond_0

    iget-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->g:Lkit;

    instance-of p1, p1, Lkiq;

    if-eqz p1, :cond_1

    new-instance p1, Lkjn;

    invoke-direct {p1, p0}, Lkjn;-><init>(Lcom/google/android/gms/common/api/internal/BasePendingResult;)V

    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->mResultGuardian:Lkjn;

    goto :goto_0

    :cond_0
    iget-object v1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->e:Lkjm;

    const/4 v2, 0x2

    invoke-virtual {v1, v2}, Lkjm;->removeMessages(I)V

    iget-object v1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->e:Lkjm;

    invoke-virtual {p0}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->g()Lkit;

    move-result-object v2

    invoke-virtual {v1, p1, v2}, Lkjm;->a(Lkiu;Lkit;)V
    ...
    invoke-interface {v3, v4}, Lkim;->a(Lcom/google/android/gms/common/api/Status;)V
    ...
    :cond_3
    invoke-static {p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->i(Lkit;)V
...
.method public final l(Lkim;)V
    ...
    invoke-interface {p1, v1}, Lkim;->a(Lcom/google/android/gms/common/api/Status;)V
...
.method public final m(Ljava/util/concurrent/TimeUnit;)Lkit;
    ...
    invoke-static {v1, v0}, Lmin;->dr(ZLjava/lang/Object;)V
    ...
    invoke-static {p1, v0}, Lmin;->dr(ZLjava/lang/Object;)V

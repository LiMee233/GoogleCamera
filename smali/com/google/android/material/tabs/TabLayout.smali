...
.field private G:Locn;

.field private H:Landroid/animation/ValueAnimator;

.field private I:Loct;

.field private J:Z

.field private final K:Lfc;

.field private L:Lobm;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v9, p0, v1}, Locr;-><init>(Lcom/google/android/material/tabs/TabLayout;Landroid/content/Context;)V

    iput-object v9, p0, Lcom/google/android/material/tabs/TabLayout;->a:Locr;
    ...
    invoke-static/range {v3 .. v8}, Lnzr;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)Landroid/content/res/TypedArray;
    ...
    invoke-virtual {v3, p3}, Lobp;->h(Landroid/content/res/ColorStateList;)V

    invoke-virtual {v3, v1}, Lobp;->f(Landroid/content/Context;)V

    invoke-static {p0}, Lgl;->a(Landroid/view/View;)F

    move-result p3

    invoke-virtual {v3, p3}, Lobp;->g(F)V
    ...
    invoke-static {v1, p2, p3}, Lohc;->ap(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v9, v3}, Locr;->b(I)V
    ...
    invoke-virtual {v9, p3}, Locr;->b(I)V
    ...
    invoke-direct {p3}, Locj;-><init>()V

    iput-object p3, p0, Lcom/google/android/material/tabs/TabLayout;->x:Lobm;
    ...
    invoke-static {v1, p3, v3}, Lohc;->ao(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v1, p2, p3}, Lohc;->ao(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v1, p2, v3}, Lohc;->ao(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v9, v10}, Locr;->setGravity(I)V
    ...
    invoke-virtual {v9, p1}, Locr;->setGravity(I)V
...
.method private final m(IF)I
    ...
    :cond_1
    :goto_0
    iget-object v0, p0, Lcom/google/android/material/tabs/TabLayout;->a:Locr;

    invoke-virtual {v0, p1}, Locr;->getChildAt(I)Landroid/view/View;

    move-result-object v0

    add-int/lit8 p1, p1, 0x1

    iget-object v3, p0, Lcom/google/android/material/tabs/TabLayout;->a:Locr;

    invoke-virtual {v3}, Locr;->getChildCount()I
    ...
    invoke-virtual {v3, p1}, Locr;->getChildAt(I)Landroid/view/View;
...
.method private final o(Landroid/view/View;)V
    ...
    instance-of v0, p1, Locl;

    if-eqz v0, :cond_1

    check-cast p1, Locl;

    invoke-virtual {p0}, Lcom/google/android/material/tabs/TabLayout;->d()Locs;

    move-result-object v0

    iget-object v1, p1, Locl;->a:Ljava/lang/CharSequence;

    iget-object v1, p1, Locl;->b:Landroid/graphics/drawable/Drawable;

    iget v1, p1, Locl;->c:I

    invoke-virtual {p1}, Locl;->getContentDescription()Ljava/lang/CharSequence;
    ...
    iput-object p1, v0, Locs;->c:Ljava/lang/CharSequence;

    invoke-virtual {v0}, Locs;->b()V
    ...
    invoke-virtual {p0, v0, p1}, Lcom/google/android/material/tabs/TabLayout;->f(Locs;Z)V
...
.method private final p(I)V
    ...
    invoke-virtual {v0}, Locr;->getChildCount()I
    ...
    invoke-virtual {v0, v3}, Locr;->getChildAt(I)Landroid/view/View;
    ...
    invoke-direct {v5, p0}, Locm;-><init>(Lcom/google/android/material/tabs/TabLayout;)V
    ...
    iget-object v2, v0, Locr;->a:Landroid/animation/ValueAnimator;
    ...
    invoke-virtual {v0, v3, p1, v1}, Locr;->d(ZII)V
...
.method private final q(I)V
    ...
    invoke-virtual {v3, v2}, Locr;->getChildAt(I)Landroid/view/View;
...
.method private final s(Landroidx/viewpager/widget/ViewPager;Z)V
    ...
    iget-object v1, p0, Lcom/google/android/material/tabs/TabLayout;->I:Loct;
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/material/tabs/TabLayout;->L:Lobm;
    ...
    :cond_1
    iget-object v0, p0, Lcom/google/android/material/tabs/TabLayout;->G:Locn;
    ...
    iput-object v1, p0, Lcom/google/android/material/tabs/TabLayout;->G:Locn;
    ...
    iget-object v0, p0, Lcom/google/android/material/tabs/TabLayout;->I:Loct;

    if-nez v0, :cond_3

    new-instance v0, Loct;

    invoke-direct {v0, p0}, Loct;-><init>(Lcom/google/android/material/tabs/TabLayout;)V

    iput-object v0, p0, Lcom/google/android/material/tabs/TabLayout;->I:Loct;
    ...
    invoke-direct {v0, p1}, Locw;-><init>(Landroidx/viewpager/widget/ViewPager;)V

    iput-object v0, p0, Lcom/google/android/material/tabs/TabLayout;->G:Locn;

    invoke-virtual {p0, v0}, Lcom/google/android/material/tabs/TabLayout;->e(Locn;)V
    ...
    iput-object v0, p0, Lcom/google/android/material/tabs/TabLayout;->L:Lobm;
...
.method public final a()I
    ...
    iget-object v0, p0, Lcom/google/android/material/tabs/TabLayout;->A:Locs;
...
.method public final d()Locs;
    ...
    :cond_0
    iput-object p0, v0, Locs;->g:Lcom/google/android/material/tabs/TabLayout;
    ...
    invoke-direct {v1, p0, v2}, Locv;-><init>(Lcom/google/android/material/tabs/TabLayout;Landroid/content/Context;)V

    :cond_2
    invoke-virtual {v1, v0}, Locv;->a(Locs;)V

    const/4 v2, 0x1

    invoke-virtual {v1, v2}, Locv;->setFocusable(Z)V

    invoke-direct {p0}, Lcom/google/android/material/tabs/TabLayout;->n()I

    move-result v2

    invoke-virtual {v1, v2}, Locv;->setMinimumWidth(I)V

    iget-object v2, v0, Locs;->c:Ljava/lang/CharSequence;
    ...
    iget-object v2, v0, Locs;->b:Ljava/lang/CharSequence;

    invoke-virtual {v1, v2}, Locv;->setContentDescription(Ljava/lang/CharSequence;)V
    ...
    iget-object v1, v0, Locs;->h:Locv;

    const/4 v2, 0x0

    invoke-virtual {v1, v2}, Locv;->setId(I)V

    :cond_4
    return-object v0
.end method

.method public final e(Locn;)V
    .locals 1
...
.method public final f(Locs;Z)V
    .locals 6
    ...
    iget-object v1, p1, Locs;->g:Lcom/google/android/material/tabs/TabLayout;
    ...
    :cond_0
    iget-object v0, p1, Locs;->h:Locv;

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Locv;->setSelected(Z)V

    invoke-virtual {v0, v1}, Locv;->setActivated(Z)V

    iget-object v1, p0, Lcom/google/android/material/tabs/TabLayout;->a:Locr;
    ...
    invoke-virtual {v1, v0, v2, v3}, Locr;->addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V

    if-eqz p2, :cond_1

    invoke-virtual {p1}, Locs;->a()V
...
.method public final g()V
    ...
    invoke-virtual {v3, v0}, Locr;->getChildAt(I)Landroid/view/View;

    move-result-object v3

    check-cast v3, Locv;

    iget-object v4, p0, Lcom/google/android/material/tabs/TabLayout;->a:Locr;

    invoke-virtual {v4, v0}, Locr;->removeViewAt(I)V

    if-eqz v3, :cond_0

    invoke-virtual {v3, v2}, Locv;->a(Locs;)V

    const/4 v2, 0x0

    invoke-virtual {v3, v2}, Locv;->setSelected(Z)V
    ...
    iput-object v2, v3, Locs;->g:Lcom/google/android/material/tabs/TabLayout;

    iput-object v2, v3, Locs;->h:Locv;

    iput-object v2, v3, Locs;->a:Ljava/lang/Object;

    iput v1, v3, Locs;->i:I

    iput-object v2, v3, Locs;->b:Ljava/lang/CharSequence;

    iput-object v2, v3, Locs;->c:Ljava/lang/CharSequence;

    iput v1, v3, Locs;->d:I

    iput-object v2, v3, Locs;->e:Landroid/view/View;
    ...
    :cond_2
    iput-object v2, p0, Lcom/google/android/material/tabs/TabLayout;->A:Locs;
...
.method public final h(Locs;)V
    .locals 1

    const/4 v0, 0x1

    invoke-virtual {p0, p1, v0}, Lcom/google/android/material/tabs/TabLayout;->i(Locs;Z)V

    return-void
.end method

.method public final i(Locs;Z)V
    .locals 3
    ...
    :cond_5
    iput-object p1, p0, Lcom/google/android/material/tabs/TabLayout;->A:Locs;
    ...
    invoke-interface {v2, v0}, Locn;->b(Locs;)V
    ...
    invoke-interface {v0, p1}, Locn;->a(Locs;)V
...
.method public final j(IFZZ)V
    ...
    invoke-virtual {v1}, Locr;->getChildCount()I
    ...
    iget-object p4, p0, Lcom/google/android/material/tabs/TabLayout;->a:Locr;

    iget-object v1, p4, Locr;->a:Landroid/animation/ValueAnimator;
    ...
    invoke-virtual {p4, p1}, Locr;->getChildAt(I)Landroid/view/View;
    ...
    invoke-virtual {p4, v2}, Locr;->getChildAt(I)Landroid/view/View;

    move-result-object v2

    iget v3, p4, Locr;->c:F

    invoke-virtual {p4, v1, v2, v3}, Locr;->c(Landroid/view/View;Landroid/view/View;F)V
...
.method public final k(Z)V
    ...
    invoke-virtual {v1, v0}, Locr;->getChildAt(I)Landroid/view/View;
...
.method protected final onAttachedToWindow()V
    ...
    invoke-static {p0}, Lobm;->d(Landroid/view/View;)V
...
.method protected final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v2, v1, Locv;->d:Landroid/graphics/drawable/Drawable;

    if-eqz v2, :cond_0

    invoke-virtual {v1}, Locv;->getLeft()I

    move-result v3

    invoke-virtual {v1}, Locv;->getTop()I

    move-result v4

    invoke-virtual {v1}, Locv;->getRight()I

    move-result v5

    invoke-virtual {v1}, Locv;->getBottom()I

    move-result v6

    invoke-virtual {v2, v3, v4, v5, v6}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V

    iget-object v1, v1, Locv;->d:Landroid/graphics/drawable/Drawable;
...
.method public final onInitializeAccessibilityNodeInfo(Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    invoke-static {v1, v0, v1}, Lkkk;->d(III)Lkkk;
...
.method protected final onMeasure(II)V
    ...
    invoke-static {v0, v1}, Lohc;->ay(Landroid/content/Context;I)F
    ...
    invoke-static {v1, v5}, Lohc;->ay(Landroid/content/Context;I)F
...
.method public final setElevation(F)V
    ...
    invoke-static {p0, p1}, Lobm;->c(Landroid/view/View;F)V
...
.method public final shouldDelayChildPressedState()Z
    ...
    invoke-virtual {v0}, Locr;->getWidth()I

...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v9, p0}, Lnzi;-><init>(Landroid/view/View;)V

    iput-object v9, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->a:Lnzi;

    sget-object v2, Lnwe;->e:Landroid/animation/TimeInterpolator;

    iput-object v2, v9, Lnzi;->v:Landroid/animation/TimeInterpolator;

    invoke-virtual {v9}, Lnzi;->f()V

    iput-boolean v1, v9, Lnzi;->r:Z

    new-instance v10, Lnyg;

    invoke-direct {v10, v8}, Lnyg;-><init>(Landroid/content/Context;)V

    iput-object v10, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->b:Lnyg;

    sget-object v4, Lnwz;->c:[I
    ...
    invoke-virtual {v9, p3}, Lnzi;->i(I)V

    const p3, 0x7f15028d

    invoke-virtual {v9, p3}, Lnzi;->h(I)V
    ...
    invoke-static {v8, p2, p3}, Lohc;->ao(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object p3

    iget-object v2, v9, Lnzi;->k:Landroid/content/res/ColorStateList;

    if-eq v2, p3, :cond_8

    iput-object p3, v9, Lnzi;->k:Landroid/content/res/ColorStateList;
    ...
    iget-object v2, v9, Lnzi;->l:Landroid/content/res/ColorStateList;

    if-eq v2, p3, :cond_9

    iput-object p3, v9, Lnzi;->l:Landroid/content/res/ColorStateList;
    ...
    iget p3, v10, Lnyg;->b:I

    invoke-virtual {v10, p3, p1}, Lnyg;->b(IF)I
    ...
    invoke-direct {p1, p0}, Lnws;-><init>(Lcom/google/android/material/appbar/CollapsingToolbarLayout;)V
...
.method static c(Landroid/view/View;)Lnxb;
    .locals 2
    ...
    invoke-direct {v1, p0}, Lnxb;-><init>(Landroid/view/View;)V
...
.method protected static final h()Lnwu;
    .locals 1
...
.method private final n(IIIIZ)V
    ...
    invoke-static {p0, v4, v5}, Lnzj;->a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    :goto_1
    iget-object v7, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->a:Lnzi;
    ...
    iget-object v3, v7, Lnzi;->g:Landroid/graphics/Rect;

    invoke-static {v3, v8, v9, v6, v1}, Lnzi;->j(Landroid/graphics/Rect;IIII)Z
    ...
    iput-boolean v2, v7, Lnzi;->t:Z

    invoke-virtual {v7}, Lnzi;->e()V

    :cond_7
    iget-object v1, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->a:Lnzi;
    ...
    iget-object p1, v1, Lnzi;->f:Landroid/graphics/Rect;

    invoke-static {p1, v3, v4, p3, p4}, Lnzi;->j(Landroid/graphics/Rect;IIII)Z
    ...
    iput-boolean v2, v1, Lnzi;->t:Z

    invoke-virtual {v1}, Lnzi;->e()V

    :cond_a
    iget-object p1, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->a:Lnzi;

    invoke-virtual {p1, p5}, Lnzi;->g(Z)V
...
.method private final o()V
    ...
    iget-object v0, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->a:Lnzi;

    iget-object v0, v0, Lnzi;->p:Ljava/lang/CharSequence;
...
.method final a(Landroid/view/View;)I
    ...
    invoke-static {p1}, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->c(Landroid/view/View;)Lnxb;
    ...
    iget p1, v1, Lnwu;->bottomMargin:I
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {v1, p1}, Lnzi;->d(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {v0, p1}, Lnzi;->d(Landroid/graphics/Canvas;)V
...
.method protected final drawableStateChanged()V
    ...
    :cond_1
    iget-object v3, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->a:Lnzi;

    if-eqz v3, :cond_5

    iput-object v0, v3, Lnzi;->s:[I

    iget-object v0, v3, Lnzi;->l:Landroid/content/res/ColorStateList;
    ...
    :cond_2
    iget-object v0, v3, Lnzi;->k:Landroid/content/res/ColorStateList;
...
.method public final f(Ljava/lang/CharSequence;)V
    ...
    iget-object v2, v0, Lnzi;->p:Ljava/lang/CharSequence;
    ...
    :cond_0
    iput-object p1, v0, Lnzi;->p:Ljava/lang/CharSequence;

    iput-object v1, v0, Lnzi;->q:Ljava/lang/CharSequence;
    ...
    iget-object v1, p1, Lnzi;->p:Ljava/lang/CharSequence;
...
.method final g()V
    ...
    sget-object v1, Lnwe;->c:Landroid/animation/TimeInterpolator;

    goto :goto_3

    :cond_4
    sget-object v1, Lnwe;->d:Landroid/animation/TimeInterpolator;
    ...
    invoke-direct {v1, p0}, Lnwt;-><init>(Lcom/google/android/material/appbar/CollapsingToolbarLayout;)V
...
.method protected final bridge synthetic generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-static {}, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->h()Lnwu;
...
.method protected final bridge synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, p1}, Lnwu;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public final generateLayoutParams(Landroid/util/AttributeSet;)Landroid/widget/FrameLayout$LayoutParams;
    ...
    invoke-direct {v0, v1, p1}, Lnwu;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method protected final onAttachedToWindow()V
    ...
    iget-object v1, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->C:Lnwv;

    if-nez v1, :cond_0

    new-instance v1, Lnwv;

    invoke-direct {v1, p0}, Lnwv;-><init>(Lcom/google/android/material/appbar/CollapsingToolbarLayout;)V

    iput-object v1, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->C:Lnwv;
...
.method protected final onLayout(ZIIII)V
    ...
    invoke-static {v2}, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->c(Landroid/view/View;)Lnxb;

    move-result-object v2

    invoke-virtual {v2}, Lnxb;->b()V
    ...
    invoke-static {p2}, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->c(Landroid/view/View;)Lnxb;

    move-result-object p2

    invoke-virtual {p2}, Lnxb;->a()V
...
.method protected final onMeasure(II)V
    ...
    iget-object p2, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->a:Lnzi;
    ...
    iget-object v0, p2, Lnzi;->u:Landroid/text/TextPaint;

    iget v3, p2, Lnzi;->j:F

    invoke-virtual {v0, v3}, Landroid/text/TextPaint;->setTextSize(F)V

    iget-object v3, p2, Lnzi;->o:Landroid/graphics/Typeface;
    ...
    iget-object p2, p2, Lnzi;->u:Landroid/text/TextPaint;

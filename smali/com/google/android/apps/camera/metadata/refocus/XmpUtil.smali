...
# static fields
.field private static final MAX_EXTENDED_XMP_BUFFER_SIZE:I = 0xffb2
...
.field private static final XMP_EXTENSION_HEADER:Ljava/lang/String; = "http://ns.adobe.com/xmp/extension/\u0000"

.field private static final XMP_EXTENSION_HEADER_OFFSET:I = 0x7

.field private static final XMP_HAS_EXTENSION:Ljava/lang/String; = "HasExtendedXMP"
...
.method public static createXMPMeta()Lael;
    .locals 1
...
.method public static extractOrCreateXMPMeta(Ljava/lang/String;)Lael;
    .locals 0

    invoke-static {p0}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->extractXMPMeta(Ljava/lang/String;)Lael;

    move-result-object p0

    if-nez p0, :cond_0

    invoke-static {}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->createXMPMeta()Lael;
...
.method private static extractXMPMeta(Lcom/google/android/apps/camera/metadata/refocus/XmpUtil$StreamSlicer;Z)Lael;
    .locals 4
    ...
    invoke-static {p0}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->parseFirstValidXMPSection(Ljava/util/List;)Lael;
    ...
    invoke-static {p0, v1}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->parseExtendedXMPSections(Ljava/util/List;Ljava/lang/String;)Lael;
    ...
    invoke-interface {p1}, Lafw;->b()Ljava/lang/String;

    move-result-object v1

    if-eqz v1, :cond_0

    invoke-interface {p1}, Lafw;->a()Ljava/lang/String;
    ...
    invoke-interface {p1}, Lafw;->c()Ljava/lang/Object;

    move-result-object v3

    invoke-interface {p1}, Lafw;->d()Lafs;

    move-result-object p1

    invoke-interface {v0, v1, v2, v3, p1}, Lael;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;Lafs;)V
    :try_end_1
...
.method public static extractXMPMeta(Ljava/io/InputStream;)Lael;
    .locals 1

    const/4 v0, 0x0

    invoke-static {p0, v0}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->extractXMPMeta(Ljava/io/InputStream;Z)Lael;
...
.method public static extractXMPMeta(Ljava/io/InputStream;Z)Lael;
    .locals 1
    ...
    invoke-static {v0, p1}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->extractXMPMeta(Lcom/google/android/apps/camera/metadata/refocus/XmpUtil$StreamSlicer;Z)Lael;
...
.method public static extractXMPMeta(Ljava/lang/String;)Lael;
    .locals 8
    ...
    invoke-static {v0}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->extractXMPMeta(Ljava/io/InputStream;)Lael;
...
.method public static extractXMPMeta([B)Lael;
    .locals 1

    const/4 v0, 0x0

    invoke-static {p0, v0}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->extractXMPMeta([BZ)Lael;
...
.method public static extractXMPMeta([BZ)Lael;
    .locals 1
...
.method private static parseExtendedXMPSections(Ljava/util/List;Ljava/lang/String;)Lael;
    .locals 9
    ...
    :cond_2
    :try_start_0
    invoke-static {p1}, Laen;->a([B)Lael;
...
.method private static parseFirstValidXMPSection(Ljava/util/List;)Lael;
    .locals 8
    ...
    :try_start_0
    invoke-static {v3}, Laen;->a([B)Lael;
...
.method private static serializeMeta(Lael;)[B
    .locals 6
    ...
    invoke-virtual {v0}, Laft;->j()V

    invoke-virtual {v0}, Laft;->i()V

    invoke-static {p0, v0}, Laen;->a(Lael;Laft;)[B
...
.method private static writeXMPMeta(Lcom/google/android/apps/camera/metadata/refocus/XmpUtil$StreamSlicer;Ljava/io/OutputStream;Lael;Lael;)Z
    .locals 11
    ...
    invoke-static {p3}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->serializeMeta(Lael;)[B
    ...
    :try_start_0
    invoke-interface {p2, v2, v1, v4}, Lael;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    :try_end_0
    .catch Laej; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {p2}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->serializeMeta(Lael;)[B
    ...
    invoke-interface {p2, v2, v1}, Lael;->c(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static writeXMPMeta(Ljava/io/InputStream;Ljava/io/OutputStream;Lael;Lael;)Z
    .locals 1
    ...
    invoke-static {v0, p1, p2, p3}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->writeXMPMeta(Lcom/google/android/apps/camera/metadata/refocus/XmpUtil$StreamSlicer;Ljava/io/OutputStream;Lael;Lael;)Z
...
.method public static writeXMPMeta(Ljava/lang/String;Lael;)Z
    .locals 9
    ...
    :cond_2
    :try_start_2
    invoke-static {v1, v2, p1, v0}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->writeXMPMeta(Ljava/io/InputStream;Ljava/io/OutputStream;Lael;Lael;)Z
...
.method public static writeXMPMeta([BLjava/io/OutputStream;Lael;Lael;)Z
    .locals 1

...
.method private final declared-synchronized b()Leji;
    .locals 2

    monitor-enter p0

    :try_start_0
    iget-object v0, p0, Lcom/google/android/apps/camera/legacy/app/settings/CameraSearchIndexablesProvider;->b:Leji;
    ...
    invoke-interface {v0}, Leas;->a()Ldzh;

    move-result-object v0

    invoke-interface {v0}, Ldzh;->b()Lejj;

    move-result-object v0

    invoke-interface {v0}, Lejj;->a()Leji;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/apps/camera/legacy/app/settings/CameraSearchIndexablesProvider;->b:Leji;

    invoke-virtual {p0}, Lcom/google/android/apps/camera/legacy/app/settings/CameraSearchIndexablesProvider;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-virtual {v0, v1}, Leji;->a(Landroid/content/Context;)V
...
.method public final queryNonIndexableKeys([Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-direct {p0}, Lcom/google/android/apps/camera/legacy/app/settings/CameraSearchIndexablesProvider;->b()Leji;
...
.method public final queryRawData([Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-virtual {p1}, Leji;->b()Loiz;

    move-result-object p1

    invoke-interface {p1}, Loiz;->i()Ljava/util/Collection;

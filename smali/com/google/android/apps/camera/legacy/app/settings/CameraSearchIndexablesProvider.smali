...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/apps/camera/legacy/app/settings/CameraSearchIndexablesProvider;->a:Loue;
...
.method private final declared-synchronized a()Lfcd;
    .locals 4

    monitor-enter p0

    :try_start_0
    iget-object v0, p0, Lcom/google/android/apps/camera/legacy/app/settings/CameraSearchIndexablesProvider;->b:Lfcd;
    ...
    invoke-interface {v0}, Lewb;->d()Leuu;
    ...
    invoke-direct {v1, v2, v3}, Lkhv;-><init>(Landroid/content/Context;[B)V

    invoke-interface {v0, v1}, Leuu;->j(Lkhv;)Lfcf;

    move-result-object v0

    invoke-interface {v0}, Lfcf;->a()Lfcd;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/apps/camera/legacy/app/settings/CameraSearchIndexablesProvider;->b:Lfcd;

    invoke-virtual {p0}, Lcom/google/android/apps/camera/legacy/app/settings/CameraSearchIndexablesProvider;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-virtual {v0, v1}, Lfcd;->a(Landroid/content/Context;)V
...
.method public final onCreate()Z
    ...
    sget-object v0, Lcom/google/android/apps/camera/legacy/app/settings/CameraSearchIndexablesProvider;->a:Loue;
...
.method public final queryNonIndexableKeys([Ljava/lang/String;)Landroid/database/Cursor;
    ...
    sget-object p1, Lcom/google/android/apps/camera/legacy/app/settings/CameraSearchIndexablesProvider;->a:Loue;
    ...
    invoke-direct {p0}, Lcom/google/android/apps/camera/legacy/app/settings/CameraSearchIndexablesProvider;->a()Lfcd;
...
.method public final queryRawData([Ljava/lang/String;)Landroid/database/Cursor;
    ...
    iget-object p1, p1, Lfcd;->o:Loqo;

    check-cast p1, Lolf;

    iget-object v1, p1, Lolf;->d:Ljava/util/Collection;

    if-nez v1, :cond_0

    new-instance v1, Lole;

    invoke-direct {v1, p1}, Lole;-><init>(Lolf;)V

    iput-object v1, p1, Lolf;->d:Ljava/util/Collection;

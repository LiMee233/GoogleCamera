...
.method private final m(Landroid/widget/TextView;I)V
    ...
    invoke-direct {v1, p1}, Ljdv;-><init>(Landroid/widget/TextView;)V
...
.method public final i(Ljdw;Ldde;)V
    .locals 8
    ...
    iget-object v1, p1, Ljdw;->h:Ljava/util/List;

    invoke-interface {v0, v1}, Ljava/util/List;->addAll(Ljava/util/Collection;)Z

    iput-object p2, p0, Lcom/google/android/apps/camera/ui/modeslider/ModeSlider;->f:Ldde;

    iget-object p1, p1, Ljdw;->h:Ljava/util/List;
    ...
    iget-object v4, v4, Ljdx;->b:Ljava/lang/String;
    ...
    iget-object v5, v5, Ljdx;->c:Ljava/lang/String;
    ...
    invoke-interface {p2, v4}, Ldde;->k(Lddf;)Z
    ...
    invoke-static {v6, v4}, Lohc;->aq(Landroid/view/View;I)I
    ...
    invoke-direct {v4, p0, v3}, Ljdt;-><init>(Lcom/google/android/apps/camera/ui/modeslider/ModeSlider;I)V
    ...
    invoke-direct {p1, p0}, Ljdu;-><init>(Lcom/google/android/apps/camera/ui/modeslider/ModeSlider;)V
...
.method public final l(IZ)V
    ...
    iget-object v4, p0, Lcom/google/android/apps/camera/ui/modeslider/ModeSlider;->f:Ldde;
    ...
    invoke-static {v2, v4}, Lohc;->aq(Landroid/view/View;I)I
    ...
    iget-object v3, p0, Lcom/google/android/apps/camera/ui/modeslider/ModeSlider;->f:Ldde;
    ...
    invoke-static {v2, v3}, Lohc;->aq(Landroid/view/View;I)I
    ...
    iget-object v1, p0, Lcom/google/android/apps/camera/ui/modeslider/ModeSlider;->a:Ljek;

    if-eqz v1, :cond_6

    if-nez p2, :cond_5

    invoke-interface {v1, v0}, Ljek;->c(Z)V

    :cond_5
    iget-object v1, p0, Lcom/google/android/apps/camera/ui/modeslider/ModeSlider;->a:Ljek;

    invoke-interface {v1, p0, p1, p2}, Ljek;->a(Landroid/view/View;IZ)V

    if-nez p2, :cond_6

    iget-object p1, p0, Lcom/google/android/apps/camera/ui/modeslider/ModeSlider;->a:Ljek;

    invoke-interface {p1, p0, v0}, Ljek;->b(Landroid/view/View;Z)V

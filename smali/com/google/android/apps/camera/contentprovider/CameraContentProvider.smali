...
# instance fields
.field private a:Ldet;

.field private b:Landroid/content/pm/ProviderInfo;

.field private volatile c:Ldes;
...
.method private final b()Ldes;
    .locals 2

    iget-object v0, p0, Lcom/google/android/apps/camera/contentprovider/CameraContentProvider;->c:Ldes;
    ...
    invoke-direct {v1, p0, v0}, Ldeu;-><init>(Landroid/content/ContentProvider;Landroid/content/pm/ProviderInfo;)V
    ...
    invoke-interface {v0, v1}, Lcom/google/android/apps/camera/contentprovider/HasCameraContentProviderComponent;->cameraContentProviderComponent(Ldeu;)Ldeq;

    move-result-object v0

    invoke-interface {v0}, Ldeq;->b()Lqiu;

    move-result-object v1

    invoke-virtual {v1}, Lqiu;->a()V

    invoke-interface {v0}, Ldeq;->a()Ldes;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/apps/camera/contentprovider/CameraContentProvider;->c:Ldes;
...
.method protected final a()V
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/contentprovider/CameraContentProvider;->a:Ldet;
    ...
    invoke-virtual {v0, v1}, Ldet;->a(Ljava/lang/String;)Z
...
.method public final call(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    invoke-direct {p0}, Lcom/google/android/apps/camera/contentprovider/CameraContentProvider;->b()Ldes;
...
.method public final onCreate()Z
    ...
    invoke-direct {v2, v0, v1}, Ldet;-><init>(Landroid/content/Context;Ljava/util/Set;)V

    iput-object v2, p0, Lcom/google/android/apps/camera/contentprovider/CameraContentProvider;->a:Ldet;
...
.method public final openFile(Landroid/net/Uri;Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;
    ...
    :cond_1
    iget-object p2, v1, Ldes;->b:Landroid/content/UriMatcher;
    ...
    :cond_2
    iget-object v6, p2, Ldxu;->e:Ldwt;

    invoke-virtual {v6, v3, v4}, Ldwt;->a(J)Loix;
    ...
    invoke-virtual {v3}, Ldwr;->a()Lbcl;

    move-result-object v3

    if-eqz v3, :cond_7

    iget-object v4, p2, Ldxu;->c:Lljd;
    ...
    invoke-static {v3}, Lmin;->eu(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Bitmap;
    ...
    invoke-interface {v4, v0}, Lljd;->e(Ljava/lang/String;)V
    :try_end_0
    .catch Ldxx; {:try_start_0 .. :try_end_0} :catch_1

    :try_start_1
    iget-object v0, p2, Ldxu;->d:Ldxw;
    ...
    :goto_4
    invoke-interface {v0, v3}, Ldxs;->a(Landroid/graphics/Bitmap;)Ljava/io/ByteArrayOutputStream;
    ...
    :try_start_2
    iget-object v3, p2, Ldxu;->c:Lljd;

    invoke-interface {v3}, Lljd;->f()V

    new-instance v9, Ldxt;

    invoke-direct {v9, p2, v2, v0}, Ldxt;-><init>(Ldxu;Ljava/lang/String;Ljava/io/ByteArrayOutputStream;)V

    iget-object v4, v1, Ldes;->a:Landroid/content/ContentProvider;
    ...
    move-result-object p1
    :try_end_2
    .catch Ldxx; {:try_start_2 .. :try_end_2} :catch_1
    ...
    invoke-direct {v1, v0}, Ldxx;-><init>(Ljava/lang/Throwable;)V
    ...
    invoke-static {p2, v0, v2, v1}, Ld;->u(Louv;Ljava/lang/String;Ljava/lang/Object;C)V

    new-instance p2, Ldxx;

    const-string v0, "DrawableResource is not set in ProcessingMedia"

    invoke-direct {p2, v0}, Ldxx;-><init>(Ljava/lang/String;)V
    ...
    throw p2
    :try_end_4
    .catch Ldxx; {:try_start_4 .. :try_end_4} :catch_1
    ...
    invoke-virtual {p2}, Ldxx;->getMessage()Ljava/lang/String;
    ...
    :goto_7
    invoke-virtual {v1, p1, p2}, Ldes;->a(Landroid/net/Uri;I)Landroid/os/ParcelFileDescriptor;
...
.method public final query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    iget-object p4, p3, Ldes;->c:Lljd;

    const-string p5, "SpecialTypesQuery"

    invoke-interface {p4, p5}, Lljd;->e(Ljava/lang/String;)V

    iget-object p4, p3, Ldes;->d:Ldwz;

    iget-object p5, p4, Ldwz;->d:Landroid/content/UriMatcher;
    ...
    :sswitch_0
    iget-object p4, p4, Ldwz;->c:Ldwy;

    goto :goto_0

    :sswitch_1
    iget-object p4, p4, Ldwz;->b:Ldwy;

    goto :goto_0

    :sswitch_2
    iget-object p4, p4, Ldwz;->a:Ldwy;

    :goto_0
    invoke-interface {p4, p1, p2}, Ldwy;->a(Landroid/net/Uri;[Ljava/lang/String;)Landroid/database/Cursor;

    move-result-object p1

    iget-object p2, p3, Ldes;->c:Lljd;

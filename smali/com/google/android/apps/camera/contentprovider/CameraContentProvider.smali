...
.method private final b()Lciw;
    .locals 2

    iget-object v0, p0, Lcom/google/android/apps/camera/contentprovider/CameraContentProvider;->c:Lciw;
    ...
    invoke-direct {v1, p0, v0}, Lciz;-><init>(Landroid/content/ContentProvider;Landroid/content/pm/ProviderInfo;)V
    ...
    invoke-interface {v0, v1}, Lcom/google/android/apps/camera/contentprovider/HasCameraContentProviderComponent;->cameraContentProviderComponent(Lciz;)Lcit;

    move-result-object v0

    invoke-interface {v0}, Lcit;->a()Lciw;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/apps/camera/contentprovider/CameraContentProvider;->c:Lciw;
...
.method protected final a()V
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/contentprovider/CameraContentProvider;->a:Lciy;
    ...
    invoke-virtual {v0, v1}, Lciy;->a(Ljava/lang/String;)Z
...
.method public final call(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    invoke-direct {p0}, Lcom/google/android/apps/camera/contentprovider/CameraContentProvider;->b()Lciw;
...
.method public final delete(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    iget-object v0, p2, Lciw;->d:Landroid/content/UriMatcher;
    ...
    iget-object v1, p2, Lciw;->c:Landroid/content/Context;
    ...
    :cond_3
    iget-object p1, p2, Lciw;->a:Lcis;

    iget-object p2, p1, Lcis;->a:Lily;

    invoke-interface {p2, v3}, Lily;->b(Ljava/io/File;)Z
    ...
    invoke-interface {p2, v3}, Lily;->c(Ljava/io/File;)Z
    ...
    :cond_5
    :try_start_2
    invoke-static {v3}, Lcis;->b(Ljava/io/File;)Ljava/io/File;
    ...
    :cond_7
    invoke-static {p3}, Lcis;->b(Ljava/io/File;)Ljava/io/File;
    ...
    invoke-static {p3}, Lcis;->a(Ljava/io/File;)Z
    ...
    :cond_9
    invoke-static {p1}, Lcis;->a(Ljava/io/File;)Z
    ...
    iget-object v4, p1, Lcis;->a:Lily;

    invoke-interface {v4, v3}, Lily;->b(Ljava/io/File;)Z
    ...
    invoke-interface {v4, v3}, Lily;->c(Ljava/io/File;)Z
...
.method public final onCreate()Z
    ...
    invoke-direct {v2, v0, v1}, Lciy;-><init>(Landroid/content/Context;Ljava/util/Set;)V

    iput-object v2, p0, Lcom/google/android/apps/camera/contentprovider/CameraContentProvider;->a:Lciy;
...
.method public final openFile(Landroid/net/Uri;Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;
    ...
    :cond_1
    iget-object p2, v1, Lciw;->d:Landroid/content/UriMatcher;
    ...
    sget-object v3, Ldfa;->a:Ljava/lang/String;
    ...
    sget-object v6, Ldfa;->a:Ljava/lang/String;
    ...
    iget-object v6, v6, Ldgt;->b:Ldfi;

    invoke-interface {v6, v3, v4}, Ldfi;->a(J)Loac;
    ...
    invoke-interface {v3}, Ldfd;->d()Laow;
    ...
    invoke-interface {v4, v6}, Llvj;->b(Ljava/lang/String;)V
    ...
    invoke-static {v3}, Ljyw;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Bitmap;
    ...
    sget-object v9, Ljyw;->a:Ljava/lang/String;
    ...
    :goto_3
    sget-object v6, Ljyw;->a:Ljava/lang/String;
    ...
    sget-object v4, Ldfa;->a:Ljava/lang/String;
    ...
    :try_end_0
    .catch Ldgx; {:try_start_0 .. :try_end_0} :catch_1
    ...
    iget-object v0, v0, Ldgt;->e:Ldgp;

    :cond_7
    nop

    invoke-interface {v0, v3}, Ldgo;->a(Landroid/graphics/Bitmap;)Ljava/io/ByteArrayOutputStream;
    ...
    iget-object v3, v3, Ldgt;->c:Llvj;

    invoke-interface {v3}, Llvj;->a()V

    invoke-static {v0}, Luu;->a(Ljava/lang/Object;)Ljava/lang/Object;

    new-instance v9, Ldgs;

    check-cast p2, Ldgt;

    invoke-direct {v9, p2, v2, v0}, Ldgs;-><init>(Ldgt;Ljava/lang/String;Ljava/io/ByteArrayOutputStream;)V

    iget-object v4, v1, Lciw;->b:Landroid/content/ContentProvider;
    ...
    move-result-object p1
    :try_end_2
    .catch Ldgx; {:try_start_2 .. :try_end_2} :catch_1
    ...
    invoke-direct {v1, v0}, Ldgx;-><init>(Ljava/lang/Throwable;)V
    ...
    invoke-static {p2, v0}, Lijd;->b(Ljava/lang/String;Ljava/lang/String;)V

    new-instance p2, Ldgx;

    const-string v0, "DrawableResource is not set in ProcessingMedia"

    invoke-direct {p2, v0}, Ldgx;-><init>(Ljava/lang/String;)V
    ...
    throw p2
    :try_end_4
    .catch Ldgx; {:try_start_4 .. :try_end_4} :catch_1
    ...
    invoke-virtual {p2}, Ldgx;->getMessage()Ljava/lang/String;
    ...
    invoke-virtual {v1, p1, p2}, Lciw;->a(Landroid/net/Uri;I)Landroid/os/ParcelFileDescriptor;
...
.method public final query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    iget-object p4, p3, Lciw;->g:Llvj;

    const-string p5, "SpecialTypesQuery"

    invoke-interface {p4, p5}, Llvj;->b(Ljava/lang/String;)V

    iget-object p4, p3, Lciw;->e:Ldft;

    check-cast p4, Ldfu;

    iget-object p5, p4, Ldfu;->d:Landroid/content/UriMatcher;
    ...
    :cond_1
    :goto_0
    iget-object p4, p4, Ldfu;->c:Ldfs;

    goto :goto_1

    :cond_2
    iget-object p4, p4, Ldfu;->b:Ldfs;

    goto :goto_1

    :cond_3
    iget-object p4, p4, Ldfu;->a:Ldfs;

    :goto_1
    invoke-interface {p4, p1, p2}, Ldfs;->a(Landroid/net/Uri;[Ljava/lang/String;)Landroid/database/Cursor;

    move-result-object p1

    iget-object p2, p3, Lciw;->g:Llvj;

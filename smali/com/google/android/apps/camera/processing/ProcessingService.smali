...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, Lhhj;-><init>(Lcom/google/android/apps/camera/processing/ProcessingService;)V

    iput-object v0, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->u:Lhhj;
...
.method private final d()V
    ...
    invoke-interface {v0, p0}, Lhhi;->q(Lcom/google/android/apps/camera/processing/ProcessingService;)V

    iget-object v0, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->q:Llze;
...
.method public final b(Ljmm;)V
    ...
    invoke-interface {p1, v1}, Ljmm;->a(Landroid/content/res/Resources;)Ljava/lang/String;
...
.method public final c()V
    ...
    invoke-direct {v2, p0}, Lhhg;-><init>(Lcom/google/android/apps/camera/processing/ProcessingService;)V
    ...
    invoke-static {v1}, Lcom/hdrindicator/AgcUtil;->sHdrProcessTime(I)V
...
.method public final onCreate()V
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->n:Lljd;
    ...
    invoke-direct {v0, v2, v3, v4}, Lhho;-><init>(Landroid/os/PowerManager;J)V

    iput-object v0, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->c:Lhho;

    const-string v2, "onCreate"

    invoke-virtual {v0, v2}, Lhho;->a(Ljava/lang/String;)V

    iget-object v0, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->s:Lenv;

    invoke-virtual {v0}, Lenv;->a()V
    ...
    iget-object v3, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->u:Lhhj;
...
.method public final onDestroy()V
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->c:Lhho;

    invoke-virtual {v0}, Lhho;->b()V

    iget-object v0, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->s:Lenv;

    invoke-virtual {v0}, Lenv;->b()V

    iget-object v0, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->m:Lafp;

    iget-object v1, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->u:Lhhj;
    ...
    iget-object v1, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->k:Lhhk;
    ...
    :goto_1
    invoke-interface {v3, v0}, Lliq;->f(Ljava/lang/String;)V

    iget-boolean v0, v1, Lhhk;->d:Z

    if-eqz v0, :cond_2

    const/4 v0, 0x0

    iput-boolean v0, v1, Lhhk;->d:Z
    ...
    :cond_2
    iget-object v0, v1, Lhhk;->c:Ljava/util/LinkedList;
    ...
    iget-object v0, v1, Lhhk;->f:Lpic;

    invoke-static {}, Lpic;->f()Lpic;

    move-result-object v3

    iput-object v3, v1, Lhhk;->f:Lpic;
    ...
    invoke-static {v0}, Lcom/hdrindicator/AgcUtil;->sHdrProcessTime(I)V
...
.method public final onStartCommand(Landroid/content/Intent;II)I
    ...
    iget-object p1, p0, Lcom/google/android/apps/camera/processing/ProcessingService;->r:Lfjq;

    new-instance p2, Lfjp;

    invoke-direct {p2, p1}, Lfjp;-><init>(Lfjq;)V

    new-instance p1, Lkzz;

    new-instance p3, Lhhh;

    invoke-direct {p3, p0, p2}, Lhhh;-><init>(Lcom/google/android/apps/camera/processing/ProcessingService;Lfjp;)V

    const/16 p2, 0x9

    const-string v0, "CameraProcessingThread"

    invoke-direct {p1, p2, p3, v0}, Lkzz;-><init>(ILjava/lang/Runnable;Ljava/lang/String;)V

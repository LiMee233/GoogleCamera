...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/apps/camera/debug/contentprovider/DebugContentProvider;->b:Loue;
...
.method public static final b(Ljava/lang/Class;Lj$/util/function/Predicate;)Ljava/util/List;
    ...
    sget-object p0, Lcom/google/android/apps/camera/debug/contentprovider/DebugContentProvider;->b:Loue;
...
.method private final declared-synchronized c()Ldgs;
    .locals 4

    monitor-enter p0

    :try_start_0
    iget-object v0, p0, Lcom/google/android/apps/camera/debug/contentprovider/DebugContentProvider;->c:Ldgs;
    ...
    invoke-direct {v0, v1}, Ldgs;-><init>(Ljava/lang/String;)V

    new-instance v1, Ldgk;

    const/4 v2, 0x1

    invoke-direct {v1, v2}, Ldgk;-><init>(I)V

    const-string v2, "startup_timing_latest"

    const-class v3, Lijd;

    invoke-virtual {v0, v2, v3, v1}, Ldgs;->b(Ljava/lang/String;Ljava/lang/Class;Ldgr;)V
    ...
    iput-object v0, p0, Lcom/google/android/apps/camera/debug/contentprovider/DebugContentProvider;->c:Ldgs;
...
.method protected final declared-synchronized a()Ldde;
    ...
    :try_start_0
    iget-object v0, p0, Lcom/google/android/apps/camera/debug/contentprovider/DebugContentProvider;->a:Ldde;
    ...
    invoke-interface {v0, p0}, Ldgl;->f(Lcom/google/android/apps/camera/debug/contentprovider/DebugContentProvider;)V
...
.method public final delete(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    sget-object p1, Lcom/google/android/apps/camera/debug/contentprovider/DebugContentProvider;->b:Loue;
...
.method public final dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-direct/range {p0 .. p0}, Lcom/google/android/apps/camera/debug/contentprovider/DebugContentProvider;->c()Ldgs;
    ...
    iget-object v7, v5, Ldgs;->e:Ljava/util/Map;
    ...
    sget-object v15, Ldgs;->b:Ldgq;

    invoke-virtual {v5, v14, v8, v15}, Ldgs;->a(Ldgr;ZLdgq;)Landroid/database/Cursor;
    ...
    :cond_1
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/apps/camera/debug/contentprovider/DebugContentProvider;->a()Ldde;
    ...
    sget-object v1, Lcom/google/android/apps/camera/debug/contentprovider/DebugContentProvider;->b:Loue;
...
.method public final query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    :try_start_0
    invoke-direct {p0}, Lcom/google/android/apps/camera/debug/contentprovider/DebugContentProvider;->c()Ldgs;

    move-result-object p3

    iget-object p4, p3, Ldgs;->c:Landroid/content/UriMatcher;

    invoke-virtual {p4, p1}, Landroid/content/UriMatcher;->match(Landroid/net/Uri;)I

    move-result p4

    iget-object p3, p3, Ldgs;->d:Ljava/util/Map;
    ...
    invoke-static {p3, p4, p1, p5}, Ld;->u(Louv;Ljava/lang/String;Ljava/lang/Object;C)V

    goto :goto_0

    :cond_1
    invoke-interface {p3}, Loju;->a()Ljava/lang/Object;
    ...
    sget-object p3, Lcom/google/android/apps/camera/debug/contentprovider/DebugContentProvider;->b:Loue;
    ...
    invoke-static {p3, p5, p4, p1}, Ld;->w(Louv;Ljava/lang/String;CLjava/lang/Throwable;)V

...
.method private static b(Ljava/util/Map;Ljava/util/List;Ljava/io/PrintWriter;)V
    ...
    :cond_0
    iget-wide v5, v9, Ldis;->a:J

    iget-object v7, v9, Ldis;->i:Ljava/lang/String;

    iget-wide v11, v9, Ldis;->j:J

    iget-object v13, v9, Ldis;->b:Ljava/lang/String;

    iget-object v14, v9, Ldis;->h:Ljava/lang/String;

    iget-wide v2, v9, Ldis;->c:J

    move-object v4, v1

    iget-wide v0, v9, Ldis;->d:J

    move-wide/from16 v17, v0

    iget-wide v0, v9, Ldis;->e:J

    move-wide/from16 v19, v0

    iget-wide v0, v9, Ldis;->f:J

    move-wide/from16 v21, v0

    iget-wide v0, v9, Ldis;->g:J

    iget-boolean v9, v9, Ldis;->l:Z
    ...
    :goto_3
    iget-object v6, v8, Ldiy;->d:Ljava/lang/String;
...
.method public final a(Ljava/io/PrintWriter;)V
    ...
    invoke-virtual {v2}, Lcom/google/android/apps/camera/debug/shottracker/db/ShotDatabase;->r()Ldik;
    ...
    iget-object v6, v3, Ldiq;->a:Laii;

    invoke-virtual {v6}, Laii;->g()V

    iget-object v3, v3, Ldiq;->a:Laii;
    ...
    iput-object v4, v2, Ldis;->b:Ljava/lang/String;
    ...
    iput-wide v4, v2, Ldis;->c:J

    invoke-interface {v3, v9}, Landroid/database/Cursor;->getLong(I)J

    move-result-wide v4

    iput-wide v4, v2, Ldis;->d:J

    invoke-interface {v3, v10}, Landroid/database/Cursor;->getLong(I)J

    move-result-wide v4

    iput-wide v4, v2, Ldis;->e:J

    invoke-interface {v3, v11}, Landroid/database/Cursor;->getLong(I)J

    move-result-wide v4

    iput-wide v4, v2, Ldis;->f:J

    invoke-interface {v3, v12}, Landroid/database/Cursor;->getLong(I)J

    move-result-wide v4

    iput-wide v4, v2, Ldis;->g:J
    ...
    iput-object v4, v2, Ldis;->h:Ljava/lang/String;
    ...
    iput-object v4, v2, Ldis;->i:Ljava/lang/String;
    ...
    invoke-virtual/range {v17 .. v17}, Lcom/google/android/apps/camera/debug/shottracker/db/ShotDatabase;->s()Ldit;
    ...
    iget-object v4, v0, Ldix;->a:Laii;

    invoke-virtual {v4}, Laii;->g()V

    iget-object v0, v0, Ldix;->a:Laii;
    ...
    new-instance v8, Ldiy;

    invoke-direct {v8}, Ldiy;-><init>()V
    ...
    iput-wide v9, v8, Ldiy;->b:J

    invoke-interface {v3, v5}, Landroid/database/Cursor;->getLong(I)J

    move-result-wide v9

    iput-wide v9, v8, Ldiy;->c:J
    ...
    iput-object v9, v8, Ldiy;->d:Ljava/lang/String;
    ...
    iput-object v10, v8, Ldiy;->d:Ljava/lang/String;
    ...
    iget-boolean v4, v3, Ldis;->l:Z

    if-nez v4, :cond_9

    iget-wide v4, v3, Ldis;->d:J
    ...
    iget-wide v4, v3, Ldis;->e:J

    cmp-long v6, v4, v8

    if-nez v6, :cond_8

    iget-wide v4, v3, Ldis;->f:J

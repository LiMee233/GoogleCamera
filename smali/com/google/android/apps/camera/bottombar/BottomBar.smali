...
# instance fields
.field private actualOrientation:Ljrx;
...
.field private orientation:Ljrx;
...
.field private sysUiFlagApplier:Lime;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p2, p0, Lcom/google/android/apps/camera/bottombar/BottomBar;->orientation:Ljrx;

    sget-object p2, Ljrx;->a:Ljrx;

    iput-object p2, p0, Lcom/google/android/apps/camera/bottombar/BottomBar;->actualOrientation:Ljrx;

    sget-object p2, Ljcc;->b:Ljcc;

    iput-object p2, p0, Lcom/google/android/apps/camera/bottombar/BottomBar;->decision:Ljcc;
...
.method private applyOrientation()V
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/bottombar/BottomBar;->decision:Ljcc;
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/bottombar/BottomBar;->actualOrientation:Ljrx;
    ...
    invoke-static {p0}, Ljry;->c(Landroid/widget/LinearLayout;)V
    ...
    iget-object v1, p0, Lcom/google/android/apps/camera/bottombar/BottomBar;->orientation:Ljrx;

    iput-object v1, v0, Lcom/google/android/apps/camera/ui/zoomlock/ZoomLockView;->g:Ljrx;

    invoke-virtual {v0}, Lcom/google/android/apps/camera/ui/zoomlock/ZoomLockView;->a()V

    :cond_3
    iget-object v0, p0, Lcom/google/android/apps/camera/bottombar/BottomBar;->orientation:Ljrx;

    invoke-static {p0, v0}, Lmin;->es(Landroid/view/View;Ljrx;)V

    invoke-static {p0}, Lmin;->em(Landroid/view/ViewGroup;)Ljava/util/Collection;
...
.method private static fadeView(Landroid/view/View;ZZ)V
    ...
    :goto_0
    invoke-static {v0, p0}, Ljup;->a(ILandroid/view/View;)V
...
.method private hideNavBar()V
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/bottombar/BottomBar;->sysUiFlagApplier:Lime;

    if-eqz v0, :cond_0

    const/16 v1, 0x1006

    invoke-interface {v0, v1}, Lime;->d(I)V
...
.method private inflate(Landroid/content/Context;)V
    ...
    invoke-static {p1}, Ljuq;->a(Landroid/view/View;)Ljuq;
...
.method private reverseOrientation(Ljrx;)Ljrx;
    .locals 1
...
.method public getUiOrientation()Ljrx;
    .locals 1
...
.method public synthetic lambda$applyOrientation$1$com-google-android-apps-camera-bottombar-BottomBar(Landroid/view/View;)V
    ...
    invoke-static {p1}, Lmin;->em(Landroid/view/ViewGroup;)Ljava/util/Collection;
...
.method public setSysUiFlagApplier(Lime;)V
    .locals 0

    iput-object p1, p0, Lcom/google/android/apps/camera/bottombar/BottomBar;->sysUiFlagApplier:Lime;
...
.method public setUiOrientation(Ljrx;Ljcc;)V
    .locals 2
    ...
    :cond_0
    invoke-direct {p0, p1}, Lcom/google/android/apps/camera/bottombar/BottomBar;->reverseOrientation(Ljrx;)Ljrx;
    ...
    iget-object v1, p0, Lcom/google/android/apps/camera/bottombar/BottomBar;->decision:Ljcc;
    ...
    :cond_3
    :goto_2
    iput-object v0, p0, Lcom/google/android/apps/camera/bottombar/BottomBar;->orientation:Ljrx;

    iput-object p1, p0, Lcom/google/android/apps/camera/bottombar/BottomBar;->actualOrientation:Ljrx;

...
# direct methods
.method public constructor <init>(Ljtf;Ljava/util/Map;)V
    .locals 2
    ...
    invoke-interface {p2}, Llnv;->c()Llvq;

    move-result-object p2

    iget-object p2, p2, Llvq;->a:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/google/android/apps/camera/hdrplus/deblurfusion/DeblurFusionMergedCropCalculator;->c:Llvn;

    invoke-virtual {p1, p2}, Ljtf;->a(Ljava/lang/String;)Llvn;

    move-result-object p1

    iput-object p1, p0, Lcom/google/android/apps/camera/hdrplus/deblurfusion/DeblurFusionMergedCropCalculator;->d:Llvn;
...
.method public final a(Llmp;)Loix;
    ...
    invoke-interface {v2}, Llzs;->g()Ljava/util/Map;
    ...
    iget-object v3, v0, Lcom/google/android/apps/camera/hdrplus/deblurfusion/DeblurFusionMergedCropCalculator;->c:Llvn;

    invoke-interface {v3}, Llvn;->h()Landroid/graphics/Rect;

    move-result-object v3

    iget-object v4, v0, Lcom/google/android/apps/camera/hdrplus/deblurfusion/DeblurFusionMergedCropCalculator;->d:Llvn;
    ...
    iget-object v8, v0, Lcom/google/android/apps/camera/hdrplus/deblurfusion/DeblurFusionMergedCropCalculator;->c:Llvn;

    invoke-static {v8, v1, v7}, Lpkm;->q(Llvn;Llzo;Lcom/google/googlex/gcam/FaceInfoVector;)V

    sget-object v8, Landroid/hardware/camera2/CaptureResult;->LENS_FOCAL_LENGTH:Landroid/hardware/camera2/CaptureResult$Key;

    invoke-interface {v1, v8}, Llzo;->d(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-interface {v2, v1}, Llzo;->d(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    iget-object v1, v0, Lcom/google/android/apps/camera/hdrplus/deblurfusion/DeblurFusionMergedCropCalculator;->c:Llvn;

    invoke-static {v1}, Lmin;->aR(Llvn;)D

    move-result-wide v1

    iget-object v8, v0, Lcom/google/android/apps/camera/hdrplus/deblurfusion/DeblurFusionMergedCropCalculator;->d:Llvn;

    invoke-static {v8}, Lmin;->aR(Llvn;)D

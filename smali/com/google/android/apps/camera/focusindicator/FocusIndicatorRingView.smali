...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p2}, Lduj;-><init>()V

    iput-object p2, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->a:Ldui;
    ...
    invoke-direct {p2, v1}, Ldul;-><init>(Landroid/graphics/drawable/ShapeDrawable;)V

    iput-object p2, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->b:Lduk;
...
.method constructor <init>(Landroid/content/Context;Ldui;Lduk;)V
    .locals 0
    ...
    iput-object p3, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->b:Lduk;
...
.method protected final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->a:Ldui;

    invoke-interface {v0, p1}, Ldui;->a(Landroid/graphics/Canvas;)V

    iget-object v0, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->b:Lduk;

    invoke-interface {v0, p1}, Lduk;->a(Landroid/graphics/Canvas;)V
...
.method protected final onLayout(ZIIII)V
    ...
    iget-object p2, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->e:Ljrx;
    ...
    invoke-static {p4, p3}, Ljrx;->a(Landroid/view/Display;Landroid/content/Context;)Ljrx;

    move-result-object p3

    iput-object p3, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->e:Ljrx;
    ...
    invoke-static {p3}, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->a(Ljrx;)I

    move-result p3

    invoke-static {p2}, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->a(Ljrx;)I
    ...
    :sswitch_2
    sget-object p2, Llia;->c:Llia;

    goto :goto_0

    :sswitch_3
    sget-object p2, Llia;->d:Llia;
    ...
    invoke-virtual {p2}, Llia;->ordinal()I
...
.method protected final onSizeChanged(IIII)V
    ...
    iget-object p3, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->a:Ldui;

    invoke-interface {p3, p1, p2}, Ldui;->b(II)V

    iget-object p3, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->b:Lduk;

    invoke-interface {p3, p1, p2}, Lduk;->b(II)V

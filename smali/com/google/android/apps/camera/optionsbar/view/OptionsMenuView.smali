...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuView;->a:Loue;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p2, p0, Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuView;->i:Ljrx;

    new-instance p2, Landroid/view/GestureDetector;

    new-instance v0, Lgus;

    invoke-direct {v0, p0}, Lgus;-><init>(Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuView;)V
...
.method public final b(Lgtl;)V
    .locals 1

    const/4 v0, 0x0

    invoke-virtual {p0, p1, v0}, Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuView;->c(Lgtl;Ljava/lang/String;)V

    return-void
.end method

.method public final c(Lgtl;Ljava/lang/String;)V
    .locals 6
    ...
    iget-object v0, p1, Lgup;->d:Ljava/util/ArrayList;
    ...
    :cond_1
    iget-object v0, p1, Lgup;->e:Ljava/util/Map;
    ...
    invoke-virtual {p1, v0}, Lgup;->f(Landroid/widget/ImageButton;)V
    ...
    iget-object p2, p1, Lgup;->h:Landroid/widget/TextView;
    ...
    invoke-virtual {p1}, Lgup;->getResources()Landroid/content/res/Resources;
    ...
    :cond_3
    iget-object v0, p1, Lgup;->h:Landroid/widget/TextView;
    ...
    invoke-virtual {p1, v2}, Lgup;->setEnabled(Z)V
...
.method public final d(Lgtl;Lgtu;)V
    .locals 2
...
.method public final e(Lgtl;)V
    ...
    iget-object v1, v0, Lgup;->d:Ljava/util/ArrayList;
    ...
    :cond_0
    iget-object v1, v0, Lgup;->e:Ljava/util/Map;

    iget-object v2, v0, Lgup;->n:Lgtu;
    ...
    invoke-virtual {v0, v1}, Lgup;->e(Landroid/widget/ImageButton;)V

    iget-object v2, v0, Lgup;->f:Ljava/util/Map;
    ...
    invoke-virtual {v0}, Lgup;->getResources()Landroid/content/res/Resources;

    move-result-object v2

    invoke-virtual {v1, v2}, Lgtk;->b(Landroid/content/res/Resources;)Ljava/lang/String;

    move-result-object v2

    iget-object v3, v0, Lgup;->h:Landroid/widget/TextView;
    ...
    invoke-virtual {v1, v2}, Lgtk;->a(Landroid/content/res/Resources;)Ljava/lang/String;

    move-result-object v1

    iget-object v2, v0, Lgup;->h:Landroid/widget/TextView;

    invoke-virtual {v2, v1}, Landroid/widget/TextView;->setContentDescription(Ljava/lang/CharSequence;)V

    iget-boolean v1, v0, Lgup;->l:Z

    if-eqz v1, :cond_1

    iget-object v1, v0, Lgup;->h:Landroid/widget/TextView;

    invoke-static {v0}, Lmin;->dQ(Landroid/view/View;)I
    ...
    invoke-virtual {p1, v5}, Lgup;->setEnabled(Z)V
...
.method public final f(Lgtl;Z)V
    .locals 5
    ...
    iget-object v0, v0, Lgup;->d:Ljava/util/ArrayList;
    ...
    invoke-virtual {p1, p2}, Lgup;->setEnabled(Z)V

    :cond_1
    return-void
.end method

.method public final g(Lgtj;Lgto;)V
    .locals 1
...
.method protected final onFinishInflate()V
    ...
    invoke-direct {v0, p0}, Lguq;-><init>(Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuView;)V
...
.method protected final onMeasure(II)V
    ...
    :goto_0
    sget-object v1, Lcom/google/android/apps/camera/optionsbar/view/OptionsMenuView;->a:Loue;

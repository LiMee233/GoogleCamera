...
.method private static readDeviceParams(Landroid/content/Context;)[B
    ...
    invoke-interface {p0}, Lpjj;->a()Lpjz;
...
.method private static readDisplayParams(Landroid/content/Context;J)V
    ...
    invoke-interface {v2}, Lpjj;->b()Lpka;

    move-result-object v3

    invoke-interface {v2}, Lpjj;->d()V

    invoke-static {p0}, Lpis;->a(Landroid/content/Context;)Landroid/view/Display;

    move-result-object v2

    invoke-static {v2}, Lpis;->a(Landroid/view/Display;)Landroid/util/DisplayMetrics;
    ...
    :cond_2
    :goto_1
    invoke-static {v3}, Lpis;->a(Lpka;)F
    ...
    invoke-static {v2}, Lpip;->a(Ljava/lang/Object;)Lpip;
    ...
    invoke-virtual {v0, p0}, Lpip;->a(Ljava/lang/String;)I

    move-result p0

    const-string v1, "getSafeInsetRight"

    invoke-virtual {v0, v1}, Lpip;->a(Ljava/lang/String;)I
    ...
    invoke-static {v0}, Lpis;->a(Lpka;)F
...
.method private static readSdkConfigurationParams(Landroid/content/Context;)[B
    ...
    invoke-static {p0}, Lpjv;->a(Landroid/content/Context;)Lope;
...
.method private static readUserPrefs(Landroid/content/Context;)[B
    ...
    invoke-interface {p0}, Lpjj;->c()Lpkb;
...
.method private static writeDeviceParams(Landroid/content/Context;[B)Z
    ...
    invoke-static {v1, p1, v0}, Lpcu;->a(Lpcu;[BLpch;)Lpcu;
    ...
    invoke-interface {p0, p1}, Lpjj;->a(Lpjz;)Z

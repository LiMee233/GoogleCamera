...
.method private static requestFeatures(Landroid/content/Context;J[I[ILandroid/app/PendingIntent;)V
    ...
    invoke-static {p3}, Lpwv;->a([I)[Lpwv;

    move-result-object p3

    invoke-static {p4}, Lpwv;->a([I)[Lpwv;
    ...
    invoke-direct {v0, v1, v2}, Lpww;-><init>(J)V
    ...
    sget-object v2, Lpwl;->a:Landroid/content/ComponentName;
    ...
    invoke-virtual {v0, v6}, Lpww;->a(Lpwv;)Z

    move-result v7

    if-nez v7, :cond_0

    iget-object v6, v6, Lpwv;->d:Ljava/lang/String;
    ...
    invoke-virtual {v0, v3}, Lpww;->a(Lpwv;)Z

    move-result v5

    if-nez v5, :cond_3

    iget-object v3, v3, Lpwv;->d:Ljava/lang/String;

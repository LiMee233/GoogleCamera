...
.method public constructor <init>(Lfc;)V
    ...
    invoke-direct {p1, v1, v1, v1}, Lnuw;-><init>([B[B[C)V

    iput-object p1, p0, Lbfi;->b:Lnuw;
...
.method public final declared-synchronized b(Ljava/lang/Class;)Ljava/util/List;
    ...
    :try_start_0
    iget-object v0, p0, Lbfi;->b:Lnuw;

    iget-object v0, v0, Lnuw;->a:Ljava/util/Map;
    ...
    iget-object v1, p0, Lbfi;->b:Lnuw;

    iget-object v1, v1, Lnuw;->a:Ljava/util/Map;

    new-instance v2, Ljdw;

    invoke-direct {v2, v0}, Ljdw;-><init>(Ljava/util/List;)V

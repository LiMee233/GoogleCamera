...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Ldjm;->d:Ljava/util/List;
    ...
    iput-object v0, p0, Ldjm;->a:Landroid/content/Context;

    invoke-static {v0}, Lahj;->c(Landroid/content/Context;)Landroid/content/SharedPreferences;

    move-result-object p1

    iput-object p1, p0, Ldjm;->b:Landroid/content/SharedPreferences;
...
.method public final a(Landroidx/preference/PreferenceScreen;)V
    ...
    iput-object p1, p0, Ldjm;->c:Landroidx/preference/PreferenceScreen;

    new-instance v0, Landroidx/preference/Preference;

    iget-object v1, p0, Ldjm;->a:Landroid/content/Context;
    ...
    invoke-direct {v1, p0, v2}, Ldjj;-><init>(Ldjm;I)V

    iput-object v1, v0, Landroidx/preference/Preference;->o:Lagn;

    iget-object v1, p0, Ldjm;->c:Landroidx/preference/PreferenceScreen;
    ...
    invoke-direct {v1, p0, v3}, Ldjj;-><init>(Ldjm;I)V
    ...
    iget-object v0, p0, Ldjm;->b:Landroid/content/SharedPreferences;
    ...
    iget-object v6, p0, Ldjm;->c:Landroidx/preference/PreferenceScreen;
    ...
    invoke-direct {v0, p0}, Ldjk;-><init>(Ldjm;)V
    ...
    iget-object v0, p0, Ldjm;->c:Landroidx/preference/PreferenceScreen;

    invoke-virtual {v0, v5}, Landroidx/preference/PreferenceGroup;->ag(Landroidx/preference/Preference;)V

    iget-object v0, p0, Ldjm;->d:Ljava/util/List;

    invoke-interface {v0}, Ljava/util/List;->clear()V

    new-instance v0, Landroidx/preference/EditTextPreference;

    iget-object v3, p0, Ldjm;->c:Landroidx/preference/PreferenceScreen;
    ...
    iget-object v5, p0, Ldjm;->d:Ljava/util/List;

    new-instance v6, Ldjl;

    invoke-direct {v6, v0}, Ldjl;-><init>(Landroidx/preference/Preference;)V

    invoke-interface {v5, v6}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    const-string v5, "Gca"

    iget-object v6, p0, Ldjm;->b:Landroid/content/SharedPreferences;
    ...
    invoke-direct {v5, p0}, Ldji;-><init>(Ldjm;)V

    iput-object v5, v0, Landroidx/preference/Preference;->n:Lagm;

    new-instance v0, Landroidx/preference/PreferenceCategory;

    iget-object v5, p0, Ldjm;->a:Landroid/content/Context;
    ...
    iget-object v1, p0, Ldjm;->d:Ljava/util/List;
    ...
    iget-object v8, v4, Ldjl;->a:Ljava/lang/String;
    ...
    iget-object v4, v4, Ldjl;->b:Landroidx/preference/Preference;
    ...
    :cond_4
    iget-object p1, p0, Ldjm;->c:Landroidx/preference/PreferenceScreen;
...
.method public final b(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Ldjm;->a(Landroidx/preference/PreferenceScreen;)V

...
.method public constructor <init>(Lahr;)V
    ...
    invoke-direct {p0, p1}, Laje;-><init>(Laje;)V

    new-instance p1, Lahp;

    const/4 v0, 0x0

    invoke-direct {p1, v0}, Lahp;-><init>([B)V

    iput-object p1, p0, Lahr;->a:Lahp;

    new-instance p1, Lahq;

    invoke-direct {p1, v0}, Lahq;-><init>([B)V

    iput-object p1, p0, Lahr;->x:Lahq;
...
.method public constructor <init>(Landroid/hardware/Camera$Parameters;)V
    ...
    invoke-direct {v0, v1}, Laju;-><init>(Landroid/hardware/Camera$Size;)V

    iput-object v0, p0, Lahr;->n:Laju;

    iget-object v0, p0, Lahr;->e:Ljava/util/TreeSet;
    ...
    iget-object v0, p0, Lahr;->h:Ljava/util/TreeSet;
    ...
    iget-object v1, p0, Lahr;->c:Ljava/util/ArrayList;

    invoke-virtual {v1, v0}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    :cond_0
    iget-object v0, p0, Lahr;->c:Ljava/util/ArrayList;

    iget-object v1, p0, Lahr;->a:Lahp;
    ...
    iget-object v2, p0, Lahr;->d:Ljava/util/ArrayList;
    ...
    invoke-direct {v3, v4, v1}, Laju;-><init>(II)V
    ...
    :cond_1
    iget-object v0, p0, Lahr;->d:Ljava/util/ArrayList;

    iget-object v1, p0, Lahr;->x:Lahq;
    ...
    iget-object v2, p0, Lahr;->f:Ljava/util/ArrayList;
    ...
    :cond_2
    iget-object v0, p0, Lahr;->f:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, Lahr;->g:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, Lahr;->i:Ljava/util/EnumSet;

    sget-object v3, Lajc;->b:Lajc;
    ...
    iget-object v0, p0, Lahr;->j:Ljava/util/EnumSet;

    sget-object v2, Laja;->a:Laja;
    ...
    iget-object v2, p0, Lahr;->j:Ljava/util/EnumSet;
    ...
    iget-object v2, p0, Lahr;->k:Ljava/util/EnumSet;
    ...
    iget-object v2, p0, Lahr;->l:Ljava/util/EnumSet;

    sget-object v3, Lajd;->a:Lajd;
    ...
    iget-object v0, p0, Lahr;->m:Ljava/util/EnumSet;
    ...
    iget-object p1, p0, Lahr;->m:Ljava/util/EnumSet;

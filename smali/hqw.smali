...
# direct methods
.method public synthetic constructor <init>(Lhqy;I)V
    .locals 0
...
.method public final run()V
    ...
    iget-object v0, p0, Lhqw;->a:Lhqy;

    iget-object v1, v0, Lhqy;->e:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    iget-object v2, v0, Lhqy;->d:Lhsl;

    invoke-virtual {v2}, Lhsl;->a()Ljava/io/File;
    ...
    iget-object v0, v0, Lhqy;->e:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    invoke-virtual {v0, v1}, Lhqc;->W(Landroid/graphics/Bitmap;)V
    :try_end_2
    ...
    :goto_4
    invoke-virtual {v0, v4}, Lhqc;->H(Ljava/lang/String;)V
    ...
    invoke-direct {v6, v3, v2}, Llie;-><init>(II)V

    sget-object v2, Lmbp;->c:Lmbp;

    invoke-direct {v5, v2}, Lika;-><init>(Lmbp;)V

    invoke-virtual {v5, v4}, Lika;->a(Lcom/google/android/libraries/camera/exif/ExifInterface;)V

    sget-object v2, Llia;->a:Llia;

    invoke-virtual {v5, v2}, Lika;->b(Llia;)V

    invoke-virtual {v0, v1, v5}, Lhqc;->r([BLika;)Lpho;
    :try_end_8

...
# direct methods
.method public constructor <init>(Landroid/content/Context;Loju;Lcom/google/android/apps/camera/bottombar/RoundedThumbnailView;)V
    .locals 2
    ...
    iput-object v0, p0, Lifh;->c:Ljrx;

    iput-object p2, p0, Lifh;->e:Loju;

    iput-object p3, p0, Lifh;->a:Lcom/google/android/apps/camera/bottombar/RoundedThumbnailView;
    ...
    iput-object p2, p0, Lifh;->f:Landroid/view/ViewGroup;
    ...
    iput-object p1, p0, Lifh;->b:Lj$/time/Duration;

    new-instance p1, Lifd;

    invoke-direct {p1, p0, p3}, Lifd;-><init>(Lifh;Lcom/google/android/apps/camera/bottombar/RoundedThumbnailView;)V
...
.method public final a(Landroid/view/View;)V
    ...
    iget-object v1, p0, Lifh;->d:Landroid/support/constraint/ConstraintLayout;
    ...
    :goto_0
    iget-object v1, p0, Lifh;->f:Landroid/view/ViewGroup;

    invoke-virtual {v1}, Landroid/view/ViewGroup;->getWidth()I

    move-result v1

    iget-object v2, p0, Lifh;->a:Lcom/google/android/apps/camera/bottombar/RoundedThumbnailView;

    invoke-virtual {v2}, Lcom/google/android/apps/camera/bottombar/RoundedThumbnailView;->getWidth()I

    move-result v2

    iget-object v4, p0, Lifh;->f:Landroid/view/ViewGroup;

    invoke-virtual {v4}, Landroid/view/ViewGroup;->getHeight()I

    move-result v4

    iget-object v5, p0, Lifh;->a:Lcom/google/android/apps/camera/bottombar/RoundedThumbnailView;
    ...
    iget-object v7, p0, Lifh;->f:Landroid/view/ViewGroup;
    ...
    iget-object v2, p0, Lifh;->f:Landroid/view/ViewGroup;
    ...
    iget-object v2, p0, Lifh;->d:Landroid/support/constraint/ConstraintLayout;
    ...
    iget-object p1, p0, Lifh;->d:Landroid/support/constraint/ConstraintLayout;
...
.method final b(Landroid/support/constraint/ConstraintLayout;)V
    ...
    invoke-direct {v0, p0, p1}, Liff;-><init>(Lifh;Landroid/support/constraint/ConstraintLayout;)V

    iget-object v1, p0, Lifh;->a:Lcom/google/android/apps/camera/bottombar/RoundedThumbnailView;
    ...
    :cond_0
    iget-object v0, p0, Lifh;->a:Lcom/google/android/apps/camera/bottombar/RoundedThumbnailView;
    ...
    iput-object p1, p0, Lifh;->d:Landroid/support/constraint/ConstraintLayout;
    ...
    invoke-virtual {p0, v0}, Lifh;->a(Landroid/view/View;)V
    ...
    iget-object v0, p0, Lifh;->f:Landroid/view/ViewGroup;

    iget-object v3, p0, Lifh;->a:Lcom/google/android/apps/camera/bottombar/RoundedThumbnailView;

    invoke-virtual {v0, v3}, Landroid/view/ViewGroup;->removeView(Landroid/view/View;)V

    iget-object v0, p0, Lifh;->a:Lcom/google/android/apps/camera/bottombar/RoundedThumbnailView;

    iget-object v3, p0, Lifh;->c:Ljrx;

    invoke-static {v3}, Lmin;->eq(Ljrx;)I
    ...
    :cond_2
    :goto_0
    iget-object p1, p0, Lifh;->a:Lcom/google/android/apps/camera/bottombar/RoundedThumbnailView;

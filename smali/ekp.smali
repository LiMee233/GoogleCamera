...
.method public final run()V
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, Lekp;->a:Lekq;

    iget-boolean v1, v0, Lekq;->g:Z

    if-nez v1, :cond_9

    iget-object v1, v0, Lekq;->b:Lekn;

    invoke-interface {v1}, Lekn;->a()Landroid/media/MediaCodec;
    ...
    iget-object v4, v0, Lekq;->c:Lekr;

    invoke-virtual {v4, v3}, Lekr;->a(Landroid/media/MediaFormat;)I
    ...
    invoke-interface {v0, v1, v4}, Loub;->p(Ljava/lang/String;I)V
    ...
    iget-object v7, v0, Lekq;->e:Ljava/lang/Object;

    monitor-enter v7

    :try_start_1
    iget-object v9, v0, Lekq;->d:Ljava/util/Queue;

    new-instance v10, Lmsq;

    invoke-direct {v10, v5, v3}, Lmsq;-><init>(Ljava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V

    invoke-interface {v9, v10}, Ljava/util/Queue;->offer(Ljava/lang/Object;)Z

    iget-object v5, v0, Lekq;->e:Ljava/lang/Object;

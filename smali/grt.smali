...
# direct methods
.method public constructor <init>(Llip;Ldgz;)V
    .locals 2
    ...
    iput-object p1, p0, Lgrt;->a:Lliq;

    iput-object p2, p0, Lgrt;->b:Ldgz;
...
# virtual methods
.method public final a(Llzs;DD)V
    .locals 7

    sget-object p4, Landroid/hardware/camera2/CaptureResult;->SENSOR_TIMESTAMP:Landroid/hardware/camera2/CaptureResult$Key;

    invoke-interface {p1, p4}, Llzs;->d(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-interface {p1, p5}, Llzs;->d(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-interface {p5, v0, v1, v2, v3}, Ldgz;->b(JJ)V

    :cond_0
    iget-wide p4, p0, Lgrt;->c:D
    ...
    invoke-interface {p1, p4}, Lliq;->f(Ljava/lang/String;)V

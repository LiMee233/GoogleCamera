...
.field final synthetic c:Lekk;


# direct methods
.method public constructor <init>(Lekk;Ljava/util/concurrent/atomic/AtomicReference;Lcom/google/geo/lightfield/processing/ProgressCallback;)V
    .locals 0

    iput-object p1, p0, Lekj;->c:Lekk;

    iput-object p2, p0, Lekj;->a:Ljava/util/concurrent/atomic/AtomicReference;

    iput-object p3, p0, Lekj;->b:Lcom/google/geo/lightfield/processing/ProgressCallback;
...
.method public final run()V
    ...
    iget-object v4, v1, Lekj;->a:Ljava/util/concurrent/atomic/AtomicReference;

    iget-object v5, v1, Lekj;->c:Lekk;

    iget-object v6, v1, Lekj;->b:Lcom/google/geo/lightfield/processing/ProgressCallback;

    const/4 v7, 0x0

    invoke-interface {v6, v7}, Lcom/google/geo/lightfield/processing/ProgressCallback;->setProgress(F)V

    new-instance v8, Lnkz;

    invoke-direct {v8}, Lnkz;-><init>()V

    invoke-virtual {v8}, Lnkz;->b()V

    iget-object v0, v5, Lekk;->g:Lehb;
    ...
    invoke-static {v10, v0}, Lekv;->b(Landroid/media/MediaExtractor;Ljava/lang/String;)Landroid/media/MediaFormat;
    ...
    invoke-direct {v14, v0, v9}, Lnlb;-><init>(II)V

    new-instance v9, Landroid/view/Surface;

    iget-object v0, v14, Lnlb;->c:Landroid/graphics/SurfaceTexture;

    invoke-direct {v9, v0}, Landroid/view/Surface;-><init>(Landroid/graphics/SurfaceTexture;)V

    new-instance v15, Lekv;

    invoke-direct {v15, v9}, Lekv;-><init>(Landroid/view/Surface;)V
    ...
    iput-boolean v12, v15, Lekv;->f:Z

    iget-object v7, v15, Lekv;->c:Landroid/media/MediaExtractor;

    invoke-static {v7, v0}, Lekv;->b(Landroid/media/MediaExtractor;Ljava/lang/String;)Landroid/media/MediaFormat;

    move-result-object v7

    iput-object v7, v15, Lekv;->d:Landroid/media/MediaFormat;

    iget-object v7, v15, Lekv;->d:Landroid/media/MediaFormat;

    if-nez v7, :cond_1

    sget-object v2, Lekv;->a:Loue;
    ...
    invoke-static {v2, v7, v0, v3}, Ld;->u(Louv;Ljava/lang/String;Ljava/lang/Object;C)V

    iget-boolean v0, v15, Lekv;->f:Z
    ...
    iput-wide v12, v15, Lekv;->e:J

    :cond_2
    :try_start_0
    iget-object v0, v15, Lekv;->d:Landroid/media/MediaFormat;
    ...
    iput-object v0, v15, Lekv;->h:Landroid/media/MediaCodec;
    ...
    :try_start_1
    iget-object v0, v15, Lekv;->h:Landroid/media/MediaCodec;

    iget-object v3, v15, Lekv;->d:Landroid/media/MediaFormat;

    iget-object v7, v15, Lekv;->b:Landroid/view/Surface;
    :try_end_1
    ...
    iput-object v0, v15, Lekv;->g:[Ljava/nio/ByteBuffer;

    const/4 v2, 0x1

    iput-boolean v2, v15, Lekv;->f:Z
    ...
    invoke-static {v2, v7, v3, v0}, Ld;->w(Louv;Ljava/lang/String;CLjava/lang/Throwable;)V
    ...
    invoke-static {v3, v2, v7, v0}, Ld;->w(Louv;Ljava/lang/String;CLjava/lang/Throwable;)V
    ...
    sget-object v0, Lekv;->a:Loue;

    invoke-virtual {v0}, Lotz;->b()Louv;

    move-result-object v0

    iget-object v2, v15, Lekv;->d:Landroid/media/MediaFormat;
    ...
    invoke-static {v0, v7, v2, v3}, Ld;->u(Louv;Ljava/lang/String;Ljava/lang/Object;C)V
    ...
    sget-object v0, Lekk;->a:Loue;

    invoke-virtual {v0}, Lotz;->b()Louv;

    move-result-object v0

    iget-object v2, v5, Lekk;->g:Lehb;

    invoke-virtual {v2}, Lehb;->b()Ljava/lang/String;
    ...
    invoke-static {v0, v5, v2, v3}, Ld;->u(Louv;Ljava/lang/String;Ljava/lang/Object;C)V
    ...
    iget-boolean v2, v5, Lekk;->d:Z

    iget-wide v12, v5, Lekk;->e:D

    move-object v7, v4

    iget-wide v3, v5, Lekk;->f:D
    ...
    invoke-interface/range {v18 .. v24}, Lejq;->a(Ljava/lang/String;ZDD)Lejp;
    ...
    :cond_5
    :try_start_5
    iget-object v12, v14, Lnlb;->d:Ljava/util/concurrent/Semaphore;
    :try_end_5
    ...
    iget-object v0, v14, Lnlb;->b:Lcom/google/android/libraries/vision/opengl/Texture;

    invoke-virtual {v0}, Lcom/google/android/libraries/vision/opengl/Texture;->getName()I

    move-result v0

    iget-object v4, v15, Lekv;->d:Landroid/media/MediaFormat;

    invoke-virtual {v4, v11}, Landroid/media/MediaFormat;->getInteger(Ljava/lang/String;)I

    move-result v4

    iget-object v5, v15, Lekv;->d:Landroid/media/MediaFormat;
    ...
    sget-object v5, Lnlb;->a:Ljava/lang/String;
    ...
    invoke-static {v0, v10, v5, v4}, Ld;->w(Louv;Ljava/lang/String;CLjava/lang/Throwable;)V
    ...
    invoke-static {v4, v10, v5, v0}, Ld;->w(Louv;Ljava/lang/String;CLjava/lang/Throwable;)V
    ...
    iget-object v0, v15, Lekv;->c:Landroid/media/MediaExtractor;

    invoke-virtual {v0}, Landroid/media/MediaExtractor;->release()V

    const/4 v4, 0x0

    iput-boolean v4, v15, Lekv;->f:Z
    ...
    iget-boolean v0, v13, Lekk;->c:Z

    invoke-interface {v2, v0}, Lejp;->getResult(Z)Lcom/google/android/apps/camera/imax/cyclops/image/StereoPanorama;

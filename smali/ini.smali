...
.method public constructor <init>(Leum;Limx;)V
    ...
    iput-object v0, p0, Lini;->d:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lini;->e:Ljava/util/HashMap;

    new-instance v0, Line;

    invoke-direct {v0}, Line;-><init>()V

    iput-object v0, p0, Lini;->f:Landroid/util/LruCache;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lini;->g:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lini;->h:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lini;->i:Ljava/util/HashMap;

    new-instance v0, Lj$/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Lj$/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lini;->j:Lj$/util/concurrent/ConcurrentHashMap;

    iput-object p1, p0, Lini;->b:Leum;

    iput-object p2, p0, Lini;->c:Limx;
...
# virtual methods
.method public final a()Lilt;
    .locals 1

    new-instance v0, Linf;

    invoke-direct {v0, p0}, Linf;-><init>(Lini;)V
...
.method public final a(Landroid/content/ContentResolver;Ljava/lang/String;JLoac;ILjava/lang/String;IILmpu;)V
    ...
    iget-object v1, p0, Lini;->b:Leum;

    iget-object v2, p0, Lini;->c:Limx;

    invoke-direct {p7, v1, v2}, Leus;-><init>(Leum;Limx;)V
    ...
    sget-object p2, Lini;->a:Ljava/lang/String;
...
.method public final a(Landroid/net/Uri;)V
    ...
    iget-object v0, p0, Lini;->g:Ljava/util/HashMap;

    invoke-virtual {v0, p1}, Ljava/util/HashMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v0, p0, Lini;->f:Landroid/util/LruCache;

    invoke-virtual {v0, p1}, Landroid/util/LruCache;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v0, p0, Lini;->h:Ljava/util/HashMap;
...
.method public final a(Landroid/net/Uri;Landroid/net/Uri;)V
    ...
    iget-object v0, p0, Lini;->d:Ljava/util/HashMap;

    invoke-virtual {v0, p2, p1}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v0, p0, Lini;->e:Ljava/util/HashMap;
...
.method public final a(Landroid/net/Uri;Lawg;)V
    .locals 4

    sget-object v0, Lini;->a:Ljava/lang/String;

    iget-object v1, p0, Lini;->f:Landroid/util/LruCache;
    ...
    sget-object p1, Lini;->a:Ljava/lang/String;
    ...
    :cond_0
    invoke-virtual {p2}, Lawg;->f()Landroid/graphics/drawable/Drawable;
    ...
    iget-object p2, p0, Lini;->h:Ljava/util/HashMap;
...
.method public final a(Lawg;JLandroid/net/Uri;)V
    .locals 1

    iget-object v0, p0, Lini;->i:Ljava/util/HashMap;
    ...
    invoke-virtual {p0, p4, p1}, Lini;->a(Landroid/net/Uri;Lawg;)V

    return-void
.end method

.method public final a(Lluo;JLandroid/net/Uri;)V
    .locals 3
    ...
    iget-object p1, p0, Lini;->f:Landroid/util/LruCache;

    invoke-virtual {p1, p4}, Landroid/util/LruCache;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object p1, p0, Lini;->h:Ljava/util/HashMap;
    ...
    iget-object p1, p0, Lini;->i:Ljava/util/HashMap;
...
.method public final b()Lilu;
    ...
    invoke-direct {v0, p0}, Ling;-><init>(Lini;)V
...
.method public final b(Landroid/net/Uri;Landroid/net/Uri;)V
    ...
    iget-object v0, p0, Lini;->j:Lj$/util/concurrent/ConcurrentHashMap;

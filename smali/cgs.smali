...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcgs;->a:Loue;

    return-void
.end method

.method public constructor <init>(Lcfi;Lcka;Lckh;Lljd;)V
    .locals 1
...
.method private final c()V
    ...
    :cond_0
    iget-object v1, p0, Lcgs;->b:Lpho;

    if-eqz v1, :cond_1

    const/4 v3, 0x1

    invoke-interface {v1, v3}, Lpho;->cancel(Z)Z

    iput-object v2, p0, Lcgs;->b:Lpho;
...
.method public final a(Lckd;)Lcmz;
    ...
    :try_start_1
    invoke-virtual {p0, p1}, Lcgs;->b(Lckd;)Lpho;
...
.method final b(Lckd;)Lpho;
    ...
    iget-object v5, v1, Lcnd;->u:Lnuw;

    sget-object v6, Lcms;->d:Lcms;

    invoke-virtual {v5, v6}, Lnuw;->k(Lcms;)Llan;

    move-result-object v5

    invoke-virtual {v5, v1}, Llan;->c(Llic;)V

    iget-object v5, v1, Lcnd;->b:Lqkb;
    ...
    invoke-static {v4, p1}, Loxc;->G(Lpge;Ljava/util/concurrent/Executor;)Lpho;

    move-result-object p1

    iput-object p1, p0, Lcgs;->b:Lpho;

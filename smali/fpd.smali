...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lfpd;->a:Loue;

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Lmbg;Ldde;Lfjr;)V
    .locals 2
    ...
    iput-object v0, p0, Lfpd;->b:Ljava/util/concurrent/atomic/AtomicBoolean;

    iput-object p1, p0, Lfpd;->c:Landroid/content/Context;

    iput-object p2, p0, Lfpd;->d:Lmbg;

    iput-object p4, p0, Lfpd;->e:Lfjr;
    ...
    iput-wide p1, p0, Lfpd;->f:J

    sget-object p1, Lddq;->y:Lddf;

    invoke-interface {p3, p1}, Ldde;->k(Lddf;)Z

    move-result p1

    iput-boolean p1, p0, Lfpd;->g:Z
...
.method public final run()V
    ...
    :try_start_0
    iget-object v0, p0, Lfpd;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_0
    iget-object v0, p0, Lfpd;->c:Landroid/content/Context;
    ...
    iget-object v3, p0, Lfpd;->c:Landroid/content/Context;
    ...
    iget-boolean v5, p0, Lfpd;->g:Z

    if-eqz v5, :cond_5

    iget-object v5, p0, Lfpd;->c:Landroid/content/Context;
    ...
    invoke-interface {v8, v9, v3}, Loub;->p(Ljava/lang/String;I)V
    ...
    invoke-interface {v8, v3, v10, v11}, Loub;->J(IJ)V
    :try_end_2
    ...
    :try_end_4
    .catch Lmkw; {:try_start_4 .. :try_end_4} :catch_0
    .catchall {:try_start_4 .. :try_end_4} :catchall_2

    :try_start_5
    invoke-static {v10}, Lmkx;->c(Ljava/io/FileInputStream;)Lmkx;

    move-result-object v11

    const-string v12, "mdat"

    invoke-virtual {v11, v12}, Lmkx;->f(Ljava/lang/String;)Lmkx;

    move-result-object v11

    iget-object v11, v11, Lmkx;->a:Loix;
    ...
    invoke-virtual {v10}, Ljava/io/FileInputStream;->close()V
    :try_end_6
    .catch Lmkw; {:try_start_6 .. :try_end_6} :catch_0
    ...
    throw v8
    :try_end_9
    .catch Lmkw; {:try_start_9 .. :try_end_9} :catch_0
    ...
    invoke-interface {v9, v8}, Loub;->h(Ljava/lang/Throwable;)Louv;
    ...
    :cond_5
    :goto_4
    iget-object v5, p0, Lfpd;->d:Lmbg;

    iget-object v5, v5, Lmbg;->j:Ljava/text/DateFormat;
    ...
    iget-object v5, v5, Lmbg;->c:Ljava/lang/String;
    ...
    invoke-interface {v5, v10}, Loub;->G(I)Louv;
    ...
    invoke-interface {v5, v10, v3}, Loub;->p(Ljava/lang/String;I)V
    ...
    iget-object v3, p0, Lfpd;->e:Lfjr;

    sget-object v5, Lpbu;->d:Lpbu;
    ...
    invoke-interface {v3, v5}, Lfjr;->g(Lpbu;)V
    :try_end_e

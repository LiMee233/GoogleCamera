...
# direct methods
.method public synthetic constructor <init>(Ldnv;Lgtu;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Ldnu;->a:Ldnv;

    iput-object p2, p0, Ldnu;->b:Lgtu;
...
.method public final run()V
    ...
    iget-object v15, v0, Ldnu;->a:Ldnv;

    iget-object v1, v0, Ldnu;->b:Lgtu;

    iput-object v1, v15, Ldnv;->f:Lgtu;

    new-instance v14, Landroid/widget/FrameLayout;

    iget-object v1, v15, Ldnv;->a:Landroid/content/Context;

    invoke-direct {v14, v1}, Landroid/widget/FrameLayout;-><init>(Landroid/content/Context;)V

    iget-object v1, v15, Ldnv;->a:Landroid/content/Context;

    iget-object v2, v15, Ldnv;->e:Ldde;
    ...
    new-array v4, v2, [Lgtu;

    sget-object v5, Lgtu;->H:Lgtu;

    const/4 v6, 0x0

    aput-object v5, v4, v6

    sget-object v5, Lgtu;->F:Lgtu;

    aput-object v5, v4, v3

    sget-object v5, Lgtu;->G:Lgtu;
    ...
    iget-object v11, v15, Ldnv;->a:Landroid/content/Context;

    invoke-direct {v8, v11}, Landroid/widget/FrameLayout;-><init>(Landroid/content/Context;)V

    aput-object v8, v10, v5

    iget-object v8, v15, Ldnv;->a:Landroid/content/Context;

    iget-object v11, v15, Ldnv;->e:Ldde;
    ...
    invoke-virtual {v12}, Lgtu;->ordinal()I
    ...
    iget-object v2, v15, Ldnv;->f:Lgtu;
    ...
    iget-object v1, v15, Ldnv;->e:Ldde;
    ...
    iget-object v2, v15, Ldnv;->a:Landroid/content/Context;

    const v11, 0x7f0701c6

    invoke-static {v11, v2}, Lmin;->aH(ILandroid/content/Context;)I
    ...
    iget-object v6, v15, Ldnv;->a:Landroid/content/Context;

    invoke-static {v11, v6}, Lmin;->aH(ILandroid/content/Context;)I
    ...
    invoke-static {v8, v1}, Lohc;->aq(Landroid/view/View;I)I
    ...
    invoke-direct/range {v1 .. v17}, Ldns;-><init>(Ldnv;Landroid/view/View;Landroid/view/View;Landroid/view/View;IILandroid/widget/TextView;Landroid/widget/TextView;Landroid/widget/TextView;IILandroid/widget/ImageView;Landroid/widget/ImageView;Landroid/widget/ImageView;[Landroid/widget/FrameLayout;I)V
    ...
    invoke-direct/range {v18 .. v34}, Ldns;-><init>(Ldnv;Landroid/view/View;Landroid/view/View;Landroid/view/View;IILandroid/widget/TextView;Landroid/widget/TextView;Landroid/widget/TextView;IILandroid/widget/ImageView;Landroid/widget/ImageView;Landroid/widget/ImageView;[Landroid/widget/FrameLayout;I)V
    ...
    invoke-direct/range {v35 .. v51}, Ldns;-><init>(Ldnv;Landroid/view/View;Landroid/view/View;Landroid/view/View;IILandroid/widget/TextView;Landroid/widget/TextView;Landroid/widget/TextView;IILandroid/widget/ImageView;Landroid/widget/ImageView;Landroid/widget/ImageView;[Landroid/widget/FrameLayout;I)V
    ...
    invoke-static/range {v21 .. v26}, Ldnv;->c(Lgtu;Landroid/view/View;Landroid/view/View;Landroid/view/View;II)V

    iget-object v1, v8, Ldnv;->f:Lgtu;
    ...
    invoke-static/range {v21 .. v26}, Ldnv;->e(Lgtu;Landroid/widget/TextView;Landroid/widget/TextView;Landroid/widget/TextView;II)V

    iget-object v0, v8, Ldnv;->f:Lgtu;
    ...
    invoke-static/range {v21 .. v26}, Ldnv;->d(Lgtu;Landroid/widget/ImageView;Landroid/widget/ImageView;Landroid/widget/ImageView;II)V
    ...
    invoke-direct {v2, v8}, Ldnr;-><init>(Ldnv;)V

    invoke-virtual {v0, v2}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v0, v8, Ldnv;->c:Llzf;

    invoke-virtual {v0}, Llzf;->c()Z
    ...
    iget-object v2, v8, Ldnv;->a:Landroid/content/Context;
    ...
    invoke-direct/range {v2 .. v7}, Ldnt;-><init>(Landroid/view/View;Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/ViewGroup;Landroid/view/View;)V

    iput-object v10, v0, Liuq;->f:Landroid/view/View$OnScrollChangeListener;

    iget-object v0, v8, Ldnv;->b:Liuq;

    iget-object v2, v0, Liuq;->c:Ldde;

    sget-object v3, Lddk;->aL:Lddf;
    ...
    :cond_f
    iget-object v2, v0, Liuq;->b:Llap;

    new-instance v3, Liun;

    invoke-direct {v3, v0, v9, v1}, Liun;-><init>(Liuq;Landroid/view/View;Landroid/view/View;)V
    ...
    iput-wide v1, v0, Liuq;->h:J

    sget-object v1, Lozt;->e:Lozt;

    invoke-virtual {v1}, Lpoy;->m()Lpot;

    move-result-object v1

    iput-object v1, v0, Liuq;->k:Lpot;

    const/4 v1, 0x0

    iput-object v1, v0, Liuq;->i:Lepo;

...
.method public final h(Llia;)V
    ...
    invoke-interface {v4}, Lelu;->o()Z

    move-result v5

    if-nez v5, :cond_0

    iget-object v5, p1, Lels;->j:Lelu;
    ...
    invoke-virtual {p1, v4}, Lels;->g(Lelu;)V
    ...
    :cond_1
    iget-object v1, p1, Lels;->j:Lelu;

    if-eqz v1, :cond_2

    invoke-interface {v1}, Lelu;->o()Z
    ...
    invoke-virtual {p1, v1}, Lels;->g(Lelu;)V

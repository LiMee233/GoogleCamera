...
# direct methods
.method public synthetic constructor <init>(Legl;Lmaa;)V
    .locals 0
...
.method public final run()V
    ...
    iget-object v3, v1, Legk;->a:Legl;

    iget-object v4, v1, Legk;->b:Lmaa;

    const/4 v5, 0x0

    :try_start_0
    iget-object v6, v3, Legl;->b:Legj;
    ...
    iget-object v7, v6, Legj;->c:Lljd;

    const-string v8, "Downsample YUV"

    invoke-interface {v7, v8}, Lljd;->e(Ljava/lang/String;)V

    iget-object v7, v6, Legj;->a:Lpkj;

    invoke-virtual {v7, v4}, Lpkj;->c(Lmaa;)Lcom/google/googlex/gcam/YuvWriteView;
    ...
    invoke-static {v4, v2}, Lobm;->ar(ZLjava/lang/Object;)V
    ...
    invoke-static {v4, v0}, Lobm;->ar(ZLjava/lang/Object;)V

    invoke-static {v13, v14, v12, v9, v10}, Lcom/google/googlex/gcam/imageproc/Resample;->downsampleImpl(JIJ)Z

    iget-object v4, v6, Legj;->c:Lljd;

    const-string v9, "Rotate YUV"

    invoke-interface {v4, v9}, Lljd;->g(Ljava/lang/String;)V

    iget-object v4, v6, Legj;->b:Lbrg;

    invoke-virtual {v4}, Lbrg;->a()Llcm;
    ...
    invoke-static {v14, v2}, Lobm;->ar(ZLjava/lang/Object;)V
    ...
    invoke-static {v0}, Lpjc;->a(Landroid/graphics/Bitmap;)Lpjc;

    move-result-object v2

    iget-object v7, v2, Lpjc;->a:Lcom/google/googlex/gcam/InterleavedWriteViewU8;
    ...
    invoke-virtual {v2}, Lpjc;->close()V
    ...
    invoke-static {v2, v6, v4, v0}, Ld;->w(Louv;Ljava/lang/String;CLjava/lang/Throwable;)V

    :goto_7
    if-eqz v5, :cond_8

    iget-object v0, v3, Legl;->c:Lhrw;

    invoke-virtual {v0, v5}, Lhrw;->f(Landroid/graphics/Bitmap;)V

    return-void

    :cond_8
    sget-object v0, Legl;->a:Loue;
